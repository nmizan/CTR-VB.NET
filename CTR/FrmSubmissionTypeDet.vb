'
'Author             : Fahad Khan
'Purpose            : Maintain Submission Type Information
...
Public Class FrmSubmissionTypeDet

#Region "Global Variables"

    Dim _formName As String = "MaintenanceSubmissionTypeDet"
    Dim opt As SecForm = New SecForm(_formName)

    Dim _formMode As FormTransMode
    Dim _intModno As Integer = 0
    Dim _strSubType_Code As String = ""
...
#Region "User defined Codes"
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_SubmissionType_Add")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@SUBTYPE_CODE", DbType.String, txtId.Text.Trim())
            db.AddInParameter(commProc, "@SUBTYPE_NAME", DbType.String, txtName.Text.Trim())
            ...
            If result = 0 Then
                ...
                _strSubType_Code = txtId.Text.Trim()

                _intModno = 1

                log_message = " Added : Submission Type Code : " + txtId.Text.Trim() + "." + " " + " Submission Type Name : " + txtName.Text.ToString()
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_SubmissionType_Update")
            ...
            If result = 0 Then
                ...
                If _SubmissionType <> txtName.Text.Trim() Then

                    log_message = " Updated : Submission Type Code : " + txtId.Text.Trim() + "." + " " + " Submission Type Name  : " + _SubmissionType + " " + " To " + " " + txtName.Text.ToString()
                    Logger.system_log(log_message)
                Else
                    log_message = " Updated : Submission Type Code : " + txtId.Text.Trim() + "." + " " + " Submission Type Name  : " + txtName.Text.Trim()
                    Logger.system_log(log_message)
                End If
            ...
            'log_message = "Updated Submission Type " + txtId.Text.Trim() + " Name " + _SubmissionType + " To " + txtName.Text.ToString()
            'Logger.system_log(log_message)
    ...
    Private Sub LoadSubTypeDataForAuth(ByVal strSubTypeCode As String)
        ...
        Try
            ...
            ds = db.ExecuteDataSet(CommandType.Text, "Select * From GO_SUBMISSIONTYPE Where SUBTYPE_CODE ='" & strSubTypeCode & "' and STATUS= 'L' ")
            
            If ds.Tables(0).Rows.Count > 0 Then


                _strSubType_Code = strSubTypeCode


                _formMode = FormTransMode.Update


                txtId.Text = ds.Tables(0).Rows(0)("SUBTYPE_CODE").ToString()
                txtName.Text = ds.Tables(0).Rows(0)("SUBTYPE_NAME").ToString()
                _SubType = ds.Tables(0).Rows(0)("SUBTYPE_NAME").ToString()
    ...
    Private Sub LoadSubTypeData(ByVal strSubTypeCode As String, ByVal intMod As Integer)
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_SubmissionType_GetDetail")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@SUBTYPE_CODE", DbType.String, strSubTypeCode)
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                txtId.Text = ds.Tables(0).Rows(0)("SUBTYPE_CODE").ToString()
                txtName.Text = ds.Tables(0).Rows(0)("SUBTYPE_NAME").ToString()
                _SubmissionType = ds.Tables(0).Rows(0)("SUBTYPE_NAME").ToString()
                ...
                Dim commProc2 As DbCommand = db.GetStoredProcCommand("GO_SubmissionType_GetMaxMod")

                commProc2.Parameters.Clear()

                db.AddInParameter(commProc2, "@SUBTYPE_CODE", DbType.String, strSubTypeCode)
    ...
    Public Sub New(ByVal strSubTypeCode As String, ByVal intMod As Integer)

        ' This call is required by the Windows Form Designer.
        InitializeComponent()

        ' Add any initialization after the InitializeComponent() call.
        LoadSubTypeData(strSubTypeCode, intMod)
        _strSubType_Code = strSubTypeCode
        _intModno = intMod
    ...
    Private Function DeleteData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("GO_SubmissionType_Remove")

        commProc.Parameters.Clear()

        db.AddInParameter(commProc, "@SUBTYPE_CODE", DbType.String, _strSubType_Code)
        db.AddInParameter(commProc, "@MOD_NO", DbType.Int32, _intModno)
        db.AddOutParameter(commProc, "@RET_MOD_NO", DbType.Int32, 5)
        ...
        log_message = "Deleted Submission Type " + _strSubType_Code + " Name " + txtName.Text.ToString()
        Logger.system_log(log_message)
    ...
    Private Function AuthorizeData() As TransState
        ...
        If _intModno > 1 Then
            ...
            LoadSubTypeDataForAuth(_strSubType_Code)
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_SubmissionType_Auth")
            ...
            If result = 0 Then
                ...
                If _SubType <> _SubmissionType Then
                    If _SubType = "" Then
                        log_message = " Authorized : Submission Type Code : " + txtId.Text.Trim() + "." + " " + " Submission Type Name  : " + _SubmissionType
                    Else
                        log_message = " Authorized : Submission Type Code : " + txtId.Text.Trim() + "." + " " + " Submission Type Name  : " + _SubType + " " + " To " + " " + _SubmissionType
                    End If

                    Logger.system_log(log_message)
                Else
                    log_message = " Authorized : Submission Type Code : " + txtId.Text.Trim() + "." + " " + " Submission Type Name  : " + txtName.Text.Trim()
                    Logger.system_log(log_message)
                End If
        ...
        '
        'log_message = "Authorized Submission Type " + _strSubType_Code + " Name " + txtName.Text.ToString()
        'Logger.system_log(log_message)
...
#End Region
    ...
    Private Sub FrmSubmissionTypeDet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If _intModno > 0 Then
            LoadSubTypeData(_strSubType_Code, _intModno)
        End If
    ...
    Private Sub btnUnlock_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUnlock.Click
        ...
        If Not (_strSubType_Code.Trim() = "") Then
