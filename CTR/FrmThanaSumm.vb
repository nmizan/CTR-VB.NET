...
Public Class FrmThanaSummary

#Region "user defined codes"

    Dim _formName As String = "MaintenanceThanaSummary"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            If chkShowAll.Checked = True Then
                strSql = "select THANA_CODE, THANA_NAME, DIST_CODE, IS_AUTHORIZED, MODNO, " + _
                    " 'S' = " + _
                    "	CASE  " + _
                    ...
                    " order by IS_AUTHORIZED,THANA_CODE"
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(0).Value Is Nothing) Then
                ...
                Dim frmThn As New FrmThana(dgView.SelectedRows.Item(0).Cells(2).Value, dgView.SelectedRows.Item(0).Cells(0).Value)
                frmThn.ShowDialog()
            End If
