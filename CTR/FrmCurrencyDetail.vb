'
'Author             : Fahad Khan
'Purpose            : Maintain Currency Type Information
...
Public Class FrmCurrencyDetail
...
#Region "User defined Codes"
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_CurrencyType_Add")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@CURRENCY_CODE", DbType.String, txtId.Text.Trim())
            db.AddInParameter(commProc, "@CURRENCY_NAME", DbType.String, txtName.Text.Trim())
            ...
            If result = 0 Then
                ...
                log_message = " Added : Currency Type Code : " + txtId.Text.Trim() + "." + " " + " Currency Name : " + txtName.Text.ToString()
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_CurrencyType_Update")
            ...
            If result = 0 Then
                ...
                If _CurrName <> txtName.Text.Trim() Then

                    log_message = " Updated : Currency Type Code : " + txtId.Text.Trim() + "." + " " + " Currency Type Name : " + _CurrName + " " + " To " + " " + txtName.Text.ToString()
                    Logger.system_log(log_message)
                Else
                    log_message = " Updated : Currency Type Code : " + txtId.Text.Trim() + "." + " " + " Currency Type Name : " + txtName.Text.Trim()
                    Logger.system_log(log_message)
                End If
            ...
            'log_message = "Updated Currency Type " + txtId.Text.Trim() + " Name " + _CurrName + " To " + txtName.Text.ToString()
            'Logger.system_log(log_message)
    ...
    Private Sub LoadCnTypeDataForAuth(ByVal strCnTypeCode As String)
        ...
        Try
            ...
            ds = db.ExecuteDataSet(CommandType.Text, "Select * From GO_CURRENCY_TYPE Where CURRENCY_CODE ='" & strCnTypeCode & "' and STATUS= 'L' ")
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                txtId.Text = ds.Tables(0).Rows(0)("CURRENCY_CODE").ToString()
                txtName.Text = ds.Tables(0).Rows(0)("CURRENCY_NAME").ToString()
                _CurrancyName = ds.Tables(0).Rows(0)("CURRENCY_NAME").ToString()
    ...
    Private Sub LoadCnTypeData(ByVal strCnTypeCode As String, ByVal intMod As Integer)
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_CurrencyType_GetDetail")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@CURRENCY_CODE", DbType.String, strCnTypeCode)
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                Dim commProc2 As DbCommand = db.GetStoredProcCommand("GO_CurrencyType_GetMaxMod")

                commProc2.Parameters.Clear()

                db.AddInParameter(commProc2, "@CURRENCY_CODE", DbType.String, strCnTypeCode)
    ...
    Private Function DeleteData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("GO_CurrencyType_Remove")

        commProc.Parameters.Clear()

        db.AddInParameter(commProc, "@CURRENCY_CODE", DbType.String, _strCnType_Code)
        db.AddInParameter(commProc, "@MOD_NO", DbType.Int32, _intModno)
        db.AddOutParameter(commProc, "@RET_MOD_NO", DbType.Int32, 5)
        ...
        log_message = "Deleted Currency Type " + _strCnType_Code + " Name " + txtName.Text.ToString()
        Logger.system_log(log_message)
    ...
    Private Function AuthorizeData() As TransState
        ...
        If _intModno > 1 Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_CurrencyType_Auth")
            ...
            If result = 0 Then
                ...
                If _CurrancyName <> _CurrName Then
                    If _CurrancyName = "" Then
                        log_message = " Authorized : Currency Type Code : " + txtId.Text.Trim() + "." + " " + " Currency Type Name : " + _CurrName
                    Else
                        log_message = " Authorized : Currency Type Code : " + txtId.Text.Trim() + "." + " " + " Currency Type Name : " + _CurrancyName + " " + " To " + " " + _CurrName
                    End If

                    Logger.system_log(log_message)
                Else
                    log_message = " Authorized : Currency Type Code : " + txtId.Text.Trim() + "." + " " + " Currency Type Name : " + txtName.Text.Trim()
                    Logger.system_log(log_message)
                End If
        ...
        ''log_message = "Authorized Currency Type " + _strCnType_Code + " Name " + txtName.Text.ToString()
        ''Logger.system_log(log_message)
...
#End Region
    ...
    Private Sub FrmCurrencyDetail_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
