...
Public Class FrmFundTypeSummary
#Region "user defined codes"

    Dim _formName As String = "MaintenanceFundTypeSummary"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_FundType_GetDetailList")
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                dgView.Item(3, i).Value = dt.Rows(i).Item("FUNDTYPE_CODE").ToString()
                dgView.Item(4, i).Value = dt.Rows(i).Item("FUNDTYPE_NAME").ToString()
...
#End Region
    ...
    Private Sub FrmFundTypeSummary_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(1).Value Is Nothing) Then
                ...
                Dim frmFundTypeDet As New frmFundTypeDetail(dgView.SelectedRows.Item(0).Cells(3).Value, dgView.SelectedRows.Item(0).Cells(1).Value)
                frmFundTypeDet.Show()
            End If
        Catch ex As Exception
    ...
    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        Dim frmFundTypeDet As New frmFundTypeDetail()
        frmFundTypeDet.Show()
    ...
    Private Sub btnAuthorize_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAuthorize.Click
        Try
            ...
            If MessageBox.Show("Do you really want to Authorize?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                For i = 0 To dgView.Rows.Count - 1
                    ...
                    If dgView.Rows(i).Cells(0).Value = True Then
                        ...
                        Else
                            ...
                            LoadFundTypeData(dgView.Rows(i).Cells(3).Value.ToString(), dgView.Rows(i).Cells(1).Value)


                            If (dgView.Rows(i).Cells(1).Value) > 1 Then

                                LoadFundTypeDataForAuth(dgView.Rows(i).Cells(3).Value.ToString())
                                ...
                                db.AddInParameter(commProc, "@FUNDTYPE_CODE", DbType.String, dgView.Rows(i).Cells(3).Value.ToString())
                                ...
                                If result = 0 Then
                                    ...
                                    If _FType <> _FundType Then
                                        If _FType = "" Then
                                            log_message = " Authorized : Fund Type Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Fund Type Name  : " + _FundType
                                        Else
                                            log_message = " Authorized : Fund Type Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Fund Type Name  : " + _FType + " " + " To " + " " + _FundType
                                        End If
                ...
                '    log_message = "Authorized Fund Type " + dgView.Rows(i).Cells(3).Value.ToString() + " Name " + dgView.Rows(i).Cells(4).Value.ToString()
                '    Logger.system_log(log_message)
