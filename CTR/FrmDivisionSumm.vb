...
Public Class FrmDivisionSumm

#Region "user defined codes"

    Dim _formName As String = "MaintenanceGoDivisionSumm"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_DivisionType_GetDetailList")
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                dgView.Item(3, i).Value = dt.Rows(i).Item("DIVCODE").ToString()
                dgView.Item(4, i).Value = dt.Rows(i).Item("DIVNAME").ToString()
...
#End Region
    ...
    Private Sub FrmDivisionSumm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(1).Value Is Nothing) Then
                ...
                Dim frmDivisionDet As New FrmDivisionDet(dgView.SelectedRows.Item(0).Cells(3).Value, dgView.SelectedRows.Item(0).Cells(1).Value)
                frmDivisionDet.Show()
            End If
        Catch ex As Exception
    ...
    Private Sub btnAuthorize_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAuthorize.Click
        Try
            ...
            If MessageBox.Show("Do you really want to Authorize?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                For i = 0 To dgView.Rows.Count - 1
                    ...
                    If dgView.Rows(i).Cells(0).Value = True Then
                        ...
                        Else
                            ...
                            LoadDvTypeData(dgView.Rows(i).Cells(3).Value.ToString(), dgView.Rows(i).Cells(1).Value)


                            If (dgView.Rows(i).Cells(1).Value) > 1 Then

                                LoadDvTypeDataForAuth(dgView.Rows(i).Cells(3).Value.ToString())
                                ...
                                db.AddInParameter(commProc, "@DIVCODE", DbType.String, dgView.Rows(i).Cells(3).Value.ToString())
                                ...
                                If result = 0 Then
                                    ...
                                    If _DivisionName <> _DivName Then
                                        If _DivisionName = "" Then
                                            log_message = " Authorized : Division Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Division  Name  : " + _DivName
                                        Else
                                            log_message = " Authorized : Division Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Division  Name  : " + _DivisionName + " " + " To " + " " + _DivName
                                        End If
                ...
                '    log_message = "Authorized Division Code " + dgView.Rows(i).Cells(3).Value.ToString() + " Name " + dgView.Rows(i).Cells(4).Value.ToString()
                '    Logger.system_log(log_message)
                'Next i
