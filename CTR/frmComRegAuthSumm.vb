...
Public Class frmComRegAuthSumm

#Region "user defined codes"

    Dim _formName As String = "MaintenanceRegulariryAuthSummary"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            If chkShowAll.Checked = True Then
                strSql = "select REG_AUTHORITY_CODE, REG_AUTHORITY_NAME,IS_AUTHORIZED,MODNO, " + _
                    " 'S' = " + _
                    "	CASE  " + _
                    ...
                    "       ELSE 'U' " + _
                    "	End " + _
                    " from FIU_COMPANY_REG_AUTHORITY " + _
                    " where IS_AUTHORIZED=0 OR STATUS in ('L','D')  " + _
                    " order by IS_AUTHORIZED,REG_AUTHORITY_CODE"
...
#End Region
    ...
    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        ...
        Dim frmComRegAuthDet As New FrmComRegAuth
        frmComRegAuthDet.ShowDialog()
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(0).Value Is Nothing) Then
                ...
                Dim frmComRegAuthDet As New FrmComRegAuth(dgView.SelectedRows.Item(0).Cells(2).Value, dgView.SelectedRows.Item(0).Cells(0).Value)
                frmComRegAuthDet.ShowDialog()
            End If
    ...
    Private Sub frmComRegAuthSumm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
