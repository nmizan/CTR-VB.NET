...
'
'Author             : Fahad Khan
'Purpose            : Maintain Thana Information
...
#Region "User defined Codes"
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_ThanaType_Add")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@THANA_CODE", DbType.String, txtId.Text.Trim())
            db.AddInParameter(commProc, "@THANA_NAME", DbType.String, txtName.Text.Trim())
            ...
            If result = 0 Then
                ...
                _strThType_Code = txtId.Text.Trim()

                _intModno = 1

                log_message = " Added : Thana Code : " + txtId.Text.Trim() + "." + " " + " Thana Name : " + txtName.Text.ToString()
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_ThanaType_Update")
            ...
            If result = 0 Then
                ...
                If _ThanaName <> txtName.Text.Trim() Then

                    log_message = " Updated : Thana Code : " + txtId.Text.Trim() + "." + " " + " Thana  Name  : " + _ThanaName + " " + " To " + " " + txtName.Text.ToString()
                    Logger.system_log(log_message)
                Else
                    log_message = " Updated : Thana Code : " + txtId.Text.Trim() + "." + " " + " Thana  Name  : " + txtName.Text.Trim()
                    Logger.system_log(log_message)
                End If
            ...
            'log_message = "Updated Thana " + txtId.Text.Trim() + " Name " + _ThanaName + " To " + txtName.Text.ToString()
            'Logger.system_log(log_message)
        End If
    ...
    Private Sub LoadThTypeDataForAuth(ByVal strThTypeCode As String)
        ...
        Try
            ...
            ds = db.ExecuteDataSet(CommandType.Text, "Select * From GO_THANA_TYPE Where THANA_CODE ='" & strThTypeCode & "' and STATUS= 'L' ")
           
            If ds.Tables(0).Rows.Count > 0 Then


                _strThType_Code = strThTypeCode

                _formMode = FormTransMode.Update


                txtId.Text = ds.Tables(0).Rows(0)("THANA_CODE").ToString()
                txtName.Text = ds.Tables(0).Rows(0)("THANA_NAME").ToString()
                _ThName = ds.Tables(0).Rows(0)("THANA_NAME").ToString()
    ...
    Private Sub LoadThTypeData(ByVal strThTypeCode As String, ByVal intMod As Integer)
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_ThanaType_GetDetail")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@THANA_CODE", DbType.String, strThTypeCode)
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                Dim commProc2 As DbCommand = db.GetStoredProcCommand("GO_ThanaType_GetMaxMod")

                commProc2.Parameters.Clear()

                db.AddInParameter(commProc2, "@THANA_CODE", DbType.String, strThTypeCode)
    ...
    Public Sub New(ByVal strThTypeCode As String, ByVal intMod As Integer)

        ' This call is required by the Windows Form Designer.
        InitializeComponent()

        ' Add any initialization after the InitializeComponent() call.
        LoadThTypeData(strThTypeCode, intMod)
        _strThType_Code = strThTypeCode
        _intModno = intMod
    ...
    Private Function DeleteData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("GO_ThanaType_Remove")

        commProc.Parameters.Clear()

        db.AddInParameter(commProc, "@THANA_CODE", DbType.String, _strThType_Code)
        db.AddInParameter(commProc, "@MOD_NO", DbType.Int32, _intModno)
        db.AddOutParameter(commProc, "@RET_MOD_NO", DbType.Int32, 5)
        ...
        log_message = "Deleted Thana " + _strThType_Code + " Name " + txtName.Text.ToString()
        Logger.system_log(log_message)
    ...
    Private Function AuthorizeData() As TransState
        ...
        If _intModno > 1 Then
            ...
            LoadThTypeDataForAuth(_strThType_Code)
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_ThanaType_Auth")
            ...
            If result = 0 Then
                ...
                If _ThName <> _ThanaName Then
                    If _ThName = "" Then
                        log_message = " Authorized : Thana Code : " + txtId.Text.Trim() + "." + " " + " Thana  Name  : " + _ThanaName
                    Else
                        log_message = " Authorized : Thana Code : " + txtId.Text.Trim() + "." + " " + " Thana  Name  : " + _ThName + " " + " To " + " " + _ThanaName
                    End If

                    Logger.system_log(log_message)
                Else
                    log_message = " Authorized : Thana Code : " + txtId.Text.Trim() + "." + " " + " Thana  Name  : " + txtName.Text.Trim()
                    Logger.system_log(log_message)
                End If
        ...
        '
        'log_message = "Authorized Thana " + _strThType_Code + " Name " + txtName.Text.ToString()
        'Logger.system_log(log_message)
...
#End Region
    ...
    Private Sub FrmThanaDet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If _intModno > 0 Then
            LoadThTypeData(_strThType_Code, _intModno)
        End If
    ...
    Private Sub btnUnlock_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUnlock.Click
        ...
        If Not (_strThType_Code.Trim() = "") Then
