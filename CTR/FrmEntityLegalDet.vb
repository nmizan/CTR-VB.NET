'
'Author             : Fahad Khan
'Purpose            : Maintain Entity Type Information
...
Public Class FrmEntityLegalDet

#Region "Global Variables"


    Dim _formName As String = "MaintenanceEntityLegalDet"
...
#Region "User defined Codes"
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_EntityType_Add")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@ENTYPE_CODE", DbType.String, txtId.Text.Trim())
            db.AddInParameter(commProc, "@ENTYPE_NAME", DbType.String, txtName.Text.Trim())
            ...
            If result = 0 Then
                ...
                log_message = " Added : Entity Legal Type Code : " + txtId.Text.Trim() + "." + " " + " Entity Legal Type Name : " + txtName.Text.ToString()
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_EntityType_Update")
            ...
            If result = 0 Then
                ...
                If _EntityName <> txtName.Text.Trim() Then

                    log_message = " Updated : Entity Legal Type Code : " + txtId.Text.Trim() + "." + " " + " Entity Legal Type Name  : " + _EntityName + " " + " To " + " " + txtName.Text.ToString()
                    Logger.system_log(log_message)
                Else
                    log_message = " Updated : Entity Legal Type Code : " + txtId.Text.Trim() + "." + " " + " Entity Legal Type Name  : " + txtName.Text.Trim()
                    Logger.system_log(log_message)
                End If
            ...
            'log_message = "Updated Entity Legal Type " + txtId.Text.Trim() + " Name " + _EntityName + " To " + txtName.Text.ToString()
            'Logger.system_log(log_message)
    ...
    Private Sub LoadEnTypeDataForAuth(ByVal strEnTypeCode As String)
        ...
        Try
            ...
            ds = db.ExecuteDataSet(CommandType.Text, "Select * From GO_ENTITY_TYPE Where ENTYPE_CODE ='" & strEnTypeCode & "' and STATUS= 'L' ")
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                txtId.Text = ds.Tables(0).Rows(0)("ENTYPE_CODE").ToString()
                txtName.Text = ds.Tables(0).Rows(0)("ENTYPE_NAME").ToString()
                _EntName = ds.Tables(0).Rows(0)("ENTYPE_NAME").ToString()
    ...
    Private Sub LoadEnTypeData(ByVal strEnTypeCode As String, ByVal intMod As Integer)
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_EntityType_GetDetail")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@ENTYPE_CODE", DbType.String, strEnTypeCode)
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                txtId.Text = ds.Tables(0).Rows(0)("ENTYPE_CODE").ToString()
                txtName.Text = ds.Tables(0).Rows(0)("ENTYPE_NAME").ToString()
                _EntityName = ds.Tables(0).Rows(0)("ENTYPE_NAME").ToString()
                ...
                Dim commProc2 As DbCommand = db.GetStoredProcCommand("GO_EntityType_GetMaxMod")

                commProc2.Parameters.Clear()

                db.AddInParameter(commProc2, "@ENTYPE_CODE", DbType.String, strEnTypeCode)
    ...
    Private Function DeleteData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("GO_EntityType_Remove")

        commProc.Parameters.Clear()

        db.AddInParameter(commProc, "@ENTYPE_CODE", DbType.String, _strEnType_Code)
        db.AddInParameter(commProc, "@MOD_NO", DbType.Int32, _intModno)
        db.AddOutParameter(commProc, "@RET_MOD_NO", DbType.Int32, 5)
        ...
        log_message = "Deleted Entity Legal Type " + _strEnType_Code + " Name " + txtName.Text.ToString()
        Logger.system_log(log_message)
    ...
    Private Function AuthorizeData() As TransState
        ...
        If _intModno > 1 Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_EntityType_Auth")
            ...
            If result = 0 Then
                ...
                If _EntName <> _EntityName Then
                    If _EntName = "" Then
                        log_message = " Authorized : Entity Legal Type Code : " + txtId.Text.Trim() + "." + " " + " Entity Legal Type Name  : " + _EntityName
                    Else
                        log_message = " Authorized : Entity Legal Type Code : " + txtId.Text.Trim() + "." + " " + " Entity Legal Type Name  : " + _EntName + " " + " To " + " " + _EntityName
                    End If

                    Logger.system_log(log_message)
                Else
                    log_message = " Authorized : Entity Legal Type Code : " + txtId.Text.Trim() + "." + " " + " Entity Legal Type Name  : " + txtName.Text.Trim()
                    Logger.system_log(log_message)
                End If
        ...
        ''log_message = "Authorized Entity Legal Type " + _strEnType_Code + " Name " + txtName.Text.ToString()
        ''Logger.system_log(log_message)
...
#End Region
    ...
    Private Sub FrmEntityLegalDet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
