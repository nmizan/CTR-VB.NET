'
'Author             : Fahad Khan
'Purpose            : SubmissionType Summary
...
Public Class FrmSubmissionTypeSumm

#Region "user defined codes"

    Dim _formName As String = "MaintenanceSubmissionTypeSumm"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_SubmissionType_GetDetailList")
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                dgView.Item(3, i).Value = dt.Rows(i).Item("SUBTYPE_CODE").ToString()
                dgView.Item(4, i).Value = dt.Rows(i).Item("SUBTYPE_NAME").ToString()
...
#End Region
    ...
    Private Sub FrmSubmissionTypeSumm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(1).Value Is Nothing) Then
                ...
                Dim frmSubTypeDet As New FrmSubmissionTypeDet(dgView.SelectedRows.Item(0).Cells(3).Value, dgView.SelectedRows.Item(0).Cells(1).Value)
                frmSubTypeDet.Show()
            End If
        Catch ex As Exception
    ...
    Private Sub btnAuthorize_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAuthorize.Click
        Try
            ...
            If MessageBox.Show("Do you really want to Authorize?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                For i = 0 To dgView.Rows.Count - 1
                    ...
                    If dgView.Rows(i).Cells(0).Value = True Then
                        ...
                        Else
                            ...
                            LoadSubTypeData(dgView.Rows(i).Cells(3).Value.ToString(), dgView.Rows(i).Cells(1).Value)


                            If (dgView.Rows(i).Cells(1).Value) > 1 Then

                                LoadSubTypeDataForAuth(dgView.Rows(i).Cells(3).Value.ToString())
                                ...
                                db.AddInParameter(commProc, "@SUBTYPE_CODE", DbType.String, dgView.Rows(i).Cells(3).Value.ToString())
                                ...
                                If result = 0 Then
                                    ...
                                    If _SubType <> _SubmissionType Then
                                        If _SubType = "" Then
                                            log_message = " Authorized : Submission Type Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Submission Type Name  : " + _SubmissionType
                                        Else
                                            log_message = " Authorized : Submission Type Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Submission Type Name  : " + _SubType + " " + " To " + " " + _SubmissionType
                                        End If
                ...
                '    log_message = "Authorized Submission Code " + dgView.Rows(i).Cells(3).Value.ToString() + " name " + dgView.Rows(i).Cells(4).Value.ToString()
                '    Logger.system_log(log_message)
                'Next i
