'
'Author             : Fahad Khan
'Purpose            : Maintain Division Information
...
Public Class FrmDivisionDet

#Region "Global Variables"

    Dim _formName As String = "MaintenanceGoDivisionDet"
...
#Region "User defined Codes"
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_DivisionType_Add")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@DIVCODE", DbType.String, txtId.Text.Trim())
            db.AddInParameter(commProc, "@DIVNAME", DbType.String, txtName.Text.Trim())
            ...
            If result = 0 Then
                ...
                log_message = " Added : Division Code : " + txtId.Text.Trim() + "." + " " + " Division Name : " + txtName.Text.ToString()
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_DivisionType_Update")
            ...
            If result = 0 Then
                ...
                If _DivName <> txtName.Text.Trim() Then

                    log_message = " Updated : Division Code : " + txtId.Text.Trim() + "." + " " + " Division  Name  : " + _DivName + " " + " To " + " " + txtName.Text.ToString()
                    Logger.system_log(log_message)
                Else
                    log_message = " Updated : Division Code : " + txtId.Text.Trim() + "." + " " + " Division  Name  : " + txtName.Text.Trim()
                    Logger.system_log(log_message)
                End If
            ...
            'log_message = "Updated Division " + txtId.Text.Trim() + " Name " + txtName.Text.ToString()
            'Logger.system_log(log_message)
        End If
    ...
    Private Sub LoadDvTypeDataForAuth(ByVal strDvTypeCode As String)
        ...
        Try
            ...
            ds = db.ExecuteDataSet(CommandType.Text, "Select * From GO_DIVISION_TYPE Where DIVCODE ='" & strDvTypeCode & "' and STATUS= 'L' ")
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                txtId.Text = ds.Tables(0).Rows(0)("DIVCODE").ToString()
                txtName.Text = ds.Tables(0).Rows(0)("DIVNAME").ToString()
                _DivisionName = ds.Tables(0).Rows(0)("DIVNAME").ToString()
    ...
    Private Sub LoadDvTypeData(ByVal strDvTypeCode As String, ByVal intMod As Integer)
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_DivisionType_GetDetail")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@DIVCODE", DbType.String, strDvTypeCode)
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                txtId.Text = ds.Tables(0).Rows(0)("DIVCODE").ToString()
                txtName.Text = ds.Tables(0).Rows(0)("DIVNAME").ToString()
                _DivName = ds.Tables(0).Rows(0)("DIVNAME").ToString()
                ...
                Dim commProc2 As DbCommand = db.GetStoredProcCommand("GO_DivisionType_GetMaxMod")

                commProc2.Parameters.Clear()

                db.AddInParameter(commProc2, "@DIVCODE", DbType.String, strDvTypeCode)
    ...
    Private Function DeleteData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("GO_DivisionType_Remove")

        commProc.Parameters.Clear()

        db.AddInParameter(commProc, "@DIVCODE", DbType.String, _strDvType_Code)
        db.AddInParameter(commProc, "@MOD_NO", DbType.Int32, _intModno)
        db.AddOutParameter(commProc, "@RET_MOD_NO", DbType.Int32, 5)
        ...
        log_message = "Deleted Division " + _strDvType_Code + " Name " + txtName.Text.ToString()
        Logger.system_log(log_message)
    ...
    Private Function AuthorizeData() As TransState
        ...
        If _intModno > 1 Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_DivisionType_Auth")
            ...
            If result = 0 Then
                ...
                If _DivisionName <> _DivName Then
                    If _DivisionName = "" Then
                        log_message = " Authorized : Division Code : " + txtId.Text.Trim() + "." + " " + " Division  Name  : " + _DivName
                    Else
                        log_message = " Authorized : Division Code : " + txtId.Text.Trim() + "." + " " + " Division  Name  : " + _DivisionName + " " + " To " + " " + _DivName
                    End If

                    Logger.system_log(log_message)
                Else
                    log_message = " Authorized : Division Code : " + txtId.Text.Trim() + "." + " " + " Division  Name  : " + txtName.Text.Trim()
                    Logger.system_log(log_message)
                End If
        ...
        'log_message = "Authorized Division " + _strDvType_Code + " Name " + txtName.Text.ToString()
        'Logger.system_log(log_message)
...
#End Region
    ...
    Private Sub FrmDivisionDet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
