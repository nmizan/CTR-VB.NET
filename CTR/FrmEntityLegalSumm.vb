'
'Author             : Fahad Khan
'Purpose            : Entity Legal Type Summary
...
Public Class FrmEntityLegalSumm

#Region "user defined codes"

    Dim _formName As String = "MaintenanceEntityLegalSumm"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_EntityType_GetDetailList")
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                dgView.Item(3, i).Value = dt.Rows(i).Item("ENTYPE_CODE").ToString()
                dgView.Item(4, i).Value = dt.Rows(i).Item("ENTYPE_NAME").ToString()
...
#End Region
    ...
    Private Sub FrmEntityLegalSumm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        Dim frmEntityLegal As New FrmEntityLegalDet()
        frmEntityLegal.ShowDialog()
    End Sub
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(1).Value Is Nothing) Then
                ...
                Dim frmEntityLegal As New FrmEntityLegalDet(dgView.SelectedRows.Item(0).Cells(3).Value, dgView.SelectedRows.Item(0).Cells(1).Value)
                frmEntityLegal.Show()
            End If
        Catch ex As Exception
    ...
    Private Sub btnAuthorize_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAuthorize.Click
        Try
            ...
            If MessageBox.Show("Do you really want to Authorize?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                For i = 0 To dgView.Rows.Count - 1
                    ...
                    If dgView.Rows(i).Cells(0).Value = True Then
                        ...
                        Else
                            ...
                            LoadEnTypeData(dgView.Rows(i).Cells(3).Value.ToString(), dgView.Rows(i).Cells(1).Value)


                            If (dgView.Rows(i).Cells(1).Value) > 1 Then

                                LoadEnTypeDataForAuth(dgView.Rows(i).Cells(3).Value.ToString())
                                ...
                                db.AddInParameter(commProc, "@ENTYPE_CODE", DbType.String, dgView.Rows(i).Cells(3).Value.ToString())
                                ...
                                If result = 0 Then
                                    ...
                                    If _EntName <> _EntityName Then
                                        If _EntName = "" Then
                                            log_message = " Authorized : Entity Legal Type Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Entity Legal Type Name  : " + _EntityName
                                        Else
                                            log_message = " Authorized : Entity Legal Type Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Entity Legal Type Name  : " + _EntName + " " + " To " + " " + _EntityName
                                        End If
                ...
                '    log_message = "Authorized Entity Legal " + dgView.Rows(i).Cells(3).Value.ToString() + " Name " + dgView.Rows(i).Cells(4).Value.ToString()
                '    Logger.system_log(log_message)
