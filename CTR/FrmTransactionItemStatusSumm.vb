'
'Author             : Fahad Khan
'Purpose            : Transaction Item Status Type Summary
...
Public Class FrmTransactionItemStatusSumm

#Region "user defined codes"

    Dim _formName As String = "MaintenanceTransactionItemStatusSumm"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_TransactionStatusType_GetDetailList")
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                dgView.Item(3, i).Value = dt.Rows(i).Item("TITYPE_CODE").ToString()
                dgView.Item(4, i).Value = dt.Rows(i).Item("TITYPE_NAME").ToString()
...
#End Region
    ...
    Private Sub FrmTransactionItemStatusSumm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(1).Value Is Nothing) Then
                ...
                Dim frmTransactionStatusDet As New FrmTransactionItemStatusDet(dgView.SelectedRows.Item(0).Cells(3).Value, dgView.SelectedRows.Item(0).Cells(1).Value)
                frmTransactionStatusDet.Show()
            End If
        Catch ex As Exception
            ...
            If MessageBox.Show("Do you really want to Authorize?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                For i = 0 To dgView.Rows.Count - 1
                    ...
                    If dgView.Rows(i).Cells(0).Value = True Then
                        ...
                        db.AddInParameter(commProc, "@TITYPE_CODE", DbType.String, dgView.Rows(i).Cells(3).Value.ToString())
                    ...
                    log_message = "Authorized Transaction Item Status " + dgView.Rows(i).Cells(3).Value.ToString() + " Address " + dgView.Rows(i).Cells(4).Value.ToString()
