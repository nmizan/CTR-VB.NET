...
#Region "User defined Codes"
    ...
    Private Sub DisableFields()
        txtDivCode.ReadOnly = True
        txtDivName.ReadOnly = True
    ...
    Private Function CheckValidData() As Boolean
        ...
        If txtDivCode.Text.Trim() = "" Then
            ...
            txtDivCode.Focus()
            Return False
        ElseIf txtDivName.Text.Trim() = "" Then
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then  ' OK
            ...
            strSql = "Insert Into FIU_DIVISION(DIV_CODE, DIV_NAME, INSERTED_ON,  MODIFIED_ON, MODNO, INPUT_BY, INPUT_DATETIME, IS_AUTHORIZED,  STATUS)" & _
                     "Values(@P_DIV_CODE, @P_DIV_NAME,@P_Inserted_On,@P_Modified_On,1,@P_Input_By,getdate(),0,'U')"

            Dim commProc As DbCommand = db.GetSqlStringCommand(strSql)

            commProc.Parameters.Clear()
            db.AddInParameter(commProc, "@P_DIV_CODE", DbType.String, txtDivCode.Text.Trim())
            db.AddInParameter(commProc, "@P_DIV_NAME", DbType.String, txtDivName.Text.Trim())
            ...
            Else
                ...
                '_intSlno = intSlno
                _strDiv_Code = txtDivCode.Text.Trim()

                _intModno = 1

                log_message = " Added : Division Code : " + txtDivCode.Text.Trim() + "." + " " + " Division Name : " + txtDivName.Text.Trim()
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Using conn As DbConnection = db.CreateConnection()
                ...
                db.ExecuteNonQuery(trans, CommandType.Text, "delete FIU_DIVISION where DIV_CODE='" & _strDiv_Code & "' and IS_AUTHORIZED=0")
                Dim ds As New DataSet


                strSql = "select isnull(max(MODNO),0)+1 maxmodno from FIU_DIVISION where DIV_CODE='" & _strDiv_Code & "'"


                intModno = db.ExecuteDataSet(trans, CommandType.Text, strSql).Tables(0).Rows(0)(0)

                strSql = "Insert Into FIU_DIVISION(DIV_CODE, DIV_NAME, INSERTED_ON,  MODIFIED_ON, MODNO, INPUT_BY, INPUT_DATETIME, IS_AUTHORIZED, STATUS)" & _
                     "Values(@P_DIV_CODE, @P_DIV_NAME,@P_Inserted_On,@P_Modified_On," & intModno.ToString() & ",@P_Input_By,getdate(),0,'U')"
                ...
                Else
                    ...
                    '------------Mizan Work (10-04-16)---------
                    If _DName <> txtDivName.Text.Trim() Then

                        log_message = " Updated : Division Code : " + txtDivCode.Text.Trim() + "." + " " + " Division Name : " + _DName + " " + " To " + " " + txtDivName.Text.Trim()
                        Logger.system_log(log_message)
                    Else
                        log_message = " Updated : Division Code : " + txtDivCode.Text.Trim()
                        Logger.system_log(log_message)
                    End If
                    '------------Mizan Work (10-04-16)---------
    ...
    Private Sub LoadDivisionDataForAuth(ByVal strDivCode As String)
        ...
        Try
            ...
            ds = db.ExecuteDataSet(CommandType.Text, "Select * From FIU_DIVISION Where DIV_CODE='" & strDivCode & "' and STATUS = 'L' ")

            If ds.Tables(0).Rows.Count > 0 Then


                _strDiv_Code = strDivCode


                _formMode = FormTransMode.Update


                txtDivCode.Text = ds.Tables(0).Rows(0)("DIV_CODE").ToString()

                'txtDivName.Text = ds.Tables(0).Rows(0)("DIV_NAME").ToString()
                _DivisionName = ds.Tables(0).Rows(0)("DIV_NAME").ToString()
    ...
    Private Sub LoadDivisionData(ByVal strDivCode As String, ByVal intMod As Integer)
        ...
        Try
            ...
            ds = db.ExecuteDataSet(CommandType.Text, "Select * From FIU_DIVISION Where DIV_CODE='" & strDivCode & "' and MODNO=" & intMod.ToString())
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                txtDivName.Text = ds.Tables(0).Rows(0)("DIV_NAME").ToString()
                _DName = ds.Tables(0).Rows(0)("DIV_NAME").ToString()
                ...
                lblVerTot.Text = db.ExecuteDataSet(CommandType.Text, "Select Count(MODNO) From FIU_DIVISION Where DIV_CODE='" & strDivCode & "'").Tables(0).Rows(0)(0).ToString()
    ...
    Public Sub New(ByVal strDivCode As String, ByVal intMod As Integer)

        ' This call is required by the Windows Form Designer.
        InitializeComponent()
        LoadDivisionData(strDivCode, intMod)
    ...
    Private Function AuthorizeData() As TransState
        ...
        LoadDivisionDataForAuth(_strDiv_Code)  '------------Mizan Work (17-04-16)---------
        ...
        Using conn As DbConnection = db.CreateConnection()
            ...
            strSql = "select IS_AUTHORIZED,STATUS from FIU_DIVISION where DIV_CODE='" & _strDiv_Code & "' and MODNO=" & _intModno.ToString()
            ...
            If ds.Tables(0).Rows(0)("IS_AUTHORIZED") = 0 Then
                ...
                If ds.Tables(0).Rows(0)("STATUS") = "U" Then
                    strSql = "update FIU_DIVISION set AUTH_BY='" & CommonAppSet.User.ToString().Trim() & _
                    "', AUTH_DATETIME=getdate(), IS_AUTHORIZED=1, STATUS = 'L' " & _
                    " where  DIV_CODE='" & _strDiv_Code & "' and MODNO=" & _intModno.ToString()
                ...
                ElseIf result > 0 Then
                    ...
                    If _intModno > 1 Then
                        ...
                        strSql = "update FIU_DIVISION set STATUS = 'C' " & _
                            " where DIV_CODE='" & _strDiv_Code & "' and MODNO=" & (_intModno - 1).ToString() & _
                            " and STATUS ='D'"

                        db.ExecuteNonQuery(trans, CommandType.Text, strSql)

                        'if previous modification status is L(Deleted) then make it O(Open)
                        strSql = "update FIU_DIVISION set STATUS = 'O' " & _
                            " where DIV_CODE='" & _strDiv_Code & "' and MODNO=" & (_intModno - 1).ToString() & _
                            " and STATUS ='L'"
                    ...
                    '------------Mizan Work (17-04-16)---------
                    If _DivisionName <> _DName Then

                        log_message = " Authorized : Division  Code : " + txtDivCode.Text.Trim() + "." + " " + " Division  Name : " + _DivisionName + " " + " To " + " " + _DName
                        Logger.system_log(log_message)
                    Else
                        log_message = " Authorized : Division  Code : " + txtDivCode.Text.Trim()
                        Logger.system_log(log_message)
                    End If
                    '------------Mizan Work (17-04-16)---------
            ...
            'log_message = "Authorized Division Code " + txtDivCode.Text.Trim() + " Division Name " + txtDivName.Text.Trim()
            'Logger.system_log(log_message)
        ...
        Using conn As DbConnection = db.CreateConnection()
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                If ds.Tables(0).Rows(0)(0) = False Then 'if not authorized
                    ...
                    strSql = "delete FIU_DIVISION where DIV_CODE='" & _strDiv_Code & "' and MODNO=" & _intModno.ToString() & " and IS_AUTHORIZED=0"
                ...
                ElseIf ds.Tables(0).Rows(0)(0) = True Then 'if authorized
                    ...
                    If ds.Tables(0).Rows(0)("STATUS") = "L" Then 'if this is the last modified data
                        ...
                        strSql = "delete FIU_DIVISION where DIV_CODE='" & _strDiv_Code & "'  and IS_AUTHORIZED=0"

                        db.ExecuteNonQuery(trans, CommandType.Text, strSql)

                        strSql = "select * from FIU_DIVISION where DIV_CODE='" & _strDiv_Code & "' and MODNO=" & _intModno.ToString()
                        ...
                        strSql = "Insert Into FIU_DIVISION(DIV_CODE, DIV_NAME, INSERTED_ON,  MODIFIED_ON, MODNO, INPUT_BY, INPUT_DATETIME, IS_AUTHORIZED,  STATUS)" & _
                     "Values(@P_DIV_CODE, @P_DIV_NAME, @P_Inserted_On,@P_Modified_On," & intModno.ToString() & ",@P_Input_By,getdate(),0,'D')"
                        ...
                        db.AddInParameter(commProc, "@P_DIV_NAME", DbType.String, dsKeeper.Tables(0).Rows(0)("DIV_NAME"))
            ...
            log_message = "Delete Division Code " + txtDivCode.Text.Trim()
            Logger.system_log(log_message)
...
#End Region
    ...
    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        ...
        If txtDivCode.Enabled = True Then
            txtDivCode.Focus()
        End If
            ...
            If MessageBox.Show("Do you really want to Save?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                If CheckValidData() Then  ' Ok
                    ...
                    If tState = TransState.Add Then
                        ...
                        LoadDivisionData(_strDiv_Code, _intModno)
    ...
    Private Sub btnNextVer_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNextVer.Click
        ...
        If _intModno = 0 Then
            ...
            LoadDivisionData(strDiv_Code, intModno)
        End If
    End Sub
End Class