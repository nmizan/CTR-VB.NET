...
'
'Author             : Fahad Khan
'Purpose            : Show Unauthorized Transaction Status Information
...
Public Class FrmReportStatusUnAuthTrans

#Region "user defined codes"

    Dim _formName As String = "ReportStatusUnAuthorizedTransaction"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_UnauthorizedTransaction_GetDetailList")
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                dgView.Item(1, i).Value = dt.Rows(i).Item("TXN_DATE").ToString()
...
#End Region
    ...
    Private Sub FrmReportStatusUnAuthTrans_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        Try
            ...
            If MessageBox.Show("Do you really want to Delete?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                Dim commProc As DbCommand = db.GetStoredProcCommand("GO_UnauthorizedTrans_Remove")
                ...
                For i = 0 To dgView.Rows.Count - 1
                    ...
                    If dgView.Rows(i).Cells(0).Value = True Then
                        ...
                        db.AddInParameter(commProc, "@TXN_DATE", DbType.String, dgView.Rows(i).Cells(1).Value.ToString())
                    ...
                    End If
                    log_message = " Deleted : Unauthorized Transaction Date : " + dgView.Rows(i).Cells(1).Value.ToString()
