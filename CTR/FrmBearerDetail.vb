...
Public Class FrmBearerDetail

#Region "Global Variables"

    Dim _formName As String = "MaintenanceGoBearerDetail"
    ...
    Dim _brefNo As String = ""

    Dim BearerList As New List(Of String)
    Dim _bearerLog As String = ""
    Dim _Blog As String = ""
...
#Region "User defined Codes"
    ...
    Private Function CheckValidData() As Boolean
        ...
        ElseIf txtLast.Text.Trim() = "" Then
            ...
            '    MessageBox.Show("Birth Registration Number required !!", "Saving Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            '    txtIDNumber.Focus()
            '    Return False
        ...
        ElseIf txtReferenceNumber.Text.Trim() = "" Then
            MessageBox.Show("Reference Number required !!", "Saving Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then
            ...
            Using conn As DbConnection = db.CreateConnection()
                ...
                Dim strSql As String = "SELECT REFERENCE_NUMBER FROM GO_BEARER_INFO WHERE REFERENCE_NUMBER=@REFERENCE_NUMBER"


                Dim commProcr As DbCommand = db.GetSqlStringCommand(strSql)

                commProcr.Parameters.Clear()

                db.AddInParameter(commProcr, "@REFERENCE_NUMBER", DbType.String, txtReferenceNumber.Text)

                dtBearerRef = db.ExecuteDataSet(commProcr, trans).Tables(0)


                If dtBearerRef.Rows.Count > 0 Then


                    MessageBox.Show("Duplicate Bearer/Depositor Reference Number : " + txtReferenceNumber.Text.ToString() + " ", "Error!!", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Exit Function
                ...
                Else
                    ...
                    commProcr = db.GetSqlStringCommand(strSql)
                    ...
                    Else
                        ...
                        Dim commProc As DbCommand = db.GetStoredProcCommand("GO_Bearer_Add")
                        ...
                        db.AddInParameter(commProc, "@REFERENCE_NUMBER", DbType.String, txtReferenceNumber.Text)
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Using conn As DbConnection = db.CreateConnection()
                ...
                Dim commProc As DbCommand = db.GetStoredProcCommand("GO_Bearer_Update")
                ...
                If _title <> txtTitle.Text.Trim() Then
                    ...
                    End If
                    BearerList.Add(log_message)
                End If
                If _refNo <> txtReferenceNumber.Text.Trim() Then
                    log_message = " Reference No " + _refNo + " " + " To " + " " + txtReferenceNumber.Text.ToString() + "." + " "
                    BearerList.Add(log_message)
                End If
                ...
                For Each bearlist As String In BearerList
                    _bearerLog += bearlist
                Next

                _Blog = " Updated : Bearer/Depositor Person ID : " + txtId.Text.ToString() + "." + " " + _bearerLog

                Logger.system_log(_Blog)
                _bearerLog = ""
                BearerList.Clear()
                ...
                ''log_message = "Updated Bearer/depositor Person " + txtId.Text.Trim() + " Name " + txtFirstName.Text.ToString() + " " + txtLast.Text.ToString()
                ''Logger.system_log(log_message)
    ...
    Private Sub LoadMainDataForAuth(ByVal strId As String)
        ...
        Try
            ...
            ds = db.ExecuteDataSet(CommandType.Text, "Select * From  GO_BEARER_INFO Where PERSON_ID ='" & strId & "' and STATUS ='L' ")
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                txtReferenceNumber.Text = ds.Tables(0).Rows(0)("REFERENCE_NUMBER").ToString()
                _brefNo = ds.Tables(0).Rows(0)("REFERENCE_NUMBER").ToString()
    ...
    Private Sub LoadMainData(ByVal strId As String, ByVal intmod As Integer)
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_Bearer_GetDetail")
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                txtReferenceNumber.Text = ds.Tables(0).Rows(0)("REFERENCE_NUMBER").ToString()
                _refNo = ds.Tables(0).Rows(0)("REFERENCE_NUMBER").ToString()
                ...
                lblInputDate.Text = ds.Tables(0).Rows(0)("INPUT_DATETIME")
                ...
                Dim commProc2 As DbCommand = db.GetStoredProcCommand("GO_Bearer_GetMaxMod")
    ...
    Private Sub LoadMainData2(ByVal strRefNo As String)

        'MessageBox.Show(strRefNo)
      

        lblToolStatus.Text = ""

        Try
            txtReferenceNumber.Text = strRefNo
            ...
            Dim commProc5 As DbCommand = db.GetStoredProcCommand("GO_Bearer_GetDetailByRef")


            commProc5.Parameters.Clear()
            db.AddInParameter(commProc5, "@REFERENCE_NUMBER", DbType.String, strRefNo)

            ds2 = db.ExecuteDataSet(commProc5)
            ...
            If ds2.Tables(0).Rows.Count > 0 Then
                ...
                strId = ds2.Tables(0).Rows(0)("PERSON_ID").ToString()
                intmod = ds2.Tables(0).Rows(0)("MOD_NO")

            Else


                MessageBox.Show("Bearer/Depositor not Exists!! Please Maintenance Bearer/Depositor", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Private Sub LoadReferenceData(ByVal strRefNo As String)
        ...
        Try
            ...
            If Not strId = "" Then
                ...
                commProc5 = db.GetStoredProcCommand("GO_Bearer_GetMaxMod")

                commProc5.Parameters.Clear()

                db.AddInParameter(commProc5, "@PERSON_ID", DbType.String, strId)

                Dim intModNo As Integer = db.ExecuteDataSet(commProc5).Tables(0).Rows(0)(0).ToString()
    ...
    Private Sub LoadPersonalPhoneData(ByVal strId As String, ByVal intmod As Integer)
        ...
        Try
            ...
            Dim commProcSche As DbCommand = db.GetStoredProcCommand("GO_BearerPersonalPhone_GetDetails")
    ...
    Private Sub LoadEmployerPhoneData(ByVal strId As String, ByVal intmod As Integer)
        ...
        Try
            ...
            Dim commProcSche As DbCommand = db.GetStoredProcCommand("GO_BearerEmployerPhone_GetDetails")
    ...
    Private Sub LoadPersonAddressData(ByVal strId As String, ByVal intmod As Integer)
        ...
        Try
            ...
            Dim dt As New DataTable
            Dim Status As String = "P"
            Dim commProcSche As DbCommand = db.GetStoredProcCommand("GO_BearerPersonalAddress_GetDetails")
    ...
    Private Sub LoadEmployerAddressData(ByVal strId As String, ByVal intmod As Integer)
        ...
        Try
            ...
            Dim dt As New DataTable
            Dim Status As String = "E"
            Dim commProcSche As DbCommand = db.GetStoredProcCommand("GO_BearerEmployerAddress_GetDetails")
    ...
    Private Sub LoadIdentificationData(ByVal strId As String, ByVal intmod As Integer)
        ...
        Try
            ...
            Dim dt As New DataTable
            Dim Status As String = "E"
            Dim commProcSche As DbCommand = db.GetStoredProcCommand("GO_BearerIdentificarion_GetDetails")
    ...
    Public Sub New(ByVal strRefNo As String)

        ' This call is required by the Windows Form Designer.
        InitializeComponent()

        ' Add any initialization after the InitializeComponent() call.
        ' LoadMainData2(strRefNo)
        _strRefNo = strRefNo
    ...
    Private Function AuthorizeData() As TransState
        ...
        If _intModno > 1 Then
            ...
            If result = 0 Then
                ...
                _Blog = " Authorized : Bearer/depositor Person ID : " + txtId.Text.ToString() + "." + " " + _bearerLog
            ...
            'log_message = "Authorized Bearer/depositor Person " + _strId + " Name " + txtTitle.Text.ToString() + " " + txtFirstName.Text.ToString() + " " + txtMiddle.Text.ToString() + " " + txtLast.Text.ToString()
            'Logger.system_log(log_message)
        ...
        Else
            ...
            If result = 0 Then
                ...
                _Blog = " Authorized : Bearer/depositor Person ID : " + txtId.Text.ToString() + "." + " " + " For Mandatory Field : " + "." + " " + _bearerLog
    ...
    Private Function DeleteData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("GO_Bearer_Remove")
        ...
        log_message = " Deleted Bearer/depositor Person " + _strId + " Name " + txtFirstName.Text.ToString() + " " + txtLast.Text.ToString()
        Logger.system_log(log_message)
...
#End Region
    ...
    Private Sub FrmBearerDetail_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnAddPersonalAddressGrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAddPersonalAddressGrid.Click
        ...
        btmCancelAddress.Visible = False
        btnRemovePersonalAddtoGrid.Enabled = True
        btnAddPersonalAddressGrid.Text = "Add"
        Label80.Text = ""
    ...
    Private Sub btmEnployerAddressAddToGrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btmEnployerAddressAddToGrid.Click
        ...
        btnCancelEmptoGrid.Visible = False
        btnEmployerRemoveGrid.Enabled = True
        btmEnployerAddressAddToGrid.Text = "Add"
        Label80.Text = ""
    ...
    Private Sub btnIdentificationAddToGrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnIdentificationAddToGrid.Click
        ...
        btnCancelIdenticication.Visible = False
        btnRemoveIdentificationToGrid.Enabled = True
        btnIdentificationAddToGrid.Text = "Add"
        Label80.Text = ""
    ...
    Private Sub btnSearchBearer_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearchBearer.Click
        'Dim frmList As New FrmList()
        'frmList.Text = "Bearer/Depositor  List"
        'frmList.ProcName = "GO_Bearer_GetList"
        'frmList.filter = New String(,) {{"REFERENCE_NUMBER", "Reference Number"}, {"NAME", "Bearer/Depositor Name"}}
        'frmList.colwidth = New Integer(,) {{1, 300}}
        'frmList.colrename = New String(,) {{"0", "Reference Number"}, {"1", "Bearer/Depositor Name"}}
        'frmList.ShowDialog()

        'If (frmList.RowResult.Cells.Count > 0) Then

        '    txtReferenceNumber.Text = frmList.RowResult.Cells(0).Value.ToString()
        ...
        If Not (txtReferenceNumber.Text.Trim() = "") Then
            LoadReferenceData(txtReferenceNumber.Text.Trim())
        End If
    End Sub

    'Private Sub txtReferenceNumber_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtReferenceNumber.Leave
    '    Try
    ...
    '        Dim commProc As DbCommand = db.GetStoredProcCommand("GO_Bearer_GetDetailByRef")

    '        commProc.Parameters.Clear()

    '        db.AddInParameter(commProc, "@REFERENCE_NUMBER", DbType.String, txtReferenceNumber.Text.Trim())

    '        dt = db.ExecuteDataSet(commProc).Tables(0)

    '        If dt.Rows.Count > 0 Then
    '            txtReferenceNumber.Text = dt.Rows(0)("REFERENCE_NUMBER").ToString()
    '            If dt.Rows(0)("GENDER").ToString() = "M" Then
    '                cmbSex.Text = "Male"
    '            Else
    '                cmbSex.Text = "Female"
    '            End If
    ...
    'Private Sub txtReferenceNumber_MouseLeave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtReferenceNumber.MouseLeave
    '    Try
    ...
    Private Sub txtReferenceNumber_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtReferenceNumber.KeyDown
