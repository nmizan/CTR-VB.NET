...
Public Class FrmBankBranchSumm

#Region "user defined codes"

    Dim _formName As String = "MaintenanceBankBranchSummary"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            If chkShowAll.Checked = True Then
                strSql = "select BRANCH_CODE, BANK_CODE, BRANCH_NAME,IS_AUTHORIZED,MODNO, " + _
                    " 'S' = " + _
                    "	CASE  " + _
                    ...
                    "       ELSE 'U' " + _
                    "	End " + _
                    " from FIU_BANK_BRANCH " + _
                    " where IS_AUTHORIZED=0 OR STATUS in ('L','D')  " + _
                    " order by IS_AUTHORIZED,BRANCH_CODE"
...
#End Region
    ...
    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        ...
        Dim frmBranch As New FrmBankBranch
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(0).Value Is Nothing) Then
                ...
                Dim frmBranch As New FrmBankBranch(dgView.SelectedRows.Item(0).Cells(2).Value, dgView.SelectedRows.Item(0).Cells(0).Value)
                frmBranch.ShowDialog()
            End If
    ...
    Private Sub FrmBankBranchSumm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
