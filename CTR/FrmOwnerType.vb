...
Public Class FrmOwnerType



#Region "Global Variables"
    Dim _formName As String = "MaintenanceOwnerTypeDetail"
    Dim opt As SecForm = New SecForm(_formName)


    Dim _formMode As FormTransMode
    'Dim _intSlno As Integer = 0
    Dim _strOwnerTypeCode As String = ""
...
#Region "User defined Codes"
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then  ' OK
            ...
            strSql = "Insert Into FIU_OWNERSHIP_TYPES(OWTYPECODE, OWDEFINITION, INSERTED_ON, MODIFIED_ON, MODNO, INPUT_BY, INPUT_DATETIME, IS_AUTHORIZED, STATUS) " & _
                     " Values(@P_OWTYPECODE, @P_OWDEFINITION, @P_INSERTED_ON, @P_MODIFIED_ON, 1, @P_INPUT_BY, getdate(), 0, 'U')"


            Dim commProc As DbCommand = db.GetSqlStringCommand(strSql)

            commProc.Parameters.Clear()
            db.AddInParameter(commProc, "@P_OWTYPECODE", DbType.String, txtId.Text.Trim())
            db.AddInParameter(commProc, "@P_OWDEFINITION", DbType.String, txtName.Text.Trim())
            ...
            Else
                ...
                _strOwnerTypeCode = txtId.Text.Trim()

                _intModno = 1

                log_message = " Added : Owner Type Code : " + txtId.Text.Trim() + "." + " " + " Owner Type Name : " + txtName.Text.Trim()
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Using conn As DbConnection = db.CreateConnection()
                ...
                db.ExecuteNonQuery(trans, CommandType.Text, "delete FIU_OWNERSHIP_TYPES where OWTYPECODE='" & _strOwnerTypeCode & "' and IS_AUTHORIZED=0")
                Dim ds As New DataSet


                strSql = "select isnull(max(MODNO),0)+1 maxmodno from FIU_OWNERSHIP_TYPES where OWTYPECODE='" & _strOwnerTypeCode & "'"


                intModno = db.ExecuteDataSet(trans, CommandType.Text, strSql).Tables(0).Rows(0)(0)

                strSql = "Insert Into FIU_OWNERSHIP_TYPES(OWTYPECODE, OWDEFINITION,  INSERTED_ON, MODIFIED_ON, MODNO, INPUT_BY, INPUT_DATETIME, IS_AUTHORIZED, STATUS) " & _
                     " Values(@P_OWTYPECODE, @P_OWDEFINITION," & _
                ...
                Else
                    ...
                    '----------Mizan Work (10-04-2016)---------------
                    If _OwName <> txtName.Text.Trim() Then

                        log_message = " Updated : Owner Type Code : " + txtId.Text.Trim() + "." + " " + " Owner Type Name : " + _OwName + " " + " To " + " " + txtName.Text.ToString()
                        Logger.system_log(log_message)
                    Else
                        log_message = " Updated : Owner Type Code : " + txtId.Text.Trim() + "." + " " + " Owner Type Name : " + txtName.Text.ToString()
                        Logger.system_log(log_message)
                    End If
                    '----------Mizan Work (10-04-2016)---------------
    ...
    Private Function AuthorizeData() As TransState
        ...
        If _intModno > 1 Then
            ...
            LoadOwnerTypeDataForAuth(_strOwnerTypeCode)
            ...
            Using conn As DbConnection = db.CreateConnection()
                ...
                strSql = "select IS_AUTHORIZED,STATUS from FIU_OWNERSHIP_TYPES where OWTYPECODE='" & _strOwnerTypeCode & "' and MODNO=" & _intModno.ToString()
                ...
                If ds.Tables(0).Rows(0)("IS_AUTHORIZED") = 0 Then
                    ...
                    If ds.Tables(0).Rows(0)("STATUS") = "U" Then
                        strSql = "update FIU_OWNERSHIP_TYPES set AUTH_BY='" & CommonAppSet.User.ToString().Trim() & _
                        "', AUTH_DATETIME=getdate(), IS_AUTHORIZED=1, STATUS = 'L' " & _
                        " where OWTYPECODE='" & _strOwnerTypeCode & "' and MODNO=" & _intModno.ToString()
                    ...
                    ElseIf result > 0 Then
                        ...
                        If _intModno > 1 Then
                            ...
                            strSql = "update FIU_OWNERSHIP_TYPES set STATUS = 'C' " & _
                                " where OWTYPECODE='" & _strOwnerTypeCode & "' and MODNO=" & (_intModno - 1).ToString() & _
                                " and STATUS ='D'"

                            db.ExecuteNonQuery(trans, CommandType.Text, strSql)

                            'if previous modification status is L(Deleted) then make it O(Open)
                            strSql = "update FIU_OWNERSHIP_TYPES set STATUS = 'O' " & _
                                " where OWTYPECODE='" & _strOwnerTypeCode & "' and MODNO=" & (_intModno - 1).ToString() & _
                                " and STATUS ='L'"
                        ...
                        If _OwnerName <> _OwName Then
                            If _OwnerName = "" Then
                                log_message = " Authorized : Owner Type Code : " + txtId.Text.Trim() + "." + " " + " Owner Type Name : " + _OwName
                            Else
                                log_message = " Authorized : Owner Type Code : " + txtId.Text.Trim() + "." + " " + " Owner Type Name : " + _OwnerName + " " + " To " + " " + _OwName
                            End If

                            Logger.system_log(log_message)
                        Else

                            log_message = "Authorized : Owner Type Code : " + txtId.Text.Trim() + "." + " " + " Owner Type Name : " + txtName.Text.Trim()
                            Logger.system_log(log_message)
    ...
    Private Sub LoadOwnerTypeDataForAuth(ByVal strOwnerTypeCd As String)
        ...
        Try
            ...
            ds = db.ExecuteDataSet(CommandType.Text, "Select * From FIU_OWNERSHIP_TYPES Where OWTYPECODE='" & strOwnerTypeCd & "' and STATUS = 'L' ")

            If ds.Tables(0).Rows.Count > 0 Then


                _strOwnerTypeCode = ds.Tables(0).Rows(0)("OWTYPECODE").ToString()

                _formMode = FormTransMode.Update


                txtId.Text = _strOwnerTypeCode
                'txtName.Text = ds.Tables(0).Rows(0)("OWDEFINITION").ToString()
                _OwnerName = ds.Tables(0).Rows(0)("OWDEFINITION").ToString()
    ...
    Private Sub LoadOwnerTypeData(ByVal strOwnerTypeCd As String, ByVal intMod As Integer)
        ...
        Try
            ...
            ds = db.ExecuteDataSet(CommandType.Text, "Select * From FIU_OWNERSHIP_TYPES Where OWTYPECODE='" & strOwnerTypeCd & "' and MODNO=" & intMod.ToString())
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                txtId.Text = _strOwnerTypeCode
                txtName.Text = ds.Tables(0).Rows(0)("OWDEFINITION").ToString()
                _OwName = ds.Tables(0).Rows(0)("OWDEFINITION").ToString()
                ...
                lblVerTot.Text = db.ExecuteDataSet(CommandType.Text, "Select Count(ModNo) From FIU_OWNERSHIP_TYPES Where OWTYPECODE='" & strOwnerTypeCd & "'").Tables(0).Rows(0)(0).ToString()
        ...
        Using conn As DbConnection = db.CreateConnection()
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                If ds.Tables(0).Rows(0)(0) = False Then 'if not authorized
                    ...
                    strSql = "delete FIU_OWNERSHIP_TYPES where OWTYPECODE='" & _strOwnerTypeCode & "' and MODNO=" & _intModno.ToString() & " and IS_AUTHORIZED=0"
                ...
                ElseIf ds.Tables(0).Rows(0)(0) = True Then 'if authorized
                    ...
                    If ds.Tables(0).Rows(0)("STATUS") = "L" Then 'if this is the last modified data
                        ...
                        strSql = "delete FIU_OWNERSHIP_TYPES where OWTYPECODE='" & _strOwnerTypeCode & "' and IS_AUTHORIZED=0"

                        db.ExecuteNonQuery(trans, CommandType.Text, strSql)

                        strSql = "select * from FIU_OWNERSHIP_TYPES where OWTYPECODE='" & _strOwnerTypeCode & "' and MODNO=" & _intModno.ToString()
                        ...
                        strSql = "Insert Into FIU_OWNERSHIP_TYPES(OWTYPECODE, OWDEFINITION," & _
                     ...
                     "@P_Inserted_On,@P_Modified_On," & intModno.ToString() & ",@P_Input_By,getdate(),0,'D')"
                        ...
                        commProc.Parameters.Clear()
                        db.AddInParameter(commProc, "@P_OWTYPECODE", DbType.String, _strOwnerTypeCode)
                        db.AddInParameter(commProc, "@P_OWDEFINITION", DbType.String, dsKeeper.Tables(0).Rows(0)("OWDEFINITION"))
            ...
            log_message = "Delete Owner Type Code " + txtId.Text.Trim()
            Logger.system_log(log_message)
...
#End Region
    ...
    Public Sub New(ByVal intModno As Integer, ByVal strAccTypeCode As String)
        ...
        _strOwnerTypeCode = strAccTypeCode
        _intModno = intModno
            ...
            If MessageBox.Show("Do you really want to Save?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                If CheckValidData() Then  ' Ok
                    ...
                    If tState = TransState.Add Then
                        ...
                        LoadOwnerTypeData(_strOwnerTypeCode, _intModno)
    ...
    Private Sub btnPrevVer_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrevVer.Click
        If _intModno - 1 > 0 Then
            LoadOwnerTypeData(_strOwnerTypeCode, _intModno - 1)
    ...
    Private Sub btnNextVer_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNextVer.Click
        ...
        Dim strAccTypeCode As String = _strOwnerTypeCode
        ...
        If _intModno = 0 Then
            ...
            LoadOwnerTypeData(strAccTypeCode, intModno)
        End If
    ...
    Private Sub FrmOwnerType_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
