'
'Author             : Fahad Khan
'Purpose            : Maintain Communication Type Information
...
Public Class FrmCommunicationTypeDet

#Region "Global Variables"

    Dim _formName As String = "MaintenanceCommunicationTypeDet"
    Dim opt As SecForm = New SecForm(_formName)

    Dim _formMode As FormTransMode
    Dim _intModno As Integer = 0
    Dim _strCmType_Code As String = ""
...
#Region "User defined Codes"
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_CommunicationType_Add")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@CMTYPE_CODE", DbType.String, txtId.Text.Trim())
            db.AddInParameter(commProc, "@CMTYPE_NAME", DbType.String, txtName.Text.Trim())
            ...
            If result = 0 Then
                ...
                _strCmType_Code = txtId.Text.Trim()

                _intModno = 1

                log_message = " Added : Communication Type : " + txtId.Text.Trim() + "." + " " + " Communication Name : " + txtName.Text.ToString()
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_CommunicationType_Update")
            ...
            If result = 0 Then
                ...
                If _ComName <> txtName.Text.Trim() Then

                    log_message = " Updated : Communication Type : " + txtId.Text.Trim() + "." + " " + " Communication Name : " + _ComName + " " + " To " + " " + txtName.Text.ToString()
                    Logger.system_log(log_message)
                Else
                    log_message = " Updated : Communication Type : " + txtId.Text.Trim() + "." + " " + " Communication Name : " + txtName.Text.Trim()
                    Logger.system_log(log_message)
                End If
            ...
            'log_message = "Update Communication Type " + txtId.Text.Trim() + " Name " + _ComName + " To " + txtName.Text.ToString()
            'Logger.system_log(log_message)
        End If
    ...
    Private Sub LoadCmTypeDataForAuth(ByVal strCmTypeCode As String)
        ...
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                _strCmType_Code = strCmTypeCode
                
                _formMode = FormTransMode.Update


                txtId.Text = ds.Tables(0).Rows(0)("CMTYPE_CODE").ToString()
    ...
    Private Sub LoadCmTypeData(ByVal strCmTypeCode As String, ByVal intMod As Integer)
        ...
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                Dim commProc2 As DbCommand = db.GetStoredProcCommand("GO_CommunicationType_GetMaxMod")

                commProc2.Parameters.Clear()

                db.AddInParameter(commProc2, "@CMTYPE_CODE", DbType.String, strCmTypeCode)
    ...
    Public Sub New(ByVal strCmTypeCode As String, ByVal intMod As Integer)

        ' This call is required by the Windows Form Designer.
        InitializeComponent()

        ' Add any initialization after the InitializeComponent() call.
        LoadCmTypeData(strCmTypeCode, intMod)
        _strCmType_Code = strCmTypeCode
        _intModno = intMod
    ...
    Private Function DeleteData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("GO_CommunicationType_Remove")

        commProc.Parameters.Clear()

        db.AddInParameter(commProc, "@CMTYPE_CODE", DbType.String, _strCmType_Code)
        db.AddInParameter(commProc, "@MOD_NO", DbType.Int32, _intModno)
        db.AddOutParameter(commProc, "@RET_MOD_NO", DbType.Int32, 5)
        ...
        log_message = "Deleted Communication Type " + _strCmType_Code + " Name " + txtName.Text.ToString()
        Logger.system_log(log_message)
        Return tStatus
    ...
    Private Function AuthorizeData() As TransState
        ...
        If _intModno > 1 Then
            ...
            LoadCmTypeDataForAuth(_strCmType_Code)
            Dim tStatus As TransState
            ...
            If result = 0 Then
                ...
                If _ComunicationName <> _ComName Then
                    If _ComunicationName = "" Then
                        log_message = " Authorized : Communication Type : " + txtId.Text.Trim() + "." + " " + " Communication Name : " + _ComName
                    Else
                        log_message = " Authorized : Communication Type : " + txtId.Text.Trim() + "." + " " + " Communication Name : " + _ComunicationName + " " + " To " + " " + _ComName
                    End If

                    Logger.system_log(log_message)
                Else
                    log_message = " Authorized : Communication Type : " + txtId.Text.Trim() + "." + " " + " Communication Name : " + txtName.Text.Trim()
                    Logger.system_log(log_message)
                End If
        ...
        'log_message = "Authorized Communication Type " + _strCmType_Code + " Name " + txtName.Text.ToString()
        'Logger.system_log(log_message)
...
#End Region
    ...
    Private Sub FrmCommunicationTypeDet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If _intModno > 0 Then
            LoadCmTypeData(_strCmType_Code, _intModno)
        End If
    ...
    Private Sub btnUnlock_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUnlock.Click
        ...
        If Not (_strCmType_Code.Trim() = "") Then
