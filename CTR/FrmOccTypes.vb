...
Public Class FrmOccTypes

#Region "Global Variables"

    Dim _formName As String = "MaintenanceOccupationTypeDetail"
    ...
    Dim _strOccTypes_Code As String = ""
    Dim log_message As String
    Dim _OName As String = ""
...
#Region "User defined Codes"
    ...
    Private Sub DisableFields()
        txtOccTypesCode.ReadOnly = True
        txtOccTypesName.ReadOnly = True
    ...
    Private Sub EnableFields()
        txtOccTypesCode.ReadOnly = False
        txtOccTypesName.ReadOnly = False
    ...
    Private Sub ClearFields()
        txtOccTypesCode.Clear()
        txtOccTypesName.Clear()
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then  ' OK
            ...
            strSql = "Insert Into FIU_OCCUPATION_TYPES(OCTYPECODE, OCDEFINITION, INSERTED_ON,  MODIFIED_ON, MODNO, INPUT_BY, INPUT_DATETIME, IS_AUTHORIZED,  STATUS)" & _
                     "Values(@P_OCTYPECODE, @P_OCDEFINITION,@P_Inserted_On,@P_Modified_On,1,@P_Input_By,getdate(),0,'U')"

            Dim commProc As DbCommand = db.GetSqlStringCommand(strSql)

            commProc.Parameters.Clear()
            db.AddInParameter(commProc, "@P_OCTYPECODE", DbType.String, txtOccTypesCode.Text.Trim())
            db.AddInParameter(commProc, "@P_OCDEFINITION", DbType.String, txtOccTypesName.Text.Trim())
            ...
            Else
                ...
                '_intSlno = intSlno
                _strOccTypes_Code = txtOccTypesCode.Text.Trim()

                _intModno = 1

                log_message = " Added : Occupation Code : " + txtOccTypesCode.Text.Trim() + "." + " " + " Occupation Name : " + txtOccTypesName.Text.Trim()
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Using conn As DbConnection = db.CreateConnection()
                ...
                db.ExecuteNonQuery(trans, CommandType.Text, "delete FIU_OCCUPATION_TYPES where OCTYPECODE='" & _strOccTypes_Code & "' and IS_AUTHORIZED=0")
                Dim ds As New DataSet


                strSql = "select isnull(max(MODNO),0)+1 maxmodno from FIU_OCCUPATION_TYPES where OCTYPECODE='" & _strOccTypes_Code & "'"


                intModno = db.ExecuteDataSet(trans, CommandType.Text, strSql).Tables(0).Rows(0)(0)

                strSql = "Insert Into FIU_OCCUPATION_TYPES(OCTYPECODE, OCDEFINITION, INSERTED_ON,  MODIFIED_ON, MODNO, INPUT_BY, INPUT_DATETIME, IS_AUTHORIZED, STATUS)" & _
                     "Values(@P_OCTYPECODE, @P_OCDEFINITION,@P_Inserted_On,@P_Modified_On," & intModno.ToString() & ",@P_Input_By,getdate(),0,'U')"
                ...
                Else
                    ...
                    ' ------mizan Work (10-04-16)------
                    If _OName <> txtOccTypesName.Text.Trim() Then

                        log_message = " Updated : Occupation Code : " + txtOccTypesCode.Text.Trim() + "." + " " + " Occupation Name : " + _OName + " " + " To " + " " + txtOccTypesName.Text.Trim()
                        Logger.system_log(log_message)
                    Else
                        log_message = " Updated : Occupation Code : " + txtOccTypesName.Text.Trim()
                        Logger.system_log(log_message)
                    End If
    ...
    ' ------mizan Work (17-04-16)------
    Private Sub LoadOccTypesDataForAuth(ByVal strOccTypesCode As String)
        ...
        Try
            ...
            ds = db.ExecuteDataSet(CommandType.Text, "Select * From FIU_OCCUPATION_TYPES Where OCTYPECODE='" & strOccTypesCode & "' and STATUS = 'L' ")


            If ds.Tables(0).Rows.Count > 0 Then


                _strOccTypes_Code = strOccTypesCode


                _formMode = FormTransMode.Update

                txtOccTypesCode.Text = ds.Tables(0).Rows(0)("OCTYPECODE").ToString()

                'txtOccTypesName.Text = ds.Tables(0).Rows(0)("OCDEFINITION").ToString()
                _OccpName = ds.Tables(0).Rows(0)("OCDEFINITION").ToString()
    ...
    Private Sub LoadOccTypesData(ByVal strOccTypesCode As String, ByVal intMod As Integer)
        ...
        Try
            ...
            ds = db.ExecuteDataSet(CommandType.Text, "Select * From FIU_OCCUPATION_TYPES Where OCTYPECODE='" & strOccTypesCode & "' and MODNO=" & intMod.ToString())
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                txtOccTypesName.Text = ds.Tables(0).Rows(0)("OCDEFINITION").ToString()
                _OName = ds.Tables(0).Rows(0)("OCDEFINITION").ToString()
                ...
                lblVerTot.Text = db.ExecuteDataSet(CommandType.Text, "Select Count(MODNO) From FIU_OCCUPATION_TYPES Where OCTYPECODE='" & strOccTypesCode & "'").Tables(0).Rows(0)(0).ToString()
    ...
    Public Sub New(ByVal strOccTypesCode As String, ByVal intMod As Integer)

        ' This call is required by the Windows Form Designer.
        InitializeComponent()
        LoadOccTypesData(strOccTypesCode, intMod)
    ...
    Private Function AuthorizeData() As TransState
        ...
        If _intModno > 1 Then
            ...
            LoadOccTypesDataForAuth(_strOccTypes_Code)
            ...
            Using conn As DbConnection = db.CreateConnection()
                ...
                strSql = "select IS_AUTHORIZED,STATUS from FIU_OCCUPATION_TYPES where OCTYPECODE='" & _strOccTypes_Code & "' and MODNO=" & _intModno.ToString()
                ...
                If ds.Tables(0).Rows(0)("IS_AUTHORIZED") = 0 Then
                    ...
                    If ds.Tables(0).Rows(0)("STATUS") = "U" Then
                        strSql = "update FIU_OCCUPATION_TYPES set AUTH_BY='" & CommonAppSet.User.ToString().Trim() & _
                        "', AUTH_DATETIME=getdate(), IS_AUTHORIZED=1, STATUS = 'L' " & _
                        " where OCTYPECODE='" & _strOccTypes_Code & "' and MODNO=" & _intModno.ToString()
                    ...
                    ElseIf result > 0 Then
                        ...
                        If _intModno > 1 Then
                            ...
                            strSql = "update FIU_OCCUPATION_TYPES set STATUS = 'C' " & _
                                " where OCTYPECODE='" & _strOccTypes_Code & "' and MODNO=" & (_intModno - 1).ToString() & _
                                " and STATUS ='D'"

                            db.ExecuteNonQuery(trans, CommandType.Text, strSql)

                            'if previous modification status is L(Deleted) then make it O(Open)
                            strSql = "update FIU_OCCUPATION_TYPES set STATUS = 'O' " & _
                                " where OCTYPECODE='" & _strOccTypes_Code & "' and MODNO=" & (_intModno - 1).ToString() & _
                                " and STATUS ='L'"
                        ...
                        If _OccpName <> _OName Then
                            If _OccpName = "" Then
                                log_message = " Authorized : Occupation Types Code : " + txtOccTypesCode.Text.Trim() + "." + " " + " Occupation Types Name : " + _OName
                            Else
                                log_message = " Authorized : Occupation Types Code : " + txtOccTypesCode.Text.Trim() + "." + " " + " Occupation Types Name : " + _OccpName + " " + " To " + " " + _OName
                            End If

                            Logger.system_log(log_message)
                        Else
                            log_message = " Authorized : Occupation Types Code : " + txtOccTypesCode.Text.Trim()
                            Logger.system_log(log_message)
                        End If
        ...
        '    'log_message = "Authorized Occupation Code " + txtOccTypesCode.Text.Trim() + " Occupation Type Name " + txtOccTypesName.Text.Trim()
        '    'Logger.system_log(log_message)
        ...
        Using conn As DbConnection = db.CreateConnection()
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                If ds.Tables(0).Rows(0)(0) = False Then 'if not authorized
                    ...
                    strSql = "delete FIU_OCCUPATION_TYPES where OCTYPECODE='" & _strOccTypes_Code & "' and MODNO=" & _intModno.ToString() & " and IS_AUTHORIZED=0"
                ...
                ElseIf ds.Tables(0).Rows(0)(0) = True Then 'if authorized
                    ...
                    If ds.Tables(0).Rows(0)("STATUS") = "L" Then 'if this is the last modified data
                        ...
                        strSql = "delete FIU_OCCUPATION_TYPES where OCTYPECODE='" & _strOccTypes_Code & "'  and IS_AUTHORIZED=0"

                        db.ExecuteNonQuery(trans, CommandType.Text, strSql)

                        strSql = "select * from FIU_OCCUPATION_TYPES where OCTYPECODE='" & _strOccTypes_Code & "' and MODNO=" & _intModno.ToString()
                        ...
                        strSql = "Insert Into FIU_OCCUPATION_TYPES(OCTYPECODE, OCDEFINITION, INSERTED_ON,  MODIFIED_ON, MODNO, INPUT_BY, INPUT_DATETIME, IS_AUTHORIZED,  STATUS)" & _
                     "Values(@P_OCTYPECODE, @P_OCDEFINITION, @P_Inserted_On,@P_Modified_On," & intModno.ToString() & ",@P_Input_By,getdate(),0,'D')"
                        ...
                        db.AddInParameter(commProc, "@P_OCDEFINITION", DbType.String, dsKeeper.Tables(0).Rows(0)("OCDEFINITION"))
            ...
            log_message = "Delete Occupation Code " + txtOccTypesCode.Text.Trim()
            Logger.system_log(log_message)
...
#End Region
    ...
    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        ...
        If txtOccTypesCode.Enabled = True Then
            txtOccTypesCode.Focus()
        End If
            ...
            If MessageBox.Show("Do you really want to Save?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                If CheckValidData() Then  ' Ok
                    ...
                    If tState = TransState.Add Then
                        ...
                        LoadOccTypesData(_strOccTypes_Code, _intModno)
    ...
    Private Sub btnNextVer_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNextVer.Click
        ...
        If _intModno = 0 Then
            ...
            LoadOccTypesData(strOccTypes_Code, intModno)
        End If
    End Sub
End Class