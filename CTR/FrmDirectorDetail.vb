...
Public Class FrmDirectorDetail


#Region "Global Variables"

    Dim _formName As String = "MaintenanceGoDirectorDetail"
...
#Region "User defined Codes"
    ...
    Private Function CheckValidData() As Boolean
        ...
        If txtFirstName.Text.Trim() = "" Then
            MessageBox.Show("Director First Name required !!", "Saving Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            txtFirstName.Focus()
            Return False
        ElseIf txtLast.Text.Trim() = "" Then
            MessageBox.Show("Director Last Name required !!", "Saving Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            txtLast.Focus()
            Return False

        ElseIf txtBirthDate.Text.Trim() = "" Then
            MessageBox.Show("Birthdate required !!", "Saving Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            txtLast.Focus()
            Return False
        ...
        ElseIf txtSSN.Text.Trim() = "" And txtIDNumber.Text.Trim() = "" And TxtPassportNo.Text.Trim() = "" Then
            ...
            MessageBox.Show(" National ID/ Birth Registration Number /Passport  required !!", "Saving Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            txtSSN.Focus()
            Return False
        ...
        ElseIf cmbNationality1.Text.Trim() = "" Then
            MessageBox.Show("Nationality1 required !!", "Saving Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then
            ...
            Using conn As DbConnection = db.CreateConnection()
                ...
                db.AddInParameter(commProc, "@DIRECTOR_ID", DbType.String, txtId.Text)
                ...
                Else
                    ...
                    For i = 0 To DataGridView1.Rows.Count - 1
                        ...
                        db.AddInParameter(commProcSche, "@DIRECTOR_ID", DbType.String, txtId.Text.Trim())
                    ...
                    For i = 0 To DataGridView4.Rows.Count - 1
                        ...
                        db.AddInParameter(commProcAdd, "@DIRECTOR_ID", DbType.String, txtId.Text.Trim())
                    ...
                    For i = 0 To DataGridView3.Rows.Count - 1
                        ...
                        db.AddInParameter(commProcEMPhone, "@DIRECTOR_ID", DbType.String, txtId.Text.Trim())
                    ...
                    For i = 0 To DataGridView5.Rows.Count - 1
                        ...
                        db.AddInParameter(commProcEMAdd, "@DIRECTOR_ID", DbType.String, txtId.Text.Trim())
                    ...
                    For i = 0 To DataGridView6.Rows.Count - 1
                        ...
                        db.AddInParameter(commProcIdent, "@DIRECTOR_ID", DbType.String, txtId.Text.Trim())
                    ...
                    log_message = " Added : Director Person ID : " + txtId.Text.Trim() + "." + " " + " Director Person Name : " + txtTitle.Text.ToString() + " " + txtFirstName.Text.ToString() + " " + txtMiddle.Text.ToString() + " " + txtLast.Text.ToString()
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Using conn As DbConnection = db.CreateConnection()
                ...
                db.AddInParameter(commProc, "@DIRECTOR_ID", DbType.String, _strId)
                ...
                For i = 0 To DataGridView1.Rows.Count - 1
                    ...
                    db.AddInParameter(commProcSche, "@TPH_ID", DbType.String, DataGridView1.Rows(i).Cells(0).Value)
                    db.AddInParameter(commProcSche, "@DIRECTOR_ID", DbType.String, _strId)
                    db.AddInParameter(commProcSche, "@SID", DbType.String, DataGridView1.Rows(i).Cells(7).Value)
                    db.AddInParameter(commProcSche, "@SLNO", DbType.String, DataGridView1.Rows(i).Cells(6).Value)
                    db.AddInParameter(commProcSche, "@TPH_CONTACT_TYPE", DbType.String, DataGridView1.Rows(i).Cells(1).Value)
                    db.AddInParameter(commProcSche, "@TPH_COMMUNICATION_TYPE", DbType.String, DataGridView1.Rows(i).Cells(2).Value)
                ...
                For i = 0 To DataGridView4.Rows.Count - 1
                    ...
                    db.AddInParameter(commProcAdd, "@ADDRESS_ID", DbType.String, DataGridView4.Rows(i).Cells(0).Value)
                    db.AddInParameter(commProcAdd, "@DIRECTOR_ID", DbType.String, _strId)
                    db.AddInParameter(commProcAdd, "@SID", DbType.String, DataGridView4.Rows(i).Cells(9).Value)
                    db.AddInParameter(commProcAdd, "@SLNO", DbType.String, DataGridView4.Rows(i).Cells(8).Value)
                    db.AddInParameter(commProcAdd, "@ADDRESS_TYPE", DbType.String, DataGridView4.Rows(i).Cells(1).Value)
                    db.AddInParameter(commProcAdd, "@ADDRESS", DbType.String, DataGridView4.Rows(i).Cells(2).Value)
                ...
                For i = 0 To DataGridView3.Rows.Count - 1
                    ...
                    If (Not (String.IsNullOrEmpty(DataGridView3.Rows(i).Cells(0).Value.ToString()))) Then  '-----Mizan Work (11-04-2016)
                        ...
                        db.AddInParameter(commProcEMPhone, "@TPH_ID", DbType.String, DataGridView3.Rows(i).Cells(0).Value)
                        db.AddInParameter(commProcEMPhone, "@DIRECTOR_ID", DbType.String, _strId)
                        db.AddInParameter(commProcEMPhone, "@SID", DbType.String, DataGridView3.Rows(i).Cells(7).Value)
                        db.AddInParameter(commProcEMPhone, "@SLNO", DbType.String, DataGridView3.Rows(i).Cells(6).Value)
                        db.AddInParameter(commProcEMPhone, "@TPH_CONTACT_TYPE", DbType.String, DataGridView3.Rows(i).Cells(1).Value)
                        db.AddInParameter(commProcEMPhone, "@TPH_COMMUNICATION_TYPE", DbType.String, DataGridView3.Rows(i).Cells(2).Value)
                ...
                For i = 0 To DataGridView5.Rows.Count - 1
                    ...
                    If (Not (String.IsNullOrEmpty(DataGridView5.Rows(i).Cells(0).Value.ToString()))) Then  '-----Mizan Work (11-04-2016)
                        ...
                        db.AddInParameter(commProcEMAdd, "@ADDRESS_ID", DbType.String, DataGridView5.Rows(i).Cells(0).Value)
                        db.AddInParameter(commProcEMAdd, "@DIRECTOR_ID", DbType.String, _strId)
                        db.AddInParameter(commProcEMAdd, "@SID", DbType.String, DataGridView5.Rows(i).Cells(9).Value)
                        db.AddInParameter(commProcEMAdd, "@SLNO", DbType.String, DataGridView5.Rows(i).Cells(8).Value)
                        db.AddInParameter(commProcEMAdd, "@ADDRESS_TYPE", DbType.String, DataGridView5.Rows(i).Cells(1).Value)
                        db.AddInParameter(commProcEMAdd, "@ADDRESS", DbType.String, DataGridView5.Rows(i).Cells(2).Value)
                ...
                For i = 0 To DataGridView6.Rows.Count - 1
                    ...
                    db.AddInParameter(commProcIdent, "@IDENTIFICATION_ID", DbType.String, DataGridView6.Rows(i).Cells(0).Value)
                    db.AddInParameter(commProcIdent, "@DIRECTOR_ID", DbType.String, _strId)
                    db.AddInParameter(commProcIdent, "@SID", DbType.String, DataGridView6.Rows(i).Cells(8).Value)
                    db.AddInParameter(commProcIdent, "@SLNO", DbType.String, DataGridView6.Rows(i).Cells(7).Value)
                    db.AddInParameter(commProcIdent, "@TYPE", DbType.String, DataGridView6.Rows(i).Cells(1).Value)
                    db.AddInParameter(commProcIdent, "@NUMBER", DbType.String, DataGridView6.Rows(i).Cells(2).Value)
                ...
                If _spouse <> txtPrefix.Text.Trim() Then
                    ...
                    DirectorList.Add(log_message)
                End If
                If _birthdate <> txtBirthDate.Text.Trim() Then
                ...
                _Dlog = " Updated : Director Person ID : " + txtId.Text.ToString() + "." + " " + _DirectorLog
                ...
                'log_message = "Updated Director Person " + txtId.Text.Trim() + " Information "
                'Logger.system_log(log_message)
    ...
    Private Sub LoadMainDataForAuth(ByVal strId As String)
        ...
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                txtId.Text = ds.Tables(0).Rows(0)("DIRECTOR_ID").ToString()
    ...
    Private Sub LoadMainData(ByVal strId As String, ByVal intmod As Integer)
        ...
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                Dim commProc2 As DbCommand = db.GetStoredProcCommand("GO_Director_GetMaxMod")

                commProc2.Parameters.Clear()

                db.AddInParameter(commProc2, "@DIRECTOR_ID", DbType.String, strId)
    ...
    Private Sub LoadMainData2(ByVal strId As String)
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_Director_GetDetailbuCode")
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                'Dim intmod As Integer = ds.Tables(0).Rows(0)("MOD_NO").ToString()
                ...
                'LoadPersonalPhoneData(strId)
                'LoadEmployerPhoneData(strId)
                'LoadPersonAddressData(strId)
                'LoadEmployerAddressData(strId)
                'LoadIdentificationData(strId, Int)
    ...
    Private Sub LoadPersonalPhoneData(ByVal strId As String, ByVal intmod As Integer)
        ...
        Try
            ...
            Dim commProcSche As DbCommand = db.GetStoredProcCommand("GO_DirectorPPhone_GetDetails")

            commProcSche.Parameters.Clear()

            db.AddInParameter(commProcSche, "@DIRECTOR_ID", DbType.String, strId)
    ...
    Private Sub LoadEmployerPhoneData(ByVal strId As String, ByVal intmod As Integer)
        ...
        Try
            ...
            Dim commProcSche As DbCommand = db.GetStoredProcCommand("GO_DirectorEPhone_GetDetails")
    ...
    Private Sub LoadPersonAddressData(ByVal strId As String, ByVal intmod As Integer)
        ...
        Try
            ...
            Dim dt As New DataTable
            Dim Status As String = "P"
            Dim commProcSche As DbCommand = db.GetStoredProcCommand("GO_DirectorPAddress_GetDetails")
    ...
    Private Sub LoadEmployerAddressData(ByVal strId As String, ByVal intmod As Integer)
        ...
        Try
            ...
            Dim dt As New DataTable
            Dim Status As String = "E"
            Dim commProcSche As DbCommand = db.GetStoredProcCommand("GO_DirectorEAddress_GetDetails")
    ...
    Private Sub LoadIdentificationData(ByVal strId As String, ByVal intmod As Integer)
        ...
        Try
            ...
            Dim dt As New DataTable
            Dim Status As String = "E"
            Dim commProcSche As DbCommand = db.GetStoredProcCommand("GO_DirectorIdentification_GetDetails")
    ...
    Private Function AuthorizeData() As TransState
        ...
        If _intModno > 1 Then
            ...
            If result = 0 Then
                ...
                _Dlog = " Authorized : Director Person ID : " + txtId.Text.ToString() + "." + " " + _DirectorLog
            ...
            'log_message = "Authorized Director Person " + _strId + " Name " + txtFirstName.Text.ToString() + " " + txtLast.Text.ToString()
            'Logger.system_log(log_message)
        ...
        Else
            ...
            If result = 0 Then
                ...
                _Dlog = " Authorized : Director Person ID : " + txtId.Text.ToString() + "." + " " + " For Mandatory Field : " + "." + " " + _DirectorLog
    ...
    Private Function DeleteData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("GO_Director_Remove")
        ...
        log_message = "Authorized Director " + _strId + " Name " + txtTitle.Text.ToString() + " " + txtFirstName.Text.ToString() + " " + txtMiddle.Text.ToString() + " " + txtLast.Text.ToString()
        Logger.system_log(log_message)
...
#End Region
    ...
    Private Sub FrmDirectorDetail_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
