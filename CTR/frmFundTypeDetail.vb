'
'Author             : Fahad Khan
'Purpose            : Maintain Fund Type Information
...
Public Class frmFundTypeDetail

#Region "Global Variables"

    Dim _formName As String = "MaintenanceFundTypeDetail"
    Dim opt As SecForm = New SecForm(_formName)

    Dim _formMode As FormTransMode
    Dim _intModno As Integer = 0
    Dim _strFundType_Code As String = ""
    Dim _mod_datetime As Date
    Dim _status As String = ""
    Dim log_message As String = ""

    Dim _FundType As String = ""
    Dim _FType As String = ""
#End Region
#Region "User defined Codes"
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_FundType_Add")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@FUNDTYPE_CODE", DbType.String, txtId.Text.Trim())
            db.AddInParameter(commProc, "@FUNDTYPE_NAME", DbType.String, txtName.Text.Trim())
            ...
            If result = 0 Then
                ...
                _strFundType_Code = txtId.Text.Trim()

                _intModno = 1

                log_message = " Added : Fund Type Code : " + txtId.Text.Trim() + "." + " " + " Fund Type Name : " + txtName.Text.ToString()
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_FundType_Update")
            ...
            If result = 0 Then
                ...
                If _FundType <> txtName.Text.Trim() Then

                    log_message = " Updated : Fund Type Code : " + txtId.Text.Trim() + "." + " " + " Fund Type Name  : " + _FundType + " " + " To " + " " + txtName.Text.ToString()
                    Logger.system_log(log_message)
                Else
                    log_message = " Updated : Fund Type Code : " + txtId.Text.Trim() + "." + " " + " Fund Type Name  : " + txtName.Text.Trim()
                    Logger.system_log(log_message)
                End If
            ...
            'log_message = "Updated Fund Type " + txtId.Text.Trim() + " Name " + _FundType + " To " + txtName.Text.ToString()
            'Logger.system_log(log_message)
    ...
    Private Sub LoadFundTypeDataForAuth(ByVal strFundTypeCode As String)
        ...
        Try
            ...
            ds = db.ExecuteDataSet(CommandType.Text, "Select * From GO_FUNDTYPE Where FUNDTYPE_CODE ='" & strFundTypeCode & "' and STATUS= 'L' ")
            If ds.Tables(0).Rows.Count > 0 Then


                _strFundType_Code = strFundTypeCode


                _formMode = FormTransMode.Update


                txtId.Text = ds.Tables(0).Rows(0)("FUNDTYPE_CODE").ToString()
                txtName.Text = ds.Tables(0).Rows(0)("FUNDTYPE_NAME").ToString()
                _FType = ds.Tables(0).Rows(0)("FUNDTYPE_NAME").ToString()
    ...
    Private Sub LoadFundTypeData(ByVal strFundTypeCode As String, ByVal intMod As Integer)
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_FundType_GetDetail")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@FUNDTYPE_CODE", DbType.String, strFundTypeCode)
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                txtId.Text = ds.Tables(0).Rows(0)("FUNDTYPE_CODE").ToString()
                txtName.Text = ds.Tables(0).Rows(0)("FUNDTYPE_NAME").ToString()
                _FundType = ds.Tables(0).Rows(0)("FUNDTYPE_NAME").ToString()
                ...
                Dim commProc2 As DbCommand = db.GetStoredProcCommand("GO_FundType_GetMaxMod")

                commProc2.Parameters.Clear()

                db.AddInParameter(commProc2, "@FUNDTYPE_CODE", DbType.String, strFundTypeCode)
    ...
    Public Sub New(ByVal strFundTypeCode As String, ByVal intMod As Integer)

        ' This call is required by the Windows Form Designer.
        InitializeComponent()

        ' Add any initialization after the InitializeComponent() call.
        LoadFundTypeData(strFundTypeCode, intMod)
        _strFundType_Code = strFundTypeCode
        _intModno = intMod
    ...
    Private Function DeleteData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("GO_FundType_Remove")

        commProc.Parameters.Clear()

        db.AddInParameter(commProc, "@FUNDTYPE_CODE", DbType.String, _strFundType_Code)
        db.AddInParameter(commProc, "@MOD_NO", DbType.Int32, _intModno)
        db.AddOutParameter(commProc, "@RET_MOD_NO", DbType.Int32, 5)
        ...
        log_message = "Deleted Fund Type " + _strFundType_Code + " Name " + txtName.Text.ToString()
        Logger.system_log(log_message)
    ...
    Private Function AuthorizeData() As TransState
        ...
        If _intModno > 1 Then
            ...
            LoadFundTypeDataForAuth(_strFundType_Code)
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_FundType_Auth")
            ...
            If result = 0 Then
                ...
                If _FType <> _FundType Then
                    If _FType = "" Then
                        log_message = " Authorized : Fund Type Code : " + txtId.Text.Trim() + "." + " " + " Fund Type Name  : " + _FundType
                    Else
                        log_message = " Authorized : Fund Type Code : " + txtId.Text.Trim() + "." + " " + " Fund Type Name  : " + _FType + " " + " To " + " " + _FundType
                    End If
                    Logger.system_log(log_message)
                Else
                    log_message = " Authorized : Fund Type Code : " + txtId.Text.Trim() + "." + " " + " Fund Type Name  : " + txtName.Text.Trim()
                    Logger.system_log(log_message)
                End If
        ...
        'log_message = "Authorized Fund Type " + _strFundType_Code + " Name " + txtName.Text.ToString()
        'Logger.system_log(log_message)
...
#End Region
    ...
    Private Sub frmFundTypeDetail_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If _intModno > 0 Then
            LoadFundTypeData(_strFundType_Code, _intModno)
        End If
    ...
    Private Sub btnUnlock_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUnlock.Click
        ...
        If Not (_strFundType_Code.Trim() = "") Then
