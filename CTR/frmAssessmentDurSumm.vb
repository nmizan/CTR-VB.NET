...
Public Class frmAssessmentDurSumm

#Region "user defined codes"

    Dim _formName As String = "MaintenanceAssesmentDurationSummary"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            If chkShowAll.Checked = True Then
                strSql = "select DUR_CODE, DURDEFINITION,IS_AUTHORIZED,MODNO, " + _
                    " 'S' = " + _
                    "	CASE  " + _
                    ...
                    "       ELSE 'U' " + _
                    "	End " + _
                    " from FIU_ASSESSMENT_DURATION " + _
                    " where IS_AUTHORIZED=0 OR STATUS in ('L','D')  " + _
                    " order by IS_AUTHORIZED,DUR_CODE"
...
#End Region
    ...
    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        ...
        Dim frmDurInfo As New FrmAssessment_Duration
        frmDurInfo.ShowDialog()
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(0).Value Is Nothing) Then
                ...
                Dim frmDurInfo As New FrmAssessment_Duration(dgView.SelectedRows.Item(0).Cells(2).Value, dgView.SelectedRows.Item(0).Cells(0).Value)
                frmDurInfo.ShowDialog()
            End If
    ...
    Private Sub frmAssessmentDurSumm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
