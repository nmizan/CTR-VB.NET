...
Public Class FrmAccountTypeSummary

#Region "user defined codes"

    Dim _formName As String = "MaintenanceAccountTypeSummary"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_AccountType_GetDetailList")
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                dgView.Item(3, i).Value = dt.Rows(i).Item("ACTYPECODE").ToString()
                dgView.Item(4, i).Value = dt.Rows(i).Item("ACTYPENAME").ToString()
...
#End Region
    ...
    Private Sub FrmAccountTypeSummary_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(1).Value Is Nothing) Then
                ...
                Dim frmAccountTypeDet As New FrmAccountTypeDetail(dgView.SelectedRows.Item(0).Cells(3).Value, dgView.SelectedRows.Item(0).Cells(1).Value)
                frmAccountTypeDet.Show()
            End If
        Catch ex As Exception
    ...
    Private Sub btnAuthorize_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAuthorize.Click
        Try
            ...
            If MessageBox.Show("Do you really want to Authorize?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                    ...
                    If dgView.Rows(i).Cells(0).Value = True Then
                        ...
                        Else
                            ...
                            If (dgView.Rows(i).Cells(1).Value) > 1 Then
                                ...
                                LoadAcTypeDataForAuth(dgView.Rows(i).Cells(3).Value.ToString())
                                ...
                                db.AddInParameter(commProc, "@ACTYPECODE", DbType.String, dgView.Rows(i).Cells(3).Value.ToString())
                                ...
                                If result = 0 Then
                                    ...
                                    If _AccountTypeName <> _AccTypeName Then
                                        If _AccountTypeName = "" Then
                                            log_message = " Authorized : Account Type Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Account Type Name : " + _AccTypeName
                                        Else
                                            log_message = " Authorized : Account Type Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Account Type Name : " + _AccountTypeName + " " + " To " + " " + _AccTypeName
                                        End If
                ...
                '    log_message = "Authorized Account Type " + dgView.Rows(i).Cells(3).Value.ToString() + " Name " + dgView.Rows(i).Cells(4).Value.ToString()
                '    Logger.system_log(log_message)
                'Next i
