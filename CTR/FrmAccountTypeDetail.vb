'
'Author             : Fahad Khan
'Purpose            : Maintain Account Type Information
...
Public Class FrmAccountTypeDetail
...
#Region "User defined Codes"
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_AccountType_Add")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@ACTYPECODE", DbType.String, txtId.Text.Trim())
            db.AddInParameter(commProc, "@ACTYPENAME", DbType.String, txtName.Text.Trim())
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_AccountType_Update")
            ...
            If result = 0 Then
                ...
                If _AccTypeName <> txtName.Text.Trim() Then

                    log_message = " Updated : Account Type Code : " + txtId.Text.Trim() + "." + " " + " Account Type Name : " + _AccTypeName + " " + " To " + " " + txtName.Text.ToString()
                    Logger.system_log(log_message)
                Else
            ...
            'log_message = "Update Account Type " + txtId.Text.Trim() + " Name " + _AccTypeName + " To " + txtName.Text.Trim()
            'Logger.system_log(log_message)
        End If
    ...
    Private Sub LoadAcTypeDataForAuth(ByVal strAcTypeCode As String)
        ...
        Try
            ...
            ds = db.ExecuteDataSet(CommandType.Text, "Select * From GO_ACCOUNT_TYPE Where ACTYPECODE='" & strAcTypeCode & "' and STATUS= 'L' ")
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                txtId.Text = ds.Tables(0).Rows(0)("ACTYPECODE").ToString()

                txtName.Text = ds.Tables(0).Rows(0)("ACTYPENAME").ToString()
                _AccountTypeName = ds.Tables(0).Rows(0)("ACTYPENAME").ToString()
    ...
    Private Sub LoadAcTypeData(ByVal strAcTypeCode As String, ByVal intMod As Integer)
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_AccountType_GetDetail")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@ACTYPECODE", DbType.String, strAcTypeCode)
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                txtName.Text = ds.Tables(0).Rows(0)("ACTYPENAME").ToString()
                _AccTypeName = ds.Tables(0).Rows(0)("ACTYPENAME").ToString()
                ...
                Dim commProc2 As DbCommand = db.GetStoredProcCommand("GO_AccountType_GetMaxMod")

                commProc2.Parameters.Clear()

                db.AddInParameter(commProc2, "@ACTYPECODE", DbType.String, strAcTypeCode)
    ...
    Private Function DeleteData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("GO_AccountType_Remove")

        commProc.Parameters.Clear()

        db.AddInParameter(commProc, "@ACTYPECODE", DbType.String, _strAcType_Code)
        db.AddInParameter(commProc, "@MOD_NO", DbType.Int32, _intModno)
        db.AddOutParameter(commProc, "@RET_MOD_NO", DbType.Int32, 5)
        ...
        Else
            tStatus = TransState.UpdateNotPossible
        End If
        log_message = "Deleted Account Type " + _strAcType_Code
        Logger.system_log(log_message)
    ...
    Private Function AuthorizeData() As TransState
        ...
        If _intModno > 1 Then
            ...
            LoadAcTypeDataForAuth(_strAcType_Code)
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_AccountType_Auth")
            ...
            If result = 0 Then
                ...
                If _AccountTypeName <> _AccTypeName Then
                    If _AccountTypeName = "" Then
                        log_message = " Authorized : Account Type Code : " + txtId.Text.Trim() + "." + " " + " Account Type Name : " + _AccTypeName
                    Else
                        log_message = " Authorized : Account Type Code : " + txtId.Text.Trim() + "." + " " + " Account Type Name : " + _AccountTypeName + " " + " To " + " " + _AccTypeName
                    End If
        ...
        'log_message = "Authorized Account Type " + _strAcType_Code + " Type Name " + txtName.Text.ToString()
        'Logger.system_log(log_message)
...
#End Region
    ...
    Private Sub FrmAccountTypeDetail_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
