'
'Author             : Fahad Khan
'Purpose            : TransactionItem Type Summary
...
Public Class FrmTransactionItemSumm
#Region "user defined codes"

    Dim _formName As String = "MaintenanceTransactionItemSumm"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_TransactionItemType_GetDetailList")
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                dgView.Item(3, i).Value = dt.Rows(i).Item("TTYPE_CODE").ToString()
                dgView.Item(4, i).Value = dt.Rows(i).Item("TTYPE_NAME").ToString()
...
#End Region
    ...
    Private Sub FrmTransactionItemSumm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        Dim frmtrans55 As New FrmTransactionItemDet()
        frmtrans55.ShowDialog()
    End Sub
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(1).Value Is Nothing) Then
                ...
                Dim frmtrans55 As New FrmTransactionItemDet(dgView.SelectedRows.Item(0).Cells(3).Value, dgView.SelectedRows.Item(0).Cells(1).Value)
                frmtrans55.Show()
            End If
        Catch ex As Exception
            ...
            If MessageBox.Show("Do you really want to Authorize?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                For i = 0 To dgView.Rows.Count - 1
                    ...
                    If dgView.Rows(i).Cells(0).Value = True Then
                        ...
                        db.AddInParameter(commProc, "@TTYPE_CODE", DbType.String, dgView.Rows(i).Cells(3).Value.ToString())
                    ...
                    End If
                    log_message = "Authorized Transaction Item " + dgView.Rows(i).Cells(3).Value.ToString() + " Name " + dgView.Rows(i).Cells(4).Value.ToString()
