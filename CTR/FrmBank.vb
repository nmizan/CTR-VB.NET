...
#Region "User defined Codes"
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then  ' OK
            ...
            strSql = "Insert Into FIU_BANK(BANK_CODE, BANK_NAME, GCODE, INSERTED_ON,  MODIFIED_ON, MODNO, INPUT_BY, INPUT_DATETIME, IS_AUTHORIZED,  STATUS)" & _
                     "Values(@P_BANK_CODE,@P_BANK_NAME,@P_GCODE,@P_Inserted_On,@P_Modified_On,1,@P_Input_By,getdate(),0,'U')"

            Dim commProc As DbCommand = db.GetSqlStringCommand(strSql)

            commProc.Parameters.Clear()
            db.AddInParameter(commProc, "@P_BANK_CODE", DbType.String, txtBankCode.Text.Trim())
            db.AddInParameter(commProc, "@P_BANK_NAME", DbType.String, txtBankName.Text.Trim())
            db.AddInParameter(commProc, "@P_GCODE", DbType.String, txtGrpCode.Text.Trim())
            ...
            Else
                ...
                If txtGrpCode.Text.Trim() = "" Then
                    log_message = " Added : Bank Code : " + txtBankCode.Text.Trim() + "." + " " + " Bank Name : " + txtBankName.Text.Trim()
                    Logger.system_log(log_message)
                Else
                    log_message = " Added : Bank Code : " + txtBankCode.Text.Trim() + "." + " " + " Bank Name : " + txtBankName.Text.Trim() + "." + " " + " Group Code : " + txtGrpCode.Text.Trim()
                    Logger.system_log(log_message)
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Using conn As DbConnection = db.CreateConnection()
                ...
                db.ExecuteNonQuery(trans, CommandType.Text, "delete FIU_BANK where BANK_CODE='" & _strBank_Code & "' and IS_AUTHORIZED=0")
                Dim ds As New DataSet


                strSql = "select isnull(max(MODNO),0)+1 maxmodno from FIU_BANK where BANK_CODE='" & _strBank_Code & "'"


                intModno = db.ExecuteDataSet(trans, CommandType.Text, strSql).Tables(0).Rows(0)(0)

                strSql = "Insert Into FIU_BANK(BANK_CODE, BANK_NAME, GCODE, INSERTED_ON,  MODIFIED_ON, MODNO, INPUT_BY, INPUT_DATETIME, IS_AUTHORIZED, STATUS)" & _
                     "Values(@P_BANK_CODE,@P_BANK_NAME,@P_GCODE,@P_Inserted_On,@P_Modified_On," & intModno.ToString() & ",@P_Input_By,getdate(),0,'U')"
                ...
                Else
                    ...
                    If _BName <> txtBankName.Text.Trim() And _GCode <> txtGrpCode.Text.Trim() Then
                        If _GCode = "" Then
                            log_message = " Updated : Bank Code : " + txtBankCode.Text.Trim() + "." + " " + " Bank Name : " + _BName + " " + " To " + " " + txtBankName.Text.Trim() + "." + " " + " Group Code : " + txtGrpCode.Text.Trim()
                        Else
                            log_message = " Updated : Bank Code : " + txtBankCode.Text.Trim() + "." + " " + " Bank Name : " + _BName + " " + " To " + " " + txtBankName.Text.Trim() + "." + " " + " Group Code " + _GCode + " " + " To " + " " + txtGrpCode.Text.Trim()
                        End If
                        Logger.system_log(log_message)

                    ElseIf _BName <> txtBankName.Text.Trim() Then

                        log_message = " Updated : Bank Code : " + txtBankCode.Text.Trim() + "." + " " + " Bank Name : " + _BName + " " + " To " + " " + txtBankName.Text.Trim()
                        Logger.system_log(log_message)
                    ElseIf _GCode <> txtGrpCode.Text.Trim() Then
                        If _GCode = "" Then
                            log_message = " Updated : Bank Code : " + txtBankCode.Text.Trim() + "." + " " + " Group Code : " + txtGrpCode.Text.Trim()
                        Else
                            log_message = " Updated : Bank Code : " + txtBankCode.Text.Trim() + "." + " " + " Group Code : " + _GCode + " " + " To " + " " + txtGrpCode.Text.Trim()
                        End If
                        Logger.system_log(log_message)
                    Else
                        log_message = " Updated : Bank Code : " + txtBankCode.Text.Trim()
                        Logger.system_log(log_message)
                    End If
    ...
    Private Sub LoadBankDataForAuth(ByVal strBankCode As String)
        ...
        Try
            ...
            ds = db.ExecuteDataSet(CommandType.Text, "Select * From FIU_BANK Where BANK_CODE='" & strBankCode & "' and STATUS = 'L' ")
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                'txtGrpCode.Text = ds.Tables(0).Rows(0)("GCODE").ToString()
                _GroupCode = ds.Tables(0).Rows(0)("GCODE").ToString()
    ...
    Private Sub LoadBankData(ByVal strBankCode As String, ByVal intMod As Integer)
        ...
        Try
            ...
            ds = db.ExecuteDataSet(CommandType.Text, "Select * From FIU_BANK Where BANK_CODE='" & strBankCode & "' and MODNO=" & intMod.ToString())
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                txtBankCode.Text = ds.Tables(0).Rows(0)("BANK_CODE").ToString()
                txtBankName.Text = ds.Tables(0).Rows(0)("BANK_NAME").ToString()
                _BName = ds.Tables(0).Rows(0)("BANK_NAME").ToString()
                txtGrpCode.Text = ds.Tables(0).Rows(0)("GCODE").ToString()
                _GCode = ds.Tables(0).Rows(0)("GCODE").ToString()
                ...
                lblVerTot.Text = db.ExecuteDataSet(CommandType.Text, "Select Count(MODNO) From FIU_BANK Where BANK_CODE='" & strBankCode & "'").Tables(0).Rows(0)(0).ToString()
    ...
    Private Function AuthorizeData() As TransState
        ...
        If _intModno > 1 Then
            ...
            Using conn As DbConnection = db.CreateConnection()
                ...
                strSql = "select IS_AUTHORIZED,STATUS from FIU_BANK where BANK_CODE='" & _strBank_Code & "' and MODNO=" & _intModno.ToString()
                ...
                If ds.Tables(0).Rows(0)("IS_AUTHORIZED") = 0 Then
                    ...
                    If ds.Tables(0).Rows(0)("STATUS") = "U" Then
                        strSql = "update FIU_BANK set AUTH_BY='" & CommonAppSet.User.ToString().Trim() & _
                        "', AUTH_DATETIME=getdate(), IS_AUTHORIZED=1, STATUS = 'L' " & _
                        " where  BANK_CODE='" & _strBank_Code & "' and MODNO=" & _intModno.ToString()
                    ...
                    ElseIf result > 0 Then
                        ...
                        If _intModno > 1 Then
                            ...
                            strSql = "update FIU_BANK set STATUS = 'C' " & _
                                " where BANK_CODE='" & _strBank_Code & "' and MODNO=" & (_intModno - 1).ToString() & _
                                " and STATUS ='D'"

                            db.ExecuteNonQuery(trans, CommandType.Text, strSql)

                            'if previous modification status is L(Deleted) then make it O(Open)
                            strSql = "update FIU_BANK set STATUS = 'O' " & _
                                " where BANK_CODE='" & _strBank_Code & "' and MODNO=" & (_intModno - 1).ToString() & _
                                " and STATUS ='L'"
                        ...
                        If _BankName <> _BName And _GroupCode <> _GCode Then
                            If _BankName = "" And _GroupCode = "" Then
                                log_message = " Authorized : Bank Code : " + txtBankCode.Text.Trim() + "." + " " + " Bank Name : " + _BName + "." + " " + " Group Code : " + _GCode
                            ElseIf _GroupCode = "" Then
                                log_message = " Authorized : Bank Code : " + txtBankCode.Text.Trim() + "." + " " + " Bank Name : " + _BankName + " " + " To " + " " + _BName + "." + " " + " Group Code : " + _GCode
                            Else
                                log_message = " Authorized : Bank Code : " + txtBankCode.Text.Trim() + "." + " " + " Bank Name : " + _BankName + " " + " To " + " " + _BName + "." + " " + " Group Code : " + _GroupCode + " " + " To " + " " + _GCode
                            End If
                            Logger.system_log(log_message)

                        ElseIf _BankName <> _BName Then
                            If _BankName = "" Then
                                log_message = " Authorized : Bank Code : " + txtBankCode.Text.Trim() + "." + " " + " Bank Name : " + _BName
                            Else
                                log_message = " Authorized : Bank Code : " + txtBankCode.Text.Trim() + "." + " " + " Bank Name : " + _BankName + " " + " To " + " " + _BName
                            End If

                            Logger.system_log(log_message)
                        ElseIf _GroupCode <> _GCode Then
                            If _GroupCode = "" Then
                                log_message = " Authorized : Bank Code : " + txtBankCode.Text.Trim() + "." + " " + " Group Code : " + _GCode
                            Else
                                log_message = " Authorized : Bank Code : " + txtBankCode.Text.Trim() + "." + " " + " Group Code : " + _GroupCode + " " + " To " + " " + _GCode
                            End If
                            Logger.system_log(log_message)
                        Else
                            log_message = " Authorized : Bank Code : " + txtBankCode.Text.Trim() + "." + " " + " Bank Name : " + txtBankName.Text.Trim()
                            Logger.system_log(log_message)
                        End If
        ...
        Using conn As DbConnection = db.CreateConnection()
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                If ds.Tables(0).Rows(0)(0) = False Then 'if not authorized
                    ...
                    strSql = "delete FIU_BANK where BANK_CODE='" & _strBank_Code & "' and MODNO=" & _intModno.ToString() & " and IS_AUTHORIZED=0"
                ...
                ElseIf ds.Tables(0).Rows(0)(0) = True Then 'if authorized
                    ...
                    If ds.Tables(0).Rows(0)("STATUS") = "L" Then 'if this is the last modified data
                        ...
                        strSql = "delete FIU_BANK where BANK_CODE='" & _strBank_Code & "'  and IS_AUTHORIZED=0"

                        db.ExecuteNonQuery(trans, CommandType.Text, strSql)

                        strSql = "select * from FIU_BANK where BANK_CODE='" & _strBank_Code & "' and MODNO=" & _intModno.ToString()
                        ...
                        strSql = "Insert Into FIU_BANK(BANK_CODE, BANK_NAME, GCODE, INSERTED_ON,  MODIFIED_ON, MODNO, INPUT_BY, INPUT_DATETIME, IS_AUTHORIZED,  STATUS)" & _
                     "Values(@P_BANK_CODE, @P_BANK_NAME, @P_GCODE, @P_Inserted_On,@P_Modified_On," & intModno.ToString() & ",@P_Input_By,getdate(),0,'D')"
                        ...
                        db.AddInParameter(commProc, "@P_BANK_NAME", DbType.String, dsKeeper.Tables(0).Rows(0)("BANK_NAME"))
                        db.AddInParameter(commProc, "@P_GCODE", DbType.String, dsKeeper.Tables(0).Rows(0)("GCODE"))
            ...
            log_message = "Delete Bank " + _strBank_Code + " Successfully"
            Logger.system_log(log_message)
...
#End Region
    ...
    Private Sub btnNextVer_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNextVer.Click
        ...
        If _intModno = 0 Then
            ...
            LoadBankData(strBank_Code, intModno)
        End If
    End Sub
End Class