...
Public Class frmBankGroupSumm

#Region "user defined codes"

    Dim _formName As String = "MaintenanceBankGroupSummary"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            If chkShowAll.Checked = True Then
                strSql = "select GROUP_CODE, GROUP_NAME,IS_AUTHORIZED,MODNO, " + _
                    " 'S' = " + _
                    "	CASE  " + _
                    ...
                    "       ELSE 'U' " + _
                    "	End " + _
                    " from FIU_BANKGROUP " + _
                    " where IS_AUTHORIZED=0 OR STATUS in ('L','D')  " + _
                    " order by IS_AUTHORIZED,GROUP_CODE"
...
#End Region
    ...
    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        ...
        Dim frmBnkGrpDet As New FrmBankGroup
        frmBnkGrpDet.ShowDialog()
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(0).Value Is Nothing) Then
                ...
                Dim frmBnkGrpDet As New FrmBankGroup(dgView.SelectedRows.Item(0).Cells(2).Value, dgView.SelectedRows.Item(0).Cells(0).Value)
                frmBnkGrpDet.ShowDialog()
            End If
    ...
    Private Sub frmBankGroupSumm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
