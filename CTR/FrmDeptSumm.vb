...
#Region "user defined codes"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("CTR_Department_GetDetailList")
    ...
    Private Sub btnAuthorize_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAuthorize.Click
        Try
            ...
            If MessageBox.Show("Do you really want to Authorize?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                                ...
                                If result = 0 Then
                                    ...
                                    If _DepartmentName <> _deptName Then
                                        If _DepartmentName = "" Then
                                            log_message = " Authorized : Department Code : " + dgView.Rows(i).Cells(4).Value + "." + " " + " Department  Name  : " + _deptName
                                        Else
                                            log_message = " Authorized : Department Code : " + dgView.Rows(i).Cells(4).Value + "." + " " + " Department  Name  : " + _DepartmentName + " " + " To " + " " + _deptName
                                        End If
                ...
                '    log_message = " Authorized Department Slno " + dgView.Rows(i).Cells(1).Value.ToString()
                '    Logger.system_log(log_message)
