...
Public Class crFormPermission
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CTR.crFormPermission.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrFormPermission
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crFormPermission = New crFormPermission
        rpt.Site = Me.Site
        Return rpt
    End Function
