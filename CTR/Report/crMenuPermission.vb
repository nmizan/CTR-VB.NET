...
Public Class crMenuPermission
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CTR.crMenuPermission.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrMenuPermission
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crMenuPermission = New crMenuPermission
        rpt.Site = Me.Site
        Return rpt
    End Function
