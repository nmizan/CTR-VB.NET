...
Public Class CrUserInactivity
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CTR.CrUserInactivity.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrUserInactivity
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrUserInactivity = New CrUserInactivity
        rpt.Site = Me.Site
        Return rpt
    End Function
