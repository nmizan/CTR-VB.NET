    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            If chkShowAll.Checked = True Then
                strSql = "select CURRENCY_CODE, CURRENCY_NAME,IS_AUTHORIZED,MODNO, " + _
                    " 'S' = " + _
                    "	CASE  " + _
                    ...
                    "       ELSE 'U' " + _
                    "	End " + _
                    " from FIU_CURRENCY_INFO " + _
                    " where IS_AUTHORIZED=0 OR STATUS in ('L','D')  " + _
                    " order by IS_AUTHORIZED,CURRENCY_CODE"
...
#End Region
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(0).Value Is Nothing) Then
                ...
                Dim frmCurDet As New FrmCurrency(dgView.SelectedRows.Item(0).Cells(2).Value, dgView.SelectedRows.Item(0).Cells(0).Value)
                frmCurDet.ShowDialog()
            End If
    ...
    Private Sub frmCurrencySumm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
