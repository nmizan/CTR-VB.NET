'
'Author             : Fahad Khan
'Purpose            : Occupation Type Summary
...
Public Class FrmOccupationTypeSummary

#Region "user defined codes"

    Dim _formName As String = "MaintenanceOccupationTypeSummary"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_OccupationType_GetDetailList")
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                dgView.Item(3, i).Value = dt.Rows(i).Item("OCP_CODE").ToString()
                dgView.Item(4, i).Value = dt.Rows(i).Item("OCP_NAME").ToString()
...
#End Region
    ...
    Private Sub FrmOccupationTypeSummary_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        Dim frmOccTypeDet As New FrmOccupationTypeDet()
        frmOccTypeDet.Show()
    End Sub
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(1).Value Is Nothing) Then
                ...
                Dim frmOccTypeDet As New FrmOccupationTypeDet(dgView.SelectedRows.Item(0).Cells(3).Value, dgView.SelectedRows.Item(0).Cells(1).Value)
                frmOccTypeDet.Show()
            End If
        Catch ex As Exception
    ...
    Private Sub btnAuthorize_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAuthorize.Click
        Try
            ...
            If MessageBox.Show("Do you really want to Authorize?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                For i = 0 To dgView.Rows.Count - 1
                    ...
                    If dgView.Rows(i).Cells(0).Value = True Then
                        ...
                        Else
                            ...
                            LoadOccTypeData(dgView.Rows(i).Cells(3).Value.ToString(), dgView.Rows(i).Cells(1).Value)


                            If (dgView.Rows(i).Cells(1).Value) > 1 Then

                                LoadOccTypeDataForAuth(dgView.Rows(i).Cells(3).Value.ToString())
                                ...
                                db.AddInParameter(commProc, "@OCP_CODE", DbType.String, dgView.Rows(i).Cells(3).Value.ToString())
                                ...
                                If result = 0 Then
                                    ...
                                    If _OccupationTypeName <> _OccTypeName Then
                                        If _OccupationTypeName = "" Then
                                            log_message = " Authorized : Occupation Type Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Occupation Type Name  : " + _OccTypeName
                                        Else
                                            log_message = " Authorized : Occupation Type Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Occupation Type Name  : " + _OccupationTypeName + " " + " To " + " " + _OccTypeName
                                        End If
                ...
                '    log_message = "Authorized Occupation Type " + dgView.Rows(i).Cells(3).Value.ToString() + " Name " + dgView.Rows(i).Cells(4).Value.ToString()
                '    Logger.system_log(log_message)
