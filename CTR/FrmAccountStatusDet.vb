'
'Author             : Fahad Khan
'Purpose            : Maintain Account Status Type Information
'Creation date      : 25-Sept-2013
'Stored Procedure(s):  
'
...
Public Class FrmAccountStatusDet

#Region "Global Variables"
    Dim _formName As String = "MaintenanceAccountStatusDet"
    Dim opt As SecForm = New SecForm(_formName)
    Dim _formMode As FormTransMode
    Dim _intModno As Integer = 0
    Dim _strAcType_Code As String = ""
    Dim _mod_datetime As Date
    Dim _status As String = ""
    Dim log_message As String = ""
    Dim _AccstatusType As String = ""

    Dim _AccountstatusType As String = ""
#End Region
#Region "User defined Codes"
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_AccountStatusType_Add")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@ACTYPE_CODE", DbType.String, txtId.Text.Trim())
            db.AddInParameter(commProc, "@ACTYPE_NAME", DbType.String, txtName.Text.Trim())
            ...
            If result = 0 Then
                ...
                _strAcType_Code = txtId.Text.Trim()

                _intModno = 1

                log_message = " Added : Account Status Code : " + txtId.Text.Trim() + " " + " And Status Name : " + txtName.Text.Trim()
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_AccountStatusType_Update")
            ...
            If result = 0 Then
                ...
                If _AccstatusType <> txtName.Text.Trim() Then

                    log_message = " Updated : Account Status Code : " + txtId.Text.Trim() + "." + " " + " Account Status Name : " + _AccstatusType + " " + " To " + " " + txtName.Text.ToString()
                    Logger.system_log(log_message)
                Else
                    log_message = " Updated : Account Status Code : " + txtId.Text.Trim() + "." + " " + " Account Status Name : " + txtName.Text.Trim()
                    Logger.system_log(log_message)
                End If
            ...
            'log_message = "Account Status " + txtId.Text.Trim() + " And Status " + _AccstatusType + " To " + txtName.Text.Trim() + " Updated"
            'Logger.system_log(log_message)
    ...
    Private Sub LoadAcStatusTypeDataForAuth(ByVal strAcTypeCode As String)
        ...
        Try
            ...
            ds = db.ExecuteDataSet(CommandType.Text, "Select * From GO_ACSTATUSTYPE Where ACTYPE_CODE='" & strAcTypeCode & "' and STATUS= 'L' ")

            If ds.Tables(0).Rows.Count > 0 Then


                _strAcType_Code = strAcTypeCode


                _formMode = FormTransMode.Update


                txtId.Text = ds.Tables(0).Rows(0)("ACTYPE_CODE").ToString()
                txtName.Text = ds.Tables(0).Rows(0)("ACTYPE_NAME").ToString()
                _AccountstatusType = ds.Tables(0).Rows(0)("ACTYPE_NAME").ToString()
    ...
    Private Sub LoadAcTypeData(ByVal strAcTypeCode As String, ByVal intMod As Integer)
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_AccountStatusType_GetDetail")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@ACTYPE_CODE", DbType.String, strAcTypeCode)
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                txtId.Text = ds.Tables(0).Rows(0)("ACTYPE_CODE").ToString()
                txtName.Text = ds.Tables(0).Rows(0)("ACTYPE_NAME").ToString()
                _AccstatusType = ds.Tables(0).Rows(0)("ACTYPE_NAME").ToString()
                ...
                Dim commProc2 As DbCommand = db.GetStoredProcCommand("GO_AccountStatusType_GetMaxMod")

                commProc2.Parameters.Clear()

                db.AddInParameter(commProc2, "@ACTYPE_CODE", DbType.String, strAcTypeCode)
    ...
    Public Sub New(ByVal strAcTypeCode As String, ByVal intMod As Integer)

        ' This call is required by the Windows Form Designer.
        InitializeComponent()

        ' Add any initialization after the InitializeComponent() call.
        LoadAcTypeData(strAcTypeCode, intMod)
        _strAcType_Code = strAcTypeCode
        _intModno = intMod
    ...
    Private Function DeleteData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("GO_AccountStatusType_Remove")

        commProc.Parameters.Clear()

        db.AddInParameter(commProc, "@ACTYPE_CODE", DbType.String, _strAcType_Code)
        db.AddInParameter(commProc, "@MOD_NO", DbType.Int32, _intModno)
        db.AddOutParameter(commProc, "@RET_MOD_NO", DbType.Int32, 5)
        ...
        log_message = "Account Status " + _strAcType_Code + " Deleted"
        Logger.system_log(log_message)
    ...
    Private Function AuthorizeData() As TransState
        ...
        If _intModno > 1 Then
            ...
            LoadAcStatusTypeDataForAuth(_strAcType_Code)
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_AccountStatusType_Auth")
            ...
            If result = 0 Then
                ...
                If _AccountstatusType <> _AccstatusType Then
                    If _AccountstatusType = "" Then
                        log_message = " Authorized : Account Status Code : " + txtId.Text.Trim() + "." + " " + " Account Status Name : " + _AccstatusType
                    Else
                        log_message = " Authorized : Account Status Code : " + txtId.Text.Trim() + "." + " " + " Account Status Name : " + _AccountstatusType + " " + " To " + " " + _AccstatusType
                    End If

                    Logger.system_log(log_message)
                Else
                    log_message = " Authorized : Account Status Code : " + txtId.Text.Trim() + "." + " " + " Account Status Name : " + txtName.Text.Trim()
                    Logger.system_log(log_message)
                End If
        ...
        'log_message = "Account Status " + _strAcType_Code + " Status Name " + txtName.Text.ToString() + " Authorized"
        'Logger.system_log(log_message)
...
#End Region
    ...
    Private Sub FrmAccountStatusDet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If _intModno > 0 Then
            LoadAcTypeData(_strAcType_Code, _intModno)
        End If
    ...
    Private Sub btnUnlock_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUnlock.Click
        ...
        If Not (_strAcType_Code.Trim() = "") Then
