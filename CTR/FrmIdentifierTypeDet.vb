'
'Author             : Fahad Khan
'Purpose            : Maintain Identifier Type Information
...
Public Class FrmIdentifierTypeDet

#Region "Global Variables"

    Dim _formName As String = "MaintenanceIdentifierTypeDet"
    Dim opt As SecForm = New SecForm(_formName)

    Dim _formMode As FormTransMode
    Dim _intModno As Integer = 0
    Dim _strIDType_Code As String = ""
    Dim _mod_datetime As Date
    Dim _status As String = ""
    Dim log_message As String = ""

    Dim _IdentName As String = ""
    Dim _IdentifierName As String = ""
#End Region
#Region "User defined Codes"
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_IdentifierType_Add")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@IDTYPE_CODE", DbType.String, txtId.Text.Trim())
            db.AddInParameter(commProc, "@IDTYPE_NAME", DbType.String, txtName.Text.Trim())
            ...
            If result = 0 Then
                ...
                _strIDType_Code = txtId.Text.Trim()

                _intModno = 1

                log_message = " Added : Identifier Type Code : " + txtId.Text.Trim() + "." + " " + " Identifier Type Name : " + txtName.Text.ToString()
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_IdentifierType_Update")
            ...
            If result = 0 Then
                ...
                If _IdentName <> txtName.Text.Trim() Then

                    log_message = " Updated : Identifier Type Code : " + txtId.Text.Trim() + "." + " " + " Identifier Type Name  : " + _IdentName + " " + " To " + " " + txtName.Text.ToString()
                    Logger.system_log(log_message)
                Else
                    log_message = " Updated : Identifier Type Code : " + txtId.Text.Trim() + "." + " " + " Identifier Type Name  : " + txtName.Text.Trim()
                    Logger.system_log(log_message)
                End If
            ...
            'log_message = "Updated Identifier Type " + txtId.Text.Trim() + " Name " + _IdentName + " To " + txtName.Text.ToString()
            'Logger.system_log(log_message)
    ...
    Private Sub LoadIDTypeDataForAuth(ByVal strIDTypeCode As String)
        ...
        Try
            ...
            ds = db.ExecuteDataSet(CommandType.Text, "Select * From GO_IDENTIFIER_TYPE Where IDTYPE_CODE ='" & strIDTypeCode & "' and STATUS= 'L' ")

            If ds.Tables(0).Rows.Count > 0 Then


                _strIDType_Code = strIDTypeCode

                _formMode = FormTransMode.Update


                txtId.Text = ds.Tables(0).Rows(0)("IDTYPE_CODE").ToString()
                txtName.Text = ds.Tables(0).Rows(0)("IDTYPE_NAME").ToString()
                _IdentifierName = ds.Tables(0).Rows(0)("IDTYPE_NAME").ToString()
    ...
    Private Sub LoadIDTypeData(ByVal strIDTypeCode As String, ByVal intMod As Integer)
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_IdentifierType_GetDetail")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@IDTYPE_CODE", DbType.String, strIDTypeCode)
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                txtId.Text = ds.Tables(0).Rows(0)("IDTYPE_CODE").ToString()
                txtName.Text = ds.Tables(0).Rows(0)("IDTYPE_NAME").ToString()
                _IdentName = ds.Tables(0).Rows(0)("IDTYPE_NAME").ToString()
                ...
                Dim commProc2 As DbCommand = db.GetStoredProcCommand("GO_IdentifierType_GetMaxMod")

                commProc2.Parameters.Clear()

                db.AddInParameter(commProc2, "@IDTYPE_CODE", DbType.String, strIDTypeCode)
    ...
    Public Sub New(ByVal strIDTypeCode As String, ByVal intMod As Integer)

        ' This call is required by the Windows Form Designer.
        InitializeComponent()

        ' Add any initialization after the InitializeComponent() call.
        LoadIDTypeData(strIDTypeCode, intMod)
        _strIDType_Code = strIDTypeCode
        _intModno = intMod
    ...
    Private Function DeleteData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("GO_IdentifierType_Remove")

        commProc.Parameters.Clear()

        db.AddInParameter(commProc, "@IDTYPE_CODE", DbType.String, _strIDType_Code)
        db.AddInParameter(commProc, "@MOD_NO", DbType.Int32, _intModno)
        db.AddOutParameter(commProc, "@RET_MOD_NO", DbType.Int32, 5)
        ...
        log_message = "Deleted Identifier Type " + _strIDType_Code + " Name " + txtName.Text.ToString()
        Logger.system_log(log_message)
    ...
    Private Function AuthorizeData() As TransState
        ...
        If _intModno > 1 Then
            ...
            LoadIDTypeDataForAuth(_strIDType_Code)
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_IdentifierType_Auth")
            ...
            If result = 0 Then
                ...
                If _IdentifierName <> _IdentName Then
                    If _IdentifierName = "" Then
                        log_message = " Authorized : Identifier Type Code : " + txtId.Text.Trim() + "." + " " + " Identifier Type Name  : " + _IdentName
                    Else
                        log_message = " Authorized : Identifier Type Code : " + txtId.Text.Trim() + "." + " " + " Identifier Type Name  : " + _IdentifierName + " " + " To " + " " + _IdentName
                    End If

                    Logger.system_log(log_message)
                Else
                    log_message = " Authorized : Identifier Type Code : " + txtId.Text.Trim() + "." + " " + " Identifier Type Name  : " + txtName.Text.Trim()
                    Logger.system_log(log_message)
                End If
        ...
        ''log_message = "Authorized Identifier Type " + _strIDType_Code + " Name " + txtName.Text.ToString()
        ''Logger.system_log(log_message)
...
#End Region
    ...
    Private Sub FrmIdentifierTypeDet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If _intModno > 0 Then
            LoadIDTypeData(_strIDType_Code, _intModno)
        End If
    ...
    Private Sub btnUnlock_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUnlock.Click
        ...
        If Not (_strIDType_Code.Trim() = "") Then
