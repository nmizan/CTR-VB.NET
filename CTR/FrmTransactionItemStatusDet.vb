'
'Author             : Fahad Khan
'Purpose            : Maintain Transaction Status Type Information
...
Public Class FrmTransactionItemStatusDet

#Region "Global Variables"
    Dim _formName As String = "MaintenanceTransactionItemStatusDet"
    Dim opt As SecForm = New SecForm(_formName)

    Dim _formMode As FormTransMode
    Dim _intModno As Integer = 0
    Dim _strTISType_Code As String = ""
...
#Region "User defined Codes"
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_TransactionStatusType_Add")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@TITYPE_CODE", DbType.String, txtId.Text.Trim())
            db.AddInParameter(commProc, "@TITYPE_NAME", DbType.String, txtName.Text.Trim())
            ...
            If result = 0 Then
                ...
                _strTISType_Code = txtId.Text.Trim()
            ...
            log_message = "Added Transaction Item Status Type " + txtId.Text.Trim() + " Name " + txtName.Text.ToString()
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_TransactionStatusType_Update")
            ...
            log_message = "Updated Transaction Item Status Type " + txtId.Text.Trim() + " Name " + txtName.Text.ToString()
            Logger.system_log(log_message)
        End If
    ...
    Private Sub LoadTISTypeData(ByVal strTISTypeCode As String, ByVal intMod As Integer)
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_TransactionStatusType_GetDetail")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@TITYPE_CODE", DbType.String, strTISTypeCode)
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                _strTISType_Code = strTISTypeCode
                _intModno = intMod

                _formMode = FormTransMode.Update


                txtId.Text = ds.Tables(0).Rows(0)("TITYPE_CODE").ToString()
                txtName.Text = ds.Tables(0).Rows(0)("TITYPE_NAME").ToString()
                ...
                Dim commProc2 As DbCommand = db.GetStoredProcCommand("GO_TransactionStatusType_GetMaxMod")

                commProc2.Parameters.Clear()

                db.AddInParameter(commProc2, "@TITYPE_CODE", DbType.String, strTISTypeCode)
    ...
    Public Sub New(ByVal strTISTypeCode As String, ByVal intMod As Integer)

        ' This call is required by the Windows Form Designer.
        InitializeComponent()

        ' Add any initialization after the InitializeComponent() call.
        LoadTISTypeData(strTISTypeCode, intMod)
        _strTISType_Code = strTISTypeCode
        _intModno = intMod
    ...
    Private Function DeleteData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("GO_TransactionStatusType_Remove")

        commProc.Parameters.Clear()

        db.AddInParameter(commProc, "@TITYPE_CODE", DbType.String, _strTISType_Code)
        db.AddInParameter(commProc, "@MOD_NO", DbType.Int32, _intModno)
        db.AddOutParameter(commProc, "@RET_MOD_NO", DbType.Int32, 5)
        ...
        Else
            tStatus = TransState.UpdateNotPossible
        End If
        log_message = "Deleted Transaction Item Status Type " + _strTISType_Code + " Name " + txtName.Text.ToString()
        Logger.system_log(log_message)
    ...
    Private Function AuthorizeData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("GO_TransactionStatusType_Auth")
        ...
        log_message = "Authorized Transaction Item Status Type " + _strTISType_Code + " Name " + txtName.Text.ToString()
        Logger.system_log(log_message)
...
#End Region
    ...
    Private Sub FrmTransactionItemStatusDet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If _intModno > 0 Then
            LoadTISTypeData(_strTISType_Code, _intModno)
        End If
    ...
    Private Sub btnUnlock_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUnlock.Click
        ...
        If Not (_strTISType_Code.Trim() = "") Then
