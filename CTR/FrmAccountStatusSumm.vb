'
'Author             : Fahad Khan
'Purpose            : Account Status Type Summary
...
Public Class FrmAccountStatusSumm

#Region "user defined codes"

    Dim _formName As String = "MaintenanceAccountStatusSumm"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_AccountStatusType_GetDetailList")
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                dgView.Item(3, i).Value = dt.Rows(i).Item("ACTYPE_CODE").ToString()
                dgView.Item(4, i).Value = dt.Rows(i).Item("ACTYPE_NAME").ToString()
...
#End Region
    ...
    Private Sub FrmAccountStatusSumm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(1).Value Is Nothing) Then
                ...
                Dim frmAccountStatusDet As New FrmAccountStatusDet(dgView.SelectedRows.Item(0).Cells(3).Value, dgView.SelectedRows.Item(0).Cells(1).Value)
                frmAccountStatusDet.Show()
            End If
        Catch ex As Exception
    ...
    Private Sub btnAuthorize_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAuthorize.Click
        Try
            ...
            If MessageBox.Show("Do you really want to Authorize?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                    ...
                    If dgView.Rows(i).Cells(0).Value = True Then
                        ...
                        Else
                            ...
                            If (dgView.Rows(i).Cells(1).Value) > 1 Then
                                ...
                                LoadAcStatusTypeDataForAuth(dgView.Rows(i).Cells(3).Value.ToString())
                                ...
                                db.AddInParameter(commProc, "@ACTYPE_CODE", DbType.String, dgView.Rows(i).Cells(3).Value.ToString())
                                ...
                                If result = 0 Then
                                    ...
                                    If _AccountstatusType <> _AccstatusType Then
                                        If _AccountstatusType = "" Then
                                            log_message = " Authorized : Account Status Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Account Status Name : " + _AccstatusType
                                        Else
                                            log_message = " Authorized : Account Status Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Account Status Name : " + _AccountstatusType + " " + " To " + " " + _AccstatusType
                                        End If
                ...
                '    log_message = "Account Status " + dgView.Rows(i).Cells(3).Value.ToString() + " And Status " + dgView.Rows(i).Cells(4).Value.ToString() + " Authorized"
                '    Logger.system_log(log_message)
                'Next i
