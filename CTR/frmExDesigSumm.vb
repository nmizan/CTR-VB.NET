...
Public Class frmExDesigSumm

#Region "user defined codes"

    Dim _formName As String = "MaintenanceExecutiveDesignitionSummary"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            If chkShowAll.Checked = True Then
                strSql = "select EXE_DESIG_CODE, EXE_DESIG_NAME,IS_AUTHORIZED,MODNO, " + _
                    " 'S' = " + _
                    "	CASE  " + _
                    ...
                    "       ELSE 'U' " + _
                    "	End " + _
                    " from FIU_EXECUTIVE_DESIG " + _
                    " where IS_AUTHORIZED=0 OR STATUS in ('L','D')  " + _
                    " order by IS_AUTHORIZED,EXE_DESIG_CODE"
...
#End Region
    ...
    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        ...
        Dim frmExDes As New FrmExDesig
        frmExDes.ShowDialog()
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(0).Value Is Nothing) Then
                ...
                Dim frmExDes As New FrmExDesig(dgView.SelectedRows.Item(0).Cells(2).Value, dgView.SelectedRows.Item(0).Cells(0).Value)
                frmExDes.ShowDialog()
            End If
    ...
    Private Sub frmExDesigSumm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
