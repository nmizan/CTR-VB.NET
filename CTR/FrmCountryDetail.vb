'
'Author             : Fahad Khan
'Purpose            : Maintain Country Type Information
...
#Region "Global Variables"
    ...
    Dim _strCountryType_Code As String = ""
...
#Region "User defined Codes"
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_CountryType_Add")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@COUNTRY_CODE", DbType.String, txtId.Text.Trim())
            db.AddInParameter(commProc, "@COUNTRY_NAME", DbType.String, txtName.Text.Trim())
            ...
            If result = 0 Then
                ...
                _strCountryType_Code = txtId.Text.Trim()

                _intModno = 1

                log_message = " Added : Country Code : " + txtId.Text.Trim() + "." + " " + " Country Name : " + txtName.Text.ToString()
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_CountryType_Update")
            ...
            If result = 0 Then
                ...
                If _Country <> txtName.Text.Trim() Then

                    log_message = " Updated : Country Code : " + txtId.Text.Trim() + "." + " " + " Country Name : " + _Country + " " + " To " + " " + txtName.Text.ToString()
                    Logger.system_log(log_message)
                Else
                    log_message = " Updated : Country Code : " + txtId.Text.Trim() + "." + " " + " Country Name : " + txtName.Text.Trim()
                    Logger.system_log(log_message)
                End If
            ...
            'log_message = "Updated Country Type " + txtId.Text.Trim() + " Name " + _Country + " To " + txtName.Text.ToString()
            'Logger.system_log(log_message)
    ...
    Private Sub LoadCountryTypeDataForAuth(ByVal strCountryTypeCode As String)
        ...
        Try
            ...
            ds = db.ExecuteDataSet(CommandType.Text, "Select * From GO_COUNTRY_TYPE Where COUNTRY_CODE ='" & strCountryTypeCode & "' and STATUS= 'L' ")

            If ds.Tables(0).Rows.Count > 0 Then


                _strCountryType_Code = strCountryTypeCode


                _formMode = FormTransMode.Update


                txtId.Text = ds.Tables(0).Rows(0)("COUNTRY_CODE").ToString()
                txtName.Text = ds.Tables(0).Rows(0)("COUNTRY_NAME").ToString()
    ...
    Private Sub LoadCountryTypeData(ByVal strCountryTypeCode As String, ByVal intMod As Integer)
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_CountryType_GetDetail")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@COUNTRY_CODE", DbType.String, strCountryTypeCode)
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                txtId.Text = ds.Tables(0).Rows(0)("COUNTRY_CODE").ToString()
                txtName.Text = ds.Tables(0).Rows(0)("COUNTRY_NAME").ToString()
                _Country = ds.Tables(0).Rows(0)("COUNTRY_NAME").ToString()
                ...
                Dim commProc2 As DbCommand = db.GetStoredProcCommand("GO_CountryType_GetMaxMod")

                commProc2.Parameters.Clear()

                db.AddInParameter(commProc2, "@COUNTRY_CODE", DbType.String, strCountryTypeCode)
    ...
    Public Sub New(ByVal strCountryTypeCode As String, ByVal intMod As Integer)

        ' This call is required by the Windows Form Designer.
        InitializeComponent()

        ' Add any initialization after the InitializeComponent() call.
        LoadCountryTypeData(strCountryTypeCode, intMod)
        _strCountryType_Code = strCountryTypeCode
        _intModno = intMod
    ...
    Private Function DeleteData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("GO_CountryType_Remove")

        commProc.Parameters.Clear()

        db.AddInParameter(commProc, "@COUNTRY_CODE", DbType.String, _strCountryType_Code)
        db.AddInParameter(commProc, "@MOD_NO", DbType.Int32, _intModno)
        db.AddOutParameter(commProc, "@RET_MOD_NO", DbType.Int32, 5)
        ...
        log_message = "Deleted Country Type " + _strCountryType_Code + " Name " + txtName.Text.ToString()
        Logger.system_log(log_message)
    ...
    Private Function AuthorizeData() As TransState
        ...
        If _intModno > 1 Then
            ...
            LoadCountryTypeDataForAuth(_strCountryType_Code)
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_CountryType_Auth")
            ...
            If result = 0 Then
                ...
                If _CountryName <> _Country Then
                    If _CountryName = "" Then
                        log_message = " Authorized : Country Code : " + txtId.Text.Trim() + "." + " " + " Country Name : " + _Country
                    Else
                        log_message = " Authorized : Country Code : " + txtId.Text.Trim() + "." + " " + " Country Name : " + _CountryName + " " + " To " + " " + _Country
                    End If
                    Logger.system_log(log_message)
                Else
                    log_message = " Authorized : Country Code : " + txtId.Text.Trim() + "." + " " + " Country Name : " + txtName.Text.Trim()
                    Logger.system_log(log_message)
                End If
        ...
        ''log_message = "Authorized Country Type " + _strCountryType_Code + " Name " + txtName.Text.ToString()
        ''Logger.system_log(log_message)
...
#End Region
    ...
    Private Sub FrmCountryDetail_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If _intModno > 0 Then
            LoadCountryTypeData(_strCountryType_Code, _intModno)
        End If
    ...
    Private Sub btnUnlock_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUnlock.Click
        ...
        If Not (_strCountryType_Code.Trim() = "") Then
    ...
    Private Sub btnPrevVer_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrevVer.Click
        If _intModno - 1 > 0 Then
            LoadCountryTypeData(_strCountryType_Code, _intModno - 1)
        End If
    End Sub

    Private Sub btnNextVer_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNextVer.Click
        Dim strCountryTypeCode As String = _strCountryType_Code
        Dim intModno As Integer = _intModno
        If intModno > 0 Then
            LoadCountryTypeData(_strCountryType_Code, _intModno + 1)

            If _intModno = 0 Then
                LoadCountryTypeData(strCountryTypeCode, intModno)
            End If
        End If
    End Sub
