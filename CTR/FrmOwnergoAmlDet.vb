...
Public Class FrmOwnergoAmlDet


#Region "Global Variables"

    Dim _formName As String = "MaintenanceOwnergoAmlDet"
...
#Region "User defined Codes"
    ...
    Private Sub DisableFields()
        ...
        cmbOccupationType.Enabled = False
    ...
    Private Sub EnableFields()
        ...
        cmbOccupationType.Enabled = True
    ...
    Private Sub ClearFields()
        ...
        cmbOccupationType.SelectedIndex = -1
    ...
    Private Sub LoadMainData(ByVal strId As String, ByVal intmod As Integer)
        ...
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                txtId.Text = ds.Tables(0).Rows(0)("OWNER_CODE").ToString
                ...
                cmbOccupationType.Text = ds.Tables(0).Rows(0)("OCP_CODE").ToString
                ...
                cmbNationality1.SelectedValue = ds.Tables(0).Rows(0)("NATIONALITY1").ToString
                _nationality1 = ds.Tables(0).Rows(0)("NATIONALITY1").ToString()
                cmbNationality2.SelectedValue = ds.Tables(0).Rows(0)("NATIONALITY2").ToString
                cmbNationality3.SelectedValue = ds.Tables(0).Rows(0)("NATIONALITY3").ToString
                cmbResidence.SelectedValue = ds.Tables(0).Rows(0)("RESIDENCE").ToString
                ...
                If ds.Tables(0).Rows(0)("DECEASED") = 1 Then
                ...
                Dim commProc2 As DbCommand = db.GetStoredProcCommand("GO_OwnerInfo_GetMaxMod")

                commProc2.Parameters.Clear()

                db.AddInParameter(commProc2, "@OWNER_CODE", DbType.String, strId)
    ...
    Private Sub LoadPersonalPhoneData(ByVal strId As String, ByVal intmod As Integer)
        ...
        Try
            ...
            Dim commProcSche As DbCommand = db.GetStoredProcCommand("GO_OwnerPersonalPhone_GetDetails")

            commProcSche.Parameters.Clear()

            db.AddInParameter(commProcSche, "@OWNER_CODE", DbType.String, strId)
    ...
    Private Sub LoadEmployerPhoneData(ByVal strId As String, ByVal intmod As Integer)
        ...
        Try
            ...
            Dim commProcSche As DbCommand = db.GetStoredProcCommand("GO_OwnerEmployerPhone_GetDetails")
    ...
    Private Sub LoadPersonAddressData(ByVal strId As String, ByVal intmod As Integer)
        ...
        Try
            ...
            Dim dt As New DataTable
            Dim Status As String = "P"
            Dim commProcSche As DbCommand = db.GetStoredProcCommand("GO_OwnerPersonalAddress_GetDetails")
    ...
    Private Sub LoadEmployerAddressData(ByVal strId As String, ByVal intmod As Integer)
        ...
        Try
            ...
            Dim dt As New DataTable
            Dim Status As String = "E"
            Dim commProcSche As DbCommand = db.GetStoredProcCommand("GO_OwnerEmployerAddress_GetDetails")
    ...
    Private Sub LoadIdentificationData(ByVal strId As String, ByVal intmod As Integer)
        ...
        Try
            ...
            Dim dt As New DataTable
            Dim Status As String = "E"
            Dim commProcSche As DbCommand = db.GetStoredProcCommand("GO_OwnerPersonalIdentificarion_GetDetails")
        ...
        End Try
    End Sub
    '-------Mizan work-----16.02.2016---------

    Private Function CheckPPNO(ByVal owner_code As String)
        Dim result As Integer
        Using conn As New SqlConnection(CommonAppSet.ConnStr)
            Using cmd As New SqlCommand()
                Dim db As New SqlDatabase(CommonAppSet.ConnStr)
                cmd.CommandText = "select dbo.CheckPPNO(@owner_code)"
                cmd.CommandType = CommandType.Text
                cmd.Connection = conn
                cmd.Parameters.AddWithValue("@owner_code", owner_code)
                conn.Open()
    ...
    End Function
    '-------Mizan work-----18.02.2016---------

    Private Function Check_Owner_Code(ByVal ownercode As String)
        Dim result As String
        Using conn As New SqlConnection(CommonAppSet.ConnStr)
            Using cmd As New SqlCommand()
                Dim db As New SqlDatabase(CommonAppSet.ConnStr)
                cmd.CommandText = "select dbo.Check_Owner_Code(@ownercode)"
                cmd.CommandType = CommandType.Text
                cmd.Connection = conn
                cmd.Parameters.AddWithValue("@ownercode", ownercode)
                conn.Open()
                result = DirectCast(cmd.ExecuteScalar(), Int32)
                conn.Close()
            End Using
        End Using
        Return result
    ...
    End Function
    '-------Mizan work-----16.03.2016---------

    'Private Function Get_CTR_Owner_Info(ByVal ownercode As String)

    '    Using conn As New SqlConnection(CommonAppSet.ConnStr)
    '        Using cmd As New SqlCommand()
    '            Dim db As New SqlDatabase(CommonAppSet.ConnStr)
    '            'cmd.CommandText = "Select dbo.Get_Owner_Info(@owner_code)"
    '            cmd.CommandText = "Select OWNER_NAME FROM FIU_OWNER_INFO WHERE OWNER_CODE=@owner_code"
    '            cmd.CommandType = CommandType.Text
    '            cmd.Connection = conn
    '            cmd.Parameters.AddWithValue("@owner_code", ownercode)
    '            conn.Open()
    '            Dim reader As SqlDataReader = cmd.ExecuteReader()
    '            If (reader.Read()) Then
    '                txtFirstName.Text = reader.GetString(0).Split(" ")(0)
    '                'txtMIddleName.Text = reader.GetString(0).Split(" ")(1)
    '                'txtLastName.Text = reader.GetString(0).Split(" ")(2)
    '                Dim i As Integer = reader.GetString(0).IndexOf(" ")
    '                txtLastName.Text = reader.GetString(0).Substring(i, reader.GetString(0).Length - i)
    ...
    'End Function
    '-------Mizan work-----19.03.2016---------

    Private Function Check_Owner_Code_goAML_HIST(ByVal ownercode As String)
        Dim result As Integer
        Using conn As New SqlConnection(CommonAppSet.ConnStr)
            Using cmd As New SqlCommand()
                Dim db As New SqlDatabase(CommonAppSet.ConnStr)
                cmd.CommandText = "select dbo.Check_Owner_CodeGOAML(@ownercode)"
                cmd.CommandType = CommandType.Text
                cmd.Connection = conn
                cmd.Parameters.AddWithValue("@ownercode", ownercode)
                conn.Open()
    ...
    End Function
    '-------Mizan work-----20.03.2016---------

    Private Function Check_Owner_Code_goAML_Info(ByVal ownercode As String)
        Dim result As Integer
        Using conn As New SqlConnection(CommonAppSet.ConnStr)
            Using cmd As New SqlCommand()
                Dim db As New SqlDatabase(CommonAppSet.ConnStr)
                cmd.CommandText = "select dbo.Check_Owner_Code_GOAML_Info(@ownercode)"
                cmd.CommandType = CommandType.Text
                cmd.Connection = conn
                cmd.Parameters.AddWithValue("@ownercode", ownercode)
                conn.Open()
    ...
    Private Function CheckValidData() As Boolean
        ...
        If txtId.Text.Trim() = "" Then
            ...
            Return False
        Else
            '--------Mizan work-23-03-2016-----------
            If _formMode = FormTransMode.Add Then
                If Check_Owner_Code_goAML_HIST(txtId.Text.Trim()) = 0 Then
                    If Check_Owner_Code_goAML_Info(txtId.Text.Trim()) = 1 Then
                        MessageBox.Show("Owner Code Exists in GoAML !!", "Saving Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                        Return False
                    End If
                Else
                    MessageBox.Show("Owner Code Exists in GoAML But Not Authorized !!", "Saving Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Return False
                End If
            ElseIf _formMode = FormTransMode.Update Then

                If Check_Owner_Code_goAML_HIST(txtId.Text.Trim()) = 1 Then
                    MessageBox.Show(" Authorize Required !!", "Saving Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Return False
                End If
            End If
        ...
        ElseIf txtLastName.Text.Trim() = "" Then
            ...
            '--- Comment by Mizan- 16-02-2016-----------

            'ElseIf txtSSN.Text.Trim() = "" And txtIDNumber.Text = "" Then

            '    MessageBox.Show(" National ID/ Birth Registration Number required !!", "Saving Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            '    txtSSN.Focus()
            '    Return False
        ...
        ElseIf txtSSN.Text.Trim() = "" And txtIDNumber.Text = "" Then
            If Check_Owner_Code(txtId.Text) = 1 Then
                If CheckPPNO(txtId.Text) = 0 Then
                    MessageBox.Show(" National ID/ Birth Registration Number required !!", "Saving Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Return False
                End If
            Else
                MessageBox.Show(" National ID/ Birth Registration Number required !!", "Saving Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                'MessageBox.Show("Not Found data in Maintenance/Owner Info(Detail) Form in CTR !!", "Saving Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                Return False
            End If
            txtSSN.Focus()
        End If
        ...
        'ElseIf txtSSN.Text <> "" And Len(txtSSN.Text) <> 13 And Len(txtSSN.Text) <> 17 Then
        '    MessageBox.Show(" National ID Must be 13 Digit or 17 digits !!", "Saving Error", MessageBoxButtons.OK, MessageBoxIcon.Error)

        '    Return False


        If cmbNationality1.Text = "" Then
            MessageBox.Show("Nationality1 Type required !!", "Saving Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            cmbNationality1.Focus()
            Return False

            'ElseIf cmbNationality1.Text = "" Then
            '    MessageBox.Show("Nationality1 Type required !!", "Saving Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            '    cmbNationality1.Focus()
            '    Return False

        ElseIf cmbResidence.Text = "" Then
            MessageBox.Show("Residence Type required !!", "Saving Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            cmbResidence.Focus()
            Return False

        ElseIf cmbOccupationType.Text = "" Then
            MessageBox.Show(" Occupation Type required !!", "Saving Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            cmbOccupationType.Focus()
            Return False
        ...
        ElseIf DataGridView4.Rows.Count() = 0 Then
            ...
            MessageBox.Show(" Atleast Personal One Address Number Required !!", "Saving Error", MessageBoxButtons.OK, MessageBoxIcon.Error)

            Return False

        ElseIf DataGridView6.Rows.Count() = 0 Then

            MessageBox.Show(" Atleast Personal One Identification Number Required !!", "Saving Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then
            ...
            Using conn As DbConnection = db.CreateConnection()
                ...
                Dim commProc As DbCommand = db.GetStoredProcCommand("GO_OwnerInfo_Add")

                commProc.Parameters.Clear()


                db.AddInParameter(commProc, "@OWNER_CODE", DbType.String, txtId.Text)
                ...
                db.AddInParameter(commProc, "@MIDDLE_NAME", DbType.String, txtMIddleName.Text)

                db.AddInParameter(commProc, "@LAST_NAME", DbType.String, txtLastName.Text)
                ...
                db.AddInParameter(commProc, "@OCP_CODE", DbType.String, cmbOccupationType.Text.Trim)
                ...
                '------------------
                '.......Mizanur Rahman Work (15.03.2016).........


                ' Add FIU_Owner_Info

                If Check_Owner_Code(txtId.Text) = 0 Then

                    Dim commProcFiu As DbCommand = db.GetStoredProcCommand("GO_FIUOwnerInfo_Form_Add")
                    commProcFiu.Parameters.Clear()

                    db.AddInParameter(commProcFiu, "@P_OWNER_CODE", DbType.String, txtId.Text)
                    db.AddInParameter(commProcFiu, "@P_OWNER_NAME", DbType.String, txtTitle.Text + " " + txtFirstName.Text + " " + txtMIddleName.Text + " " + txtLastName.Text)


                    db.AddParameter(commProcFiu, "@PROC_RET_VAL", DbType.Int32, ParameterDirection.ReturnValue, DBNull.Value.ToString(), DataRowVersion.Default, DBNull.Value)

                    Dim res As Integer


                    db.ExecuteNonQuery(commProcFiu, trans)
                    res = db.GetParameterValue(commProcFiu, "@PROC_RET_VAL")
                ...
                Else
                    '.......Mizanur Rahman Work (19.03.2016).........


                    'Update FIU_Owner_Info


                    Dim strModSql As String

                    strModSql = "select isnull(max(MODNO),0)+1 from FIU_OWNER_INFO where OWNER_CODE=@P_OWNER_CODE"
                    Dim commProcOwner1 As DbCommand = db.GetSqlStringCommand(strModSql)
                    commProcOwner1.Parameters.Clear()
                    db.AddInParameter(commProcOwner1, "@P_OWNER_CODE", DbType.String, txtId.Text)
                    intModnoU = db.ExecuteDataSet(commProcOwner1).Tables(0).Rows(0)(0)

                    ' If intModno > 0 Then

                    Dim strSql As String

                    strSql = "UPDATE FIU_OWNER_INFO SET OWNER_NAME= @P_OWNER_NAME , MODNO =  " & intModnoU.ToString() & ", INPUT_BY= @P_Input_By, INPUT_DATETIME =  getdate() , IS_AUTHORIZED= 0,  STATUS = 'U' WHERE OWNER_CODE= @P_OWNER_CODE and MODNO=(select MAX(MODNO) from FIU_OWNER_INFO where OWNER_CODE=@P_OWNER_CODE) and (STATUS='L' or STATUS='U')"



                    Dim commProcOwner As DbCommand = db.GetSqlStringCommand(strSql)

                    commProc.Parameters.Clear()


                    db.AddInParameter(commProcOwner, "@P_OWNER_CODE", DbType.String, txtId.Text)
                    db.AddInParameter(commProcOwner, "@P_OWNER_NAME", DbType.String, txtTitle.Text + " " + txtFirstName.Text + " " + txtMIddleName.Text + " " + txtLastName.Text)

                    db.AddInParameter(commProcOwner, "@P_Input_By", DbType.String, CommonAppSet.User)

                    db.ExecuteNonQuery(commProcOwner, trans)
                ...
                Else
                    ...
                    For i = 0 To DataGridView1.Rows.Count - 1
                        ...
                        db.AddInParameter(commProcSche, "@OWNER_CODE", DbType.String, txtId.Text.Trim())
                    ...
                    For i = 0 To DataGridView4.Rows.Count - 1
                        ...
                        db.AddInParameter(commProcAdd, "@OWNER_CODE", DbType.String, txtId.Text.Trim())
                    ...
                    For i = 0 To DataGridView3.Rows.Count - 1
                        ...
                        db.AddInParameter(commProcEMPhone, "@OWNER_CODE", DbType.String, txtId.Text.Trim())
                    ...
                    For i = 0 To DataGridView5.Rows.Count - 1
                        ...
                        db.AddInParameter(commProcEMAdd, "@OWNER_CODE", DbType.String, txtId.Text.Trim())
                    ...
                    For i = 0 To DataGridView6.Rows.Count - 1
                        ...
                        db.AddInParameter(commProcIdent, "@OWNER_CODE", DbType.String, txtId.Text.Trim())
                    ...
                    log_message = " Added : Owner Code : " + txtId.Text.Trim() + "." + " " + " Owner Name : " + txtTitle.Text.ToString() + " " + txtFirstName.Text.ToString() + " " + txtMIddleName.Text.ToString() + " " + txtLastName.Text.ToString()
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Using conn As DbConnection = db.CreateConnection()
                ...
                Dim commProc As DbCommand = db.GetStoredProcCommand("GO_OwnerInfo_Update")

                commProc.Parameters.Clear()

                db.AddInParameter(commProc, "@OWNER_CODE", DbType.String, _strId)
                ...
                '.......Mizanur Rahman Work (20.03.2016).........
                ...
                Else
                    ...
                    ' db.ExecuteNonQuery(trans, CommandType.Text, "delete FIU_OWNER_INFO where OWNER_CODE='@P_OWNER_CODE' and IS_AUTHORIZED=0")
                    ...
                    Dim strFiuSql As String

                    strFiuSql = "UPDATE FIU_OWNER_INFO SET OWNER_NAME= @P_OWNER_NAME , MODNO =  " & intModnoU.ToString() & ", INPUT_BY= @P_Input_By, INPUT_DATETIME =  getdate() , IS_AUTHORIZED= 0,  STATUS = 'U' WHERE OWNER_CODE= @P_OWNER_CODE and MODNO=(select MAX(MODNO) from FIU_OWNER_INFO where OWNER_CODE=@P_OWNER_CODE) and (STATUS='L' or STATUS='U')"



                    Dim commProcOwner As DbCommand = db.GetSqlStringCommand(strFiuSql)
                ...
                For i = 0 To DataGridView1.Rows.Count - 1
                    ...
                    db.AddInParameter(commProcSche, "@TPH_ID", DbType.String, DataGridView1.Rows(i).Cells(0).Value)
                    db.AddInParameter(commProcSche, "@OWNER_CODE", DbType.String, _strId)
                    db.AddInParameter(commProcSche, "@SID", DbType.String, DataGridView1.Rows(i).Cells(7).Value)
                    db.AddInParameter(commProcSche, "@SLNO", DbType.String, DataGridView1.Rows(i).Cells(6).Value)
                    db.AddInParameter(commProcSche, "@TPH_CONTACT_TYPE", DbType.String, DataGridView1.Rows(i).Cells(1).Value)
                    db.AddInParameter(commProcSche, "@TPH_COMMUNICATION_TYPE", DbType.String, DataGridView1.Rows(i).Cells(2).Value)
                ...
                For i = 0 To DataGridView4.Rows.Count - 1
                    ...
                    db.AddInParameter(commProcAdd, "@ADDRESS_ID", DbType.String, DataGridView4.Rows(i).Cells(0).Value)
                    db.AddInParameter(commProcAdd, "@OWNER_CODE", DbType.String, _strId)
                    db.AddInParameter(commProcAdd, "@SID", DbType.String, DataGridView4.Rows(i).Cells(9).Value)
                    db.AddInParameter(commProcAdd, "@SLNO", DbType.String, DataGridView4.Rows(i).Cells(8).Value)
                    db.AddInParameter(commProcAdd, "@ADDRESS_TYPE", DbType.String, DataGridView4.Rows(i).Cells(1).Value)
                    db.AddInParameter(commProcAdd, "@ADDRESS", DbType.String, DataGridView4.Rows(i).Cells(2).Value)
                ...
                For i = 0 To DataGridView3.Rows.Count - 1
                    ...
                    If (Not (String.IsNullOrEmpty(DataGridView3.Rows(i).Cells(0).Value.ToString()))) Then  ''......Mizan work (21.03.16)........

                        db.AddInParameter(commProcEMPhone, "@TPH_ID", DbType.String, DataGridView3.Rows(i).Cells(0).Value)
                        db.AddInParameter(commProcEMPhone, "@OWNER_CODE", DbType.String, _strId)
                        db.AddInParameter(commProcEMPhone, "@SID", DbType.String, DataGridView3.Rows(i).Cells(7).Value)
                        db.AddInParameter(commProcEMPhone, "@SLNO", DbType.String, DataGridView3.Rows(i).Cells(6).Value)
                        db.AddInParameter(commProcEMPhone, "@TPH_CONTACT_TYPE", DbType.String, DataGridView3.Rows(i).Cells(1).Value)
                        db.AddInParameter(commProcEMPhone, "@TPH_COMMUNICATION_TYPE", DbType.String, DataGridView3.Rows(i).Cells(2).Value)
                ...
                For i = 0 To DataGridView5.Rows.Count - 1
                    ...
                    If (Not (String.IsNullOrEmpty(DataGridView5.Rows(i).Cells(0).Value.ToString()))) Then   ''........Mizan work (21.03.2016)....

                        db.AddInParameter(commProcEMAdd, "@ADDRESS_ID", DbType.String, DataGridView5.Rows(i).Cells(0).Value)
                        db.AddInParameter(commProcEMAdd, "@OWNER_CODE", DbType.String, _strId)
                        db.AddInParameter(commProcEMAdd, "@SID", DbType.String, DataGridView5.Rows(i).Cells(9).Value)
                        db.AddInParameter(commProcEMAdd, "@SLNO", DbType.String, DataGridView5.Rows(i).Cells(8).Value)
                        db.AddInParameter(commProcEMAdd, "@ADDRESS_TYPE", DbType.String, DataGridView5.Rows(i).Cells(1).Value)
                        db.AddInParameter(commProcEMAdd, "@ADDRESS", DbType.String, DataGridView5.Rows(i).Cells(2).Value)
                ...
                For i = 0 To DataGridView6.Rows.Count - 1
                    ...
                    db.AddInParameter(commProcIdent, "@IDENTIFICATION_ID", DbType.String, DataGridView6.Rows(i).Cells(0).Value)
                    db.AddInParameter(commProcIdent, "@OWNER_CODE", DbType.String, _strId)
                    db.AddInParameter(commProcIdent, "@SID", DbType.String, DataGridView6.Rows(i).Cells(8).Value)
                    db.AddInParameter(commProcIdent, "@SLNO", DbType.String, DataGridView6.Rows(i).Cells(7).Value)
                    db.AddInParameter(commProcIdent, "@TYPE", DbType.String, DataGridView6.Rows(i).Cells(1).Value)
                    db.AddInParameter(commProcIdent, "@NUMBER", DbType.String, DataGridView6.Rows(i).Cells(2).Value)
                ...
                If _FName <> txtFirstName.Text.Trim() Then
                    ...
                    GoOwnerList.Add(log_message)
                End If
                If _LName <> txtLastName.Text.Trim() Then
                    log_message = " Last Name : " + _LName + " " + " To " + " " + txtLastName.Text.ToString() + "." + " "
                    GoOwnerList.Add(log_message)
                End If
                If _MName <> txtMIddleName.Text.Trim() Then
                    If _MName = "" Then
                        log_message = " Middle Name : " + txtMIddleName.Text.ToString() + "." + " "

                    Else
                        log_message = " Middle Name : " + _MName + " " + " To " + " " + txtMIddleName.Text.ToString() + "." + " "

                    End If
                    GoOwnerList.Add(log_message)
                End If

                If _NID <> txtSSN.Text.Trim() Then
                    If _NID = "" Then
                        log_message = " National ID : " + txtSSN.Text.ToString() + "." + " "

                    Else
                        log_message = " National ID : " + _NID + " " + " To " + " " + txtSSN.Text.ToString() + "." + " "
                ...
                If _sourceWealth <> txtSourceWealth.Text.Trim() Then
                    ...
                    GoOwnerList.Add(log_message)
                End If
                If _EmpName <> txtEmployerName.Text.Trim() Then
                    If _EmpName = "" Then
                        log_message = " Employer Name : " + txtEmployerName.Text.ToString + "." + " "

                    Else
                        log_message = " Employer Name : " + _EmpName + " " + " To " + " " + txtEmployerName.Text.ToString + "." + " "
                ...
                End If
                If _OccType <> cmbOccupationType.Text Then

                    log_message = " Occupation Type : " + _OccType + " " + " To " + " " + cmbOccupationType.Text + "." + " "
                    GoOwnerList.Add(log_message)

                End If

                For Each ownerloglist As String In GoOwnerList
                    _goownerLog += ownerloglist
                Next

                _golog = " Updated : Owner Code : " + txtId.Text.ToString() + "." + " " + _goownerLog
    ...
    Private Sub LoadOwnerData(ByVal strId As String)
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_OwnerInfo_GetDetail")
    ...
    Private Function AuthorizeData() As TransState
        ...
        If _intModno > 1 Then
            ...
            If result = 0 Then
                ...
                _golog = " Authorized : Owner Code : " + txtId.Text.ToString() + "." + " " + _goownerLog
            ...
            'log_message = "Authorized  Owner  " + _strId + " Name " + txtTitle.Text.ToString() + " " + txtFirstName.Text.ToString() + " " + txtMIddleName.Text.ToString() + " " + txtLastName.Text.ToString()
            'Logger.system_log(log_message)
        ...
        Else
            ...
            If result = 0 Then
                ...
                _golog = " Authorized : Owner Code : " + txtId.Text.ToString() + "." + " " + " For Mandatory Field : " + "." + " " + _goownerLog
    ...
    Private Function DeleteData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("GO_OwnerInfo_Remove")
        ...
        log_message = "Delete Owner  " + _strId + " Name " + txtFirstName.Text.ToString() + " " + txtLastName.Text.ToString()
        Logger.system_log(log_message)
...
#End Region
    ...
    Private Sub FrmOwnergoAmlDet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        CommonUtil.FillComboBox("GO_OccupationType_GetList", cmbOccupationType)
        ...
        If _strOwner_Code <> "" Then

            LoadOwnerData(_strOwner_Code)

            '.......Mizanur Rahman Work (20.03.2016).........


            'If (Check_Owner_Code(_strOwner_Code) = 1 And Check_Owner_Code_goAML_HIST(_strOwner_Code) = 1) Then
            '    LoadOwnerData(_strOwner_Code)

            'ElseIf (Check_Owner_Code(_strOwner_Code) = 1 And Check_Owner_Code_goAML_Info(_strOwner_Code) = 1) Then
            '    LoadOwnerData(_strOwner_Code)

            'ElseIf (Check_Owner_Code(_strOwner_Code) = 1 And Check_Owner_Code_goAML_HIST(_strOwner_Code) = 0 And Check_Owner_Code_goAML_Info(_strOwner_Code) = 0) Then

            '    Get_CTR_Owner_Info(_strOwner_Code)
    ...
    Private Sub AddToGrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AddToGrid.Click
        ...
        If _RowEditMode = True Then
            ...
            DataGridView1.Item(0, selRow).Value = Label80.Text.Trim()
    ...
    Private Sub DataGridView1_CellDoubleClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView1.CellDoubleClick
        ...
        If Not (DataGridView1.SelectedRows.Item(0).Cells(0).Value Is Nothing Or DataGridView1.SelectedRows.Item(0).Cells(0).Value Is DBNull.Value) Then
            ...
            Label80.Text = DataGridView1.Item(0, e.RowIndex).Value.ToString
            ...
            txtCountryPrefix.Text = DataGridView1.Item(3, e.RowIndex).Value.ToString
            TxtPhone.Text = DataGridView1.Item(4, e.RowIndex).Value.ToString
            txtExtension.Text = DataGridView1.Item(5, e.RowIndex).Value.ToString
    ...
    Private Sub btnAddPersonalAddressGrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAddPersonalAddressGrid.Click
        ...
        ElseIf cmbPDivision.Text.Trim() = "" Then
            ...
            cmbPDivision.Focus()
            Exit Sub
        ElseIf cmbPDistrict.Text.Trim() = "" Then
        ...
        If _RowEditMode = True Then
            ...
            DataGridView4.Item(0, selRow).Value = Label80.Text.Trim()
    ...
    Private Sub DataGridView4_CellDoubleClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView4.CellDoubleClick
        ...
        If Not (DataGridView4.SelectedRows.Item(0).Cells(0).Value Is Nothing Or DataGridView4.SelectedRows.Item(0).Cells(0).Value Is DBNull.Value) Then
            ...
            Label80.Text = DataGridView4.Item(0, e.RowIndex).Value.ToString
    ...
    Private Sub btnEmpAddtoGrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEmpAddtoGrid.Click
        ...
        If _RowEditMode = True Then
            ...
            DataGridView3.Item(0, selRow).Value = Label80.Text.Trim()
    ...
    Private Sub DataGridView3_CellDoubleClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView3.CellDoubleClick
        ...
        If Not (DataGridView3.SelectedRows.Item(0).Cells(0).Value Is Nothing Or DataGridView3.SelectedRows.Item(0).Cells(0).Value Is DBNull.Value) Then
            ...
            Label80.Text = DataGridView3.Item(0, e.RowIndex).Value.ToString
            ...
            txtEmpPrefix.Text = DataGridView3.Item(3, e.RowIndex).Value.ToString
            txtEmpPhone.Text = DataGridView3.Item(4, e.RowIndex).Value.ToString
            txtEmpExtension.Text = DataGridView3.Item(5, e.RowIndex).Value.ToString
    ...
    Private Sub btmEnployerAddressAddToGrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btmEnployerAddressAddToGrid.Click
        ...
        If cmbEmployerContact.Text = "" Then
            MessageBox.Show("Address Type required !!", "Saving Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        ...
        If _RowEditMode = True Then
            ...
            DataGridView5.Item(0, selRow).Value = Label80.Text.Trim()
    ...
    Private Sub DataGridView5_CellDoubleClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView5.CellDoubleClick
        ...
        If Not (DataGridView5.SelectedRows.Item(0).Cells(0).Value Is Nothing Or DataGridView5.SelectedRows.Item(0).Cells(0).Value Is DBNull.Value) Then
            ...
            Label80.Text = DataGridView5.Item(0, e.RowIndex).Value.ToString
            cmbEmployerContact.SelectedValue = DataGridView5.Item(1, e.RowIndex).Value
            txtEmployerAddress.Text = DataGridView5.Item(2, e.RowIndex).Value.ToString

            cmbEmpThana.Text = DataGridView5.Item(3, e.RowIndex).Value.ToString
            cmbEmpDistrict.Text = DataGridView5.Item(4, e.RowIndex).Value.ToString
            txtEmployerZip.Text = DataGridView5.Item(5, e.RowIndex).Value.ToString

            cmbEmployerCountry.SelectedValue = DataGridView5.Item(6, e.RowIndex).Value
            cmbEmpDivision.Text = DataGridView5.Item(7, e.RowIndex).Value.ToString
    ...
    Private Sub btnIdentificationAddToGrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnIdentificationAddToGrid.Click
        ...
        If _RowEditMode = True Then
            ...
            DataGridView6.Item(0, selRow).Value = Label80.Text.Trim()
  ...
  Private Sub btnRemoveIdentificationToGrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRemoveIdentificationToGrid.Click
    ...
    '    lblToolStatus.Text = ""
    '    Dim strId As String = txtId.Text.Trim()
    '    Try
    ...
    '            If ds.Tables(0).Rows(0)("DECEASED").ToString() = 0 Then
    '                cmbDecreased.Text = "Yes"
    '            Else
    '                cmbDecreased.Text = "No"
    '            End If
    ...
    Private Sub txtId_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtId.TextChanged
        ...
        '.......Mizanur Rahman Work (16.03.2016).........

        'If Check_Owner_Code(txtId.Text) = 1 Then
        'MessageBox.Show("Owner Code Exists in CTR !! Data have already in CTR !!")
        'lblToolStatus.Text = "Owner Code Exists in CTR !! Data have already in CTR !!"
        'Get_CTR_Owner_Info(txtId.Text)
        ...
        '.......Mizanur Rahman Work (22.03.2016).........

        'If Check_Owner_Code_goAML_HIST(txtId.Text) = 0 Then
        '    If Check_Owner_Code_goAML_Info(txtId.Text) = 1 Then
        '        'MessageBox.Show("Owner Code Exists in GoAML !!", "Message", MessageBoxButtons.OK, MessageBoxIcon.Error)
        '        LoadOwnerData(txtId.Text)
        '    End If'
        'Else
        '    'MessageBox.Show("Owner Code Exists in GoAML But Not Authorized !!", "Message", MessageBoxButtons.OK, MessageBoxIcon.Error)
        '    LoadOwnerData(txtId.Text)
        'End If
    ...
    Private Sub DataGridView6_CellDoubleClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView6.CellDoubleClick
        ...
        If Not (DataGridView6.SelectedRows.Item(0).Cells(0).Value Is Nothing Or DataGridView6.SelectedRows.Item(0).Cells(0).Value Is DBNull.Value) Then
            ...
            Label80.Text = DataGridView6.Item(0, e.RowIndex).Value.ToString
            cmbIdentification.SelectedValue = DataGridView6.Item(1, e.RowIndex).Value
            txtNumber.Text = DataGridView6.Item(2, e.RowIndex).Value.ToString

            txtIssueDate.Text = NullHelper.DateToStringNew(DataGridView6.Item(3, e.RowIndex).Value).ToString
            txtExpiryDate.Text = NullHelper.DateToStringNew(DataGridView6.Item(4, e.RowIndex).Value).ToString
            txtIssuedBy.Text = NullHelper.ObjectToString(DataGridView6.Item(5, e.RowIndex).Value).ToString
