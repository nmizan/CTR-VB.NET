...
Public Class FrmDistrictSumm

#Region "user defined codes"

    Dim _formName As String = "MaintenanceGoDistrictSumm"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_DistrictType_GetDetailList")
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                dgView.Item(3, i).Value = dt.Rows(i).Item("DISTCODE").ToString()
                dgView.Item(4, i).Value = dt.Rows(i).Item("DISTNAME").ToString()
...
#End Region
    ...
    Private Sub FrmDistrictSumm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(1).Value Is Nothing) Then
                ...
                Dim frmDistrictDet As New FrmDistrictDet(dgView.SelectedRows.Item(0).Cells(3).Value, dgView.SelectedRows.Item(0).Cells(1).Value)
                frmDistrictDet.Show()
            End If
        Catch ex As Exception
    ...
    Private Sub btnAuthorize_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAuthorize.Click
        Try
            ...
            If MessageBox.Show("Do you really want to Authorize?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                    ...
                    If dgView.Rows(i).Cells(0).Value = True Then
                        ...
                        Else
                            ...
                            If (dgView.Rows(i).Cells(1).Value) > 1 Then
                                ...
                                db.AddInParameter(commProc, "@DISTCODE", DbType.String, dgView.Rows(i).Cells(3).Value.ToString())
                                ...
                                If result = 0 Then
                                    ...
                                    If _DistrictName <> _DistName Then
                                        If _DistrictName = "" Then
                                            log_message = " Authorized : District Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " District  Name  : " + _DistName
                                        Else
                                            log_message = " Authorized : District Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " District  Name  : " + _DistrictName + " " + " To " + " " + _DistName
                                        End If
                ...
                '    log_message = "Authorized District Code " + dgView.Rows(i).Cells(3).Value.ToString() + " Name " + dgView.Rows(i).Cells(4).Value.ToString()
                '    Logger.system_log(log_message)
                'Next i
