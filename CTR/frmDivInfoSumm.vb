...
Public Class frmDivInfoSumm

#Region "user defined codes"

    Dim _formName As String = "MaintenanceDivisionSummary"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            If chkShowAll.Checked = True Then
                strSql = "select DIV_CODE, DIV_NAME,IS_AUTHORIZED,MODNO, " + _
                    " 'S' = " + _
                    "	CASE  " + _
                    ...
                    " order by IS_AUTHORIZED,DIV_CODE"
...
#End Region
    ...
    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        ...
        Dim frmDivInfo As New FrmDivision
        frmDivInfo.ShowDialog()
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(0).Value Is Nothing) Then
                ...
                Dim frmDivInfo As New FrmDivision(dgView.SelectedRows.Item(0).Cells(2).Value, dgView.SelectedRows.Item(0).Cells(0).Value)
                frmDivInfo.ShowDialog()
            End If
