'
'Author             : Fahad Khan
'Purpose            : Maintain Account Person Role Type Information
...
Public Class FrmAccountPersonRoleDet

#Region "Global Variables"

    Dim _formName As String = "MaintenanceAccountPersonRoleDet"
...
#Region "User defined Codes"
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_AccountPersonRoleType_Add")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@ACPR_CODE", DbType.String, txtId.Text.Trim())
            db.AddInParameter(commProc, "@ACPR_NAME", DbType.String, txtName.Text.Trim())
            ...
            If result = 0 Then
                ...
                log_message = " Added : Account Person Role : " + txtId.Text.Trim() + "." + " " + " Account Person Role Name : " + txtName.Text.Trim()
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_AccountPersonRoleType_Update")
            ...
            If result = 0 Then
                ...
                If _RoleName <> txtName.Text.Trim() Then

                    log_message = " Updated : Account Person Role : " + txtId.Text.Trim() + "." + " " + " Account Person Role Name : " + _RoleName + " " + " To " + " " + txtName.Text.ToString()
                    Logger.system_log(log_message)
                Else
                    log_message = " Updated : Account Person Role : " + txtId.Text.Trim() + "." + " " + " Account Person Role Name : " + txtName.Text.Trim()
                    Logger.system_log(log_message)
                End If
            ...
            'log_message = "Account Person Role " + txtId.Text.Trim() + " Role Name " + _RoleName + " To " + txtName.Text.Trim() + " Updated"
            'Logger.system_log(log_message)
    ...
    Private Sub LoadAcTypeRoleDataForAuth(ByVal strAcTypeCode As String)
        ...
        Try
            ...
            ds = db.ExecuteDataSet(CommandType.Text, "Select * From GO_ACCOUNT_PERSON Where ACPR_CODE ='" & strAcTypeCode & "' and STATUS= 'L' ")
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                txtId.Text = ds.Tables(0).Rows(0)("ACPR_CODE").ToString()
                txtName.Text = ds.Tables(0).Rows(0)("ACPR_NAME").ToString()
                _AcPerRoleName = ds.Tables(0).Rows(0)("ACPR_NAME").ToString()
    ...
    Private Sub LoadAcTypeData(ByVal strAcTypeCode As String, ByVal intMod As Integer)
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_AccountPersonRoleType_GetDetail")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@ACPR_CODE", DbType.String, strAcTypeCode)
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                txtId.Text = ds.Tables(0).Rows(0)("ACPR_CODE").ToString()
                txtName.Text = ds.Tables(0).Rows(0)("ACPR_NAME").ToString()
                _RoleName = ds.Tables(0).Rows(0)("ACPR_NAME").ToString()
                ...
                Dim commProc2 As DbCommand = db.GetStoredProcCommand("GO_AccountPersonRoleType_GetMaxMod")

                commProc2.Parameters.Clear()

                db.AddInParameter(commProc2, "@ACPR_CODE", DbType.String, strAcTypeCode)
    ...
    Private Function DeleteData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("GO_AccountPersonRoleType_Remove")

        commProc.Parameters.Clear()

        db.AddInParameter(commProc, "@ACPR_CODE", DbType.String, _strAcType_Code)
        db.AddInParameter(commProc, "@MOD_NO", DbType.Int32, _intModno)
        db.AddOutParameter(commProc, "@RET_MOD_NO", DbType.Int32, 5)
        ...
        log_message = "Account Person Role " + _strAcType_Code + " Deleted"
        Logger.system_log(log_message)
    ...
    Private Function AuthorizeData() As TransState
        ...
        If _intModno > 1 Then
            ...
            LoadAcTypeRoleDataForAuth(_strAcType_Code)
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_AccountPersonRoleType_Auth")
            ...
            If result = 0 Then
                ...
                If _AcPerRoleName <> _RoleName Then
                    If _AcPerRoleName = "" Then
                        log_message = " Authorized : Account Person Role : " + txtId.Text.Trim() + "." + " " + " Account Person Role Name : " + _RoleName
                    Else
                        log_message = " Authorized : Account Person Role : " + txtId.Text.Trim() + "." + " " + " Account Person Role Name : " + _AcPerRoleName + " " + " To " + " " + _RoleName
                    End If

                    Logger.system_log(log_message)
                Else
                    log_message = " Authorized : Account Person Role : " + txtId.Text.Trim() + "." + " " + " Account Person Role Name : " + txtName.Text.Trim()
                    Logger.system_log(log_message)
                End If
        ...
        ''log_message = "Account Person Role " + _strAcType_Code + " Role Name " + txtName.Text.ToString() + " Authorized "
        ''Logger.system_log(log_message)
...
#End Region
    ...
    Private Sub FrmAccountPersonRoleDet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
