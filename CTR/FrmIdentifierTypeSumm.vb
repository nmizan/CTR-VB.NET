'
'Author             : Fahad Khan
'Purpose            : Identifier Type Summary
...
Public Class FrmIdentifierTypeSumm

#Region "user defined codes"

    Dim _formName As String = "MaintenanceIdentifierTypeSumm"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_IdentifierType_GetDetailList")
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                dgView.Item(3, i).Value = dt.Rows(i).Item("IDTYPE_CODE").ToString()
                dgView.Item(4, i).Value = dt.Rows(i).Item("IDTYPE_NAME").ToString()
...
#End Region
    ...
    Private Sub FrmIdentifierTypeSumm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(1).Value Is Nothing) Then
                ...
                Dim frmIdentdet As New FrmIdentifierTypeDet(dgView.SelectedRows.Item(0).Cells(3).Value, dgView.SelectedRows.Item(0).Cells(1).Value)
                frmIdentdet.Show()
            End If
        Catch ex As Exception
    ...
    Private Sub btnAuthorize_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAuthorize.Click
        Try
            ...
            If MessageBox.Show("Do you really want to Authorize?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                For i = 0 To dgView.Rows.Count - 1
                    ...
                    If dgView.Rows(i).Cells(0).Value = True Then
                        ...
                        Else
                            ...
                            LoadIDTypeData(dgView.Rows(i).Cells(3).Value.ToString(), dgView.Rows(i).Cells(1).Value)


                            If (dgView.Rows(i).Cells(1).Value) > 1 Then

                                LoadIDTypeDataForAuth(dgView.Rows(i).Cells(3).Value.ToString())
                                ...
                                db.AddInParameter(commProc, "@IDTYPE_CODE", DbType.String, dgView.Rows(i).Cells(3).Value.ToString())
                                ...
                                If result = 0 Then
                                    ...
                                    If _IdentifierName <> _IdentName Then
                                        If _IdentifierName = "" Then
                                            log_message = " Authorized : Identifier Type Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Identifier Type Name  : " + _IdentName
                                        Else
                                            log_message = " Authorized : Identifier Type Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Identifier Type Name  : " + _IdentifierName + " " + " To " + " " + _IdentName
                                        End If
                ...
                '    log_message = "Authorized Identifier Code " + dgView.Rows(i).Cells(3).Value.ToString() + " Name " + dgView.Rows(i).Cells(4).Value.ToString()
                '    Logger.system_log(log_message)
                'Next i
