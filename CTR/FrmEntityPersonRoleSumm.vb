...
'
'Author             : Fahad Khan
'Purpose            : Entity Person Role Type Summary
...
Public Class FrmEntityPersonRoleSumm

#Region "user defined codes"

    Dim _formName As String = "MaintenanceEntityPersonRoleSumm"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_EntityPersonRoleType_GetDetailList")
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                dgView.Item(3, i).Value = dt.Rows(i).Item("ENPR_CODE").ToString()
                dgView.Item(4, i).Value = dt.Rows(i).Item("ENPR_NAME").ToString()
...
#End Region
    ...
    Private Sub FrmEntityPersonRoleSumm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        Dim FrmEntityPersoneRoleDet As New FrmEntityPersonRoleDet()
        FrmEntityPersoneRoleDet.ShowDialog()
    End Sub
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(1).Value Is Nothing) Then
                ...
                Dim FrmEntityPersoneRoleDet As New FrmEntityPersonRoleDet(dgView.SelectedRows.Item(0).Cells(3).Value, dgView.SelectedRows.Item(0).Cells(1).Value)
                FrmEntityPersoneRoleDet.Show()
            End If
        Catch ex As Exception
    ...
    Private Sub btnAuthorize_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAuthorize.Click
        Try
            ...
            If MessageBox.Show("Do you really want to Authorize?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                    ...
                    If dgView.Rows(i).Cells(0).Value = True Then
                        ...
                        Else
                            ...
                            If (dgView.Rows(i).Cells(1).Value) > 1 Then
                                ...
                                db.AddInParameter(commProc, "@ENPR_CODE", DbType.String, dgView.Rows(i).Cells(3).Value.ToString())
                                ...
                                If result = 0 Then
                                    ...
                                    If _EntPersonRole <> _EntityPersonRole Then
                                        If _EntPersonRole = "" Then
                                            log_message = " Authorized : Entity Person Role Type Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Entity Person Role Type Name  : " + _EntityPersonRole
                                        Else
                                            log_message = " Authorized : Entity Person Role Type Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Entity Person Role Type Name  : " + _EntPersonRole + " " + " To " + " " + _EntityPersonRole
                                        End If
                ...
                '    log_message = "Authorized Entity Person role " + dgView.Rows(i).Cells(3).Value.ToString() + " Name " + dgView.Rows(i).Cells(4).Value.ToString()
                '    Logger.system_log(log_message)
