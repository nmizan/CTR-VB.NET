...
Public Class FrmDistSumm

#Region "user defined codes"

    Dim _formName As String = "MaintenanceDistrictSummary"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            If chkShowAll.Checked = True Then
                strSql = "select DIST_CODE, DIV_CODE, DIST_NAME,IS_AUTHORIZED,MODNO, " + _
                    " 'S' = " + _
                    "	CASE  " + _
                    ...
                    " order by IS_AUTHORIZED,DIST_CODE"
...
#End Region
    ...
    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        ...
        Dim frmDist As New FrmDistrict
        frmDist.ShowDialog()
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(0).Value Is Nothing) Then
                ...
                Dim frmDist As New FrmDistrict(dgView.SelectedRows.Item(0).Cells(2).Value, dgView.SelectedRows.Item(0).Cells(0).Value)
                frmDist.ShowDialog()
            End If
    ...
    Private Sub FrmDistSumm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
