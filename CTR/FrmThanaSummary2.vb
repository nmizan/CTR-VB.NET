...
Public Class FrmThanaSummary2

#Region "user defined codes"

    Dim _formName As String = "MaintenanceGoThanaSummary"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_ThanaType_GetDetailList")
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                dgView.Item(3, i).Value = dt.Rows(i).Item("THANA_CODE").ToString()
                dgView.Item(4, i).Value = dt.Rows(i).Item("THANA_NAME").ToString()
...
#End Region
    ...
    Private Sub FrmThanaSummary2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(1).Value Is Nothing) Then
                ...
                Dim frmThanaDet As New FrmThanaDet(dgView.SelectedRows.Item(0).Cells(3).Value, dgView.SelectedRows.Item(0).Cells(1).Value)
                frmThanaDet.Show()
            End If
        Catch ex As Exception
    ...
    Private Sub btnAuthorize_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAuthorize.Click
        Try
            ...
            If MessageBox.Show("Do you really want to Authorize?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                For i = 0 To dgView.Rows.Count - 1
                    ...
                    If dgView.Rows(i).Cells(0).Value = True Then
                        ...
                        Else
                            ...
                            LoadThTypeData(dgView.Rows(i).Cells(3).Value.ToString(), dgView.Rows(i).Cells(1).Value)


                            If (dgView.Rows(i).Cells(1).Value) > 1 Then

                                LoadThTypeDataForAuth(dgView.Rows(i).Cells(3).Value.ToString())
                                ...
                                db.AddInParameter(commProc, "@THANA_CODE", DbType.String, dgView.Rows(i).Cells(3).Value.ToString())
                                ...
                                If result = 0 Then
                                    ...
                                    If _ThName <> _ThanaName Then
                                        If _ThName = "" Then
                                            log_message = " Authorized : Thana Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Thana  Name  : " + _ThanaName
                                        Else
                                            log_message = " Authorized : Thana Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Thana  Name  : " + _ThName + " " + " To " + " " + _ThanaName
                                        End If
                ...
                '    End If
                '    log_message = "Authorized Thana Code " + dgView.Rows(i).Cells(3).Value.ToString() + " Address " + dgView.Rows(i).Cells(4).Value.ToString()
                '    Logger.system_log(log_message)
