'
'Author             : Fahad Khan
'Purpose            : Conduction Type Summary
...
Public Class FrmConductionTypeSumm

#Region "user defined codes"

    Dim _formName As String = "MaintenanceConductionTypeSumm"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_ConductionType_GetDetailList")
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                dgView.Item(3, i).Value = dt.Rows(i).Item("CNTYPE_CODE").ToString()
                dgView.Item(4, i).Value = dt.Rows(i).Item("CNTYPE_NAME").ToString()
...
#End Region
    ...
    Private Sub FrmConductionTypeSumm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(1).Value Is Nothing) Then
                ...
                Dim frmConductionTypeDet As New FrmConductionTypeDet(dgView.SelectedRows.Item(0).Cells(3).Value, dgView.SelectedRows.Item(0).Cells(1).Value)
                frmConductionTypeDet.Show()
            End If
        Catch ex As Exception
    ...
    Private Sub LoadConductData(ByVal strCnTypeCode As String, ByVal intMod As Integer)
    ...
    Private Sub btnAuthorize_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAuthorize.Click
        Try
            ...
            If MessageBox.Show("Do you really want to Authorize?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                For i = 0 To dgView.Rows.Count - 1
                    ...
                    If dgView.Rows(i).Cells(0).Value = True Then
                        ...
                        Else
                            ...
                            LoadConductData(dgView.Rows(i).Cells(3).Value.ToString(), dgView.Rows(i).Cells(1).Value)
                            ...
                            If (dgView.Rows(i).Cells(1).Value) > 1 Then
                                ...
                                db.AddInParameter(commProc, "@CNTYPE_CODE", DbType.String, dgView.Rows(i).Cells(3).Value.ToString())
                                ...
                                If result = 0 Then
                                    ...
                                    If _ConductionType <> _ConductType Then
                                        If _ConductionType = "" Then
                                            log_message = " Authorized : Conduction Type Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Conduction Name : " + _ConductType
                                        Else
                                            log_message = " Authorized : Conduction Type Code : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Conduction Name : " + _ConductionType + " " + " To " + " " + _ConductType
                                        End If
                ...
                '    End If
                '    log_message = "Authorized Conduction Type " + dgView.Rows(i).Cells(3).Value.ToString() + " Name " + dgView.Rows(i).Cells(4).Value.ToString()
                '    Logger.system_log(log_message)
