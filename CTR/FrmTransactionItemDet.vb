'
'Author             : Fahad Khan
'Purpose            : Maintain TransactionItem Type Information
...
Public Class FrmTransactionItemDet

#Region "Global Variables"

    Dim _formName As String = "MaintenanceTransactionItemDet"
    Dim opt As SecForm = New SecForm(_formName)

    Dim _formMode As FormTransMode
    Dim _intModno As Integer = 0
    Dim _strTType_Code As String = ""
...
#Region "User defined Codes"
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_TransactionItemType_Add")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@TTYPE_CODE", DbType.String, txtId.Text.Trim())
            db.AddInParameter(commProc, "@TTYPE_NAME", DbType.String, txtName.Text.Trim())
            ...
            If result = 0 Then
                ...
                _strTType_Code = txtId.Text.Trim()
            ...
            End If
            log_message = "Added Transaction Item Type " + txtId.Text.Trim() + " Name " + txtName.Text.ToString()
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_TransactionItemType_Update")
            ...
            log_message = "Updated Transaction Item Type " + txtId.Text.Trim() + " Name " + txtName.Text.ToString()
            Logger.system_log(log_message)
        End If
    ...
    Private Sub LoadTTypeData(ByVal strTTypeCode As String, ByVal intMod As Integer)
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_TransactionItemType_GetDetail")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@TTYPE_CODE", DbType.String, strTTypeCode)
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                _strTType_Code = strTTypeCode
                _intModno = intMod

                _formMode = FormTransMode.Update


                txtId.Text = ds.Tables(0).Rows(0)("TTYPE_CODE").ToString()
                txtName.Text = ds.Tables(0).Rows(0)("TTYPE_NAME").ToString()
                ...
                Dim commProc2 As DbCommand = db.GetStoredProcCommand("GO_TransactionItemType_GetMaxMod")

                commProc2.Parameters.Clear()

                db.AddInParameter(commProc2, "@TTYPE_CODE", DbType.String, strTTypeCode)
    ...
    Public Sub New(ByVal strTTypeCode As String, ByVal intMod As Integer)

        ' This call is required by the Windows Form Designer.
        InitializeComponent()

        ' Add any initialization after the InitializeComponent() call.
        LoadTTypeData(strTTypeCode, intMod)
        _strTType_Code = strTTypeCode
        _intModno = intMod
    ...
    Private Function DeleteData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("GO_TransactionItemType_Remove")

        commProc.Parameters.Clear()

        db.AddInParameter(commProc, "@TTYPE_CODE", DbType.String, _strTType_Code)
        db.AddInParameter(commProc, "@MOD_NO", DbType.Int32, _intModno)
        db.AddOutParameter(commProc, "@RET_MOD_NO", DbType.Int32, 5)
        ...
        log_message = "Deleted Transaction Item Type " + _strTType_Code + " Name " + txtName.Text.ToString()
        Logger.system_log(log_message)
        Return tStatus
    ...
    Private Function AuthorizeData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("GO_TransactionItemType_Auth")
        ...
        log_message = "Authorized Transaction Item Type " + _strTType_Code + " Name " + txtName.Text.ToString()
        Logger.system_log(log_message)
...
#End Region
    ...
    Private Sub FrmTransactionItemDet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If _intModno > 0 Then
            LoadTTypeData(_strTType_Code, _intModno)
        End If
    ...
    Private Sub btnUnlock_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUnlock.Click
        ...
        If Not (_strTType_Code.Trim() = "") Then
