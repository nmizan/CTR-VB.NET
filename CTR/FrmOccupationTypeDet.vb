'
'Author             : Fahad Khan
'Purpose            : Occupation Type Information
...
Public Class FrmOccupationTypeDet
...
#Region "Global Variables"
    ...
    Dim _strOccType_Code As String = ""
    Dim _mod_datetime As Date
    Dim _status As String = ""
    Dim log_message As String = ""

    Dim _OccTypeName As String = ""
    Dim _OccupationTypeName As String = ""
...
#Region "User defined Codes"
    ...
    Private Function SaveData() As TransState
        ...
        If _formMode = FormTransMode.Add Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_OccupationType_Add")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@OCP_CODE", DbType.String, txtId.Text.Trim())
            db.AddInParameter(commProc, "@OCP_NAME", DbType.String, txtName.Text.Trim())
            ...
            If result = 0 Then
                ...
                _strOccType_Code = txtId.Text.Trim()

                _intModno = 1

                log_message = " Added : Occupation Type Code : " + txtId.Text.Trim() + "." + " " + " Occupation Type Name : " + txtName.Text.ToString()
        ...
        ElseIf _formMode = FormTransMode.Update Then
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_OccupationType_Update")
            ...
            If result = 0 Then
                ...
                If _OccTypeName <> txtName.Text.Trim() Then

                    log_message = " Updated : Occupation Type Code : " + txtId.Text.Trim() + "." + " " + " Occupation Type Name  : " + _OccTypeName + " " + " To " + " " + txtName.Text.ToString()
                    Logger.system_log(log_message)
                Else
                    log_message = " Updated : Occupation Type Code : " + txtId.Text.Trim() + "." + " " + " Occupation Type Name  : " + txtName.Text.Trim()
                    Logger.system_log(log_message)
                End If
            ...
            'log_message = "Updated Occupation Type " + txtId.Text.Trim() + " Name " + _OccTypeName + " To " + txtName.Text.ToString()
            'Logger.system_log(log_message)
    ...
    Private Sub LoadOccTypeDataForAuth(ByVal strOccTypeCode As String)
        ...
        Try
            ...
            ds = db.ExecuteDataSet(CommandType.Text, "Select * From GO_OCCUPATION Where OCP_CODE ='" & strOccTypeCode & "' and STATUS= 'L' ")

            If ds.Tables(0).Rows.Count > 0 Then

                _strOccType_Code = strOccTypeCode

                _formMode = FormTransMode.Update


                txtId.Text = ds.Tables(0).Rows(0)("OCP_CODE").ToString()
                txtName.Text = ds.Tables(0).Rows(0)("OCP_NAME").ToString()
                _OccupationTypeName = ds.Tables(0).Rows(0)("OCP_NAME").ToString()
    ...
    Private Sub LoadOccTypeData(ByVal strOccTypeCode As String, ByVal intMod As Integer)
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_OccupationType_GetDetail")

            commProc.Parameters.Clear()

            db.AddInParameter(commProc, "@OCP_CODE", DbType.String, strOccTypeCode)
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                txtId.Text = ds.Tables(0).Rows(0)("OCP_CODE").ToString()
                txtName.Text = ds.Tables(0).Rows(0)("OCP_NAME").ToString()
                _OccTypeName = ds.Tables(0).Rows(0)("OCP_NAME").ToString()
                ...
                Dim commProc2 As DbCommand = db.GetStoredProcCommand("GO_OccupationType_GetMaxMod")

                commProc2.Parameters.Clear()

                db.AddInParameter(commProc2, "@OCP_CODE", DbType.String, strOccTypeCode)
    ...
    Public Sub New(ByVal strOccTypeCode As String, ByVal intMod As Integer)

        ' This call is required by the Windows Form Designer.
        InitializeComponent()

        ' Add any initialization after the InitializeComponent() call.
        LoadOccTypeData(strOccTypeCode, intMod)
        _strOccType_Code = strOccTypeCode
        _intModno = intMod
    ...
    Private Function DeleteData() As TransState
        ...
        Dim commProc As DbCommand = db.GetStoredProcCommand("GO_OccupationType_Remove")

        commProc.Parameters.Clear()

        db.AddInParameter(commProc, "@OCP_CODE", DbType.String, _strOccType_Code)
        db.AddInParameter(commProc, "@MOD_NO", DbType.Int32, _intModno)
        db.AddOutParameter(commProc, "@RET_MOD_NO", DbType.Int32, 5)
        ...
        log_message = "Deleted Occupation Type " + _strOccType_Code + " Name " + txtName.Text.ToString()
        Logger.system_log(log_message)
    ...
    Private Function AuthorizeData() As TransState
        ...
        If _intModno > 1 Then
            ...
            LoadOccTypeDataForAuth(_strOccType_Code)
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_OccupationType_Auth")
            ...
            If result = 0 Then
                ...
                If _OccupationTypeName <> _OccTypeName Then
                    If _OccupationTypeName = "" Then
                        log_message = " Authorized : Occupation Type Code : " + txtId.Text.Trim() + "." + " " + " Occupation Type Name  : " + _OccTypeName
                    Else
                        log_message = " Authorized : Occupation Type Code : " + txtId.Text.Trim() + "." + " " + " Occupation Type Name  : " + _OccupationTypeName + " " + " To " + " " + _OccTypeName
                    End If

                    Logger.system_log(log_message)
                Else
                    log_message = " Authorized : Occupation Type Code : " + txtId.Text.Trim() + "." + " " + " Occupation Type Name  : " + txtName.Text.Trim()
                    Logger.system_log(log_message)
                End If
        ...
        '
        'log_message = "Authorized Occupation Type " + _strOccType_Code + " Name " + txtName.Text.ToString()
        'Logger.system_log(log_message)
...
#End Region
    ...
    Private Sub FrmOccupationTypeDet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If _intModno > 0 Then
            LoadOccTypeData(_strOccType_Code, _intModno)
        End If
