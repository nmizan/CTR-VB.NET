...
Public Class FrmTransactiongoAmlSumm
...
#Region "user defined codes"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_Transaction_GetDetailList")
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                dgView.Item(3, i).Value = dt.Rows(i).Item("TRANSACTIONNUMBER").ToString()
                dgView.Item(4, i).Value = dt.Rows(i).Item("TRANSACTION_LOCATION").ToString()
                dgView.Item(5, i).Value = NullHelper.DateToString(dt.Rows(i).Item("DATE_TRANSACTION"))
                dgView.Item(6, i).Value = dt.Rows(i).Item("AMOUNT_LOCAL").ToString()
                dgView.Item(7, i).Value = dt.Rows(i).Item("BALANCE").ToString()
                dgView.Item(8, i).Value = dt.Rows(i).Item("TRANSMODE_CODE").ToString()
                ...
                dgView.Item(14, i).Value = dt.Rows(i).Item("ACCOUNT")
                dgView.Item(15, i).Value = dt.Rows(i).Item("FROM_ACCOUNT").ToString
                dgView.Item(16, i).Value = dt.Rows(i).Item("FROM_PERSON").ToString
                dgView.Item(17, i).Value = dt.Rows(i).Item("TO_ACCOUNT").ToString
                dgView.Item(18, i).Value = dt.Rows(i).Item("TO_PERSON").ToString

                dgView.Item(19, i).Value = dt.Rows(i).Item("ACCOUNT_CURRENCY").ToString
                dgView.Item(20, i).Value = dt.Rows(i).Item("FOREIGN_AMOUNT").ToString
                dgView.Item(21, i).Value = dt.Rows(i).Item("DRCR_IND").ToString
                dgView.Item(22, i).Value = dt.Rows(i).Item("ACC_TYPE").ToString
                dgView.Item(23, i).Value = dt.Rows(i).Item("TRANSACTION_DESCRIPTION").ToString
            Next
...
#End Region
    ...
    Private Sub FrmTransactiongoAmlSumm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i As Integer
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(1).Value Is Nothing) Then
                ...
                Dim frmTransactionDet As New FrmTransactiongoAmlDet(dgView.SelectedRows.Item(0).Cells(3).Value, dgView.SelectedRows.Item(0).Cells(1).Value)
                frmTransactionDet.Show()
            End If
        Catch ex As Exception
            ...
            If MessageBox.Show("Do you really want to Authorize?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                For i = 0 To dgView.Rows.Count - 1
                    ...
                    If dgView.Rows(i).Cells(0).Value = True Then
                        ...
                        db.AddInParameter(commProc, "@TRANSACTIONNUMBER", DbType.String, dgView.Rows(i).Cells(3).Value.ToString())
