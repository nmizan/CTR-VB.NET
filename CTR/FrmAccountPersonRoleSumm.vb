...
'
'Author             : Fahad Khan
'Purpose            : Account Person Role Type Summary
...
Public Class FrmAccountPersonRoleSumm

#Region "user defined codes"
    Dim _formName As String = "MaintenanceAccountPersonRoleSumm"
    ...
    Private Sub LoadDataGrid()
        ...
        Try
            ...
            Dim commProc As DbCommand = db.GetStoredProcCommand("GO_AccountPersonRoleType_GetDetailList")
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                dgView.Item(3, i).Value = dt.Rows(i).Item("ACPR_CODE").ToString()
                dgView.Item(4, i).Value = dt.Rows(i).Item("ACPR_NAME").ToString()
...
#End Region
    ...
    Private Sub FrmAccountPersonRoleSumm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        Dim FrmAccountPersonRoleDet As New FrmAccountPersonRoleDet()
        FrmAccountPersonRoleDet.ShowDialog()
    End Sub
    ...
    Private Sub btnDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetail.Click
        Try
            ...
            If Not (dgView.SelectedRows.Item(0).Cells(1).Value Is Nothing) Then
                ...
                Dim FrmAccountPersonRoleDet As New FrmAccountPersonRoleDet(dgView.SelectedRows.Item(0).Cells(3).Value, dgView.SelectedRows.Item(0).Cells(1).Value)
                FrmAccountPersonRoleDet.Show()
            End If
        Catch ex As Exception
    ...
    Private Sub btnAuthorize_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAuthorize.Click
        Try
            ...
            If MessageBox.Show("Do you really want to Authorize?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                For i = 0 To dgView.Rows.Count - 1
                    ...
                    If dgView.Rows(i).Cells(0).Value = True Then
                        ...
                        Else
                            ...
                            LoadAcTypeData(dgView.Rows(i).Cells(3).Value.ToString(), dgView.Rows(i).Cells(1).Value)


                            If (dgView.Rows(i).Cells(1).Value) > 1 Then

                                LoadAcTypeRoleDataForAuth(dgView.Rows(i).Cells(3).Value.ToString())
                                ...
                                db.AddInParameter(commProc, "@ACPR_CODE", DbType.String, dgView.Rows(i).Cells(3).Value.ToString())
                                ...
                                If result = 0 Then
                                    ...
                                    If _AcPerRoleName <> _RoleName Then
                                        If _AcPerRoleName = "" Then
                                            log_message = " Authorized : Account Person Role : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Account Person Role Name : " + _RoleName
                                        Else
                                            log_message = " Authorized : Account Person Role : " + dgView.Rows(i).Cells(3).Value.ToString() + "." + " " + " Account Person Role Name : " + _AcPerRoleName + " " + " To " + " " + _RoleName
                                        End If
                ...
                '    log_message = "Account Person Role Type Code " + dgView.Rows(i).Cells(3).Value.ToString() + " Name " + dgView.Rows(i).Cells(4).Value.ToString() + " Authorized"
                '    Logger.system_log(log_message)
